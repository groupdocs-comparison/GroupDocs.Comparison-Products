...
steps:
    ...
    content: |
      Можно использовать файлы XLTM, используя [GroupDocs.Comparison](https://products.groupdocs.com/comparison/nodejs-java/) для получения отчета о различиях во многих XLTM файлах
