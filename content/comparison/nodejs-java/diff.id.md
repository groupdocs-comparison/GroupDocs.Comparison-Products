...
############################# Head ############################
head_title: "Bandingkan DIFF menggunakan Perpustakaan JavaScript."
...
############################# Header ############################
title: "Membandingkan file DIFF Anda di Node.js" 
description: "Pustaka perbandingan dokumen berdasarkan Node.js memberikan kesempatan untuk mengumpulkan dan menampilkan data tentang perbedaan apa pun dalam file DIFF. Tingkatkan produktivitas solusi Anda dalam tugas perbandingan file dengan GroupDocs.Comparison."
...
steps:
    enable: true
    title: "Cara melakukan perbandingan file DIFF menggunakan Node.js."
    content: |
      Dimungkinkan untuk menggunakan file DIFF menggunakan [GroupDocs.Comparison](https://products.groupdocs.com/comparison/nodejs-java/) untuk mendapatkan laporan tentang perbedaan di banyak file DIFF
      ...
      2. Buat instance Comparer dan berikan path ke file pertama dalam format DIFF
      3. Tambahkan file DIFF lainnya ke Comparer
