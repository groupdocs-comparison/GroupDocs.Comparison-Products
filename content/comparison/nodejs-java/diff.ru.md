...
steps:
    ...
    content: |
      Можно использовать файлы DIFF, используя [GroupDocs.Comparison](https://products.groupdocs.com/comparison/nodejs-java/) для получения отчета о различиях во многих DIFF файлах
