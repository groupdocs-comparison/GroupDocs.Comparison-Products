...
steps:
    ...
    content: |
      Можно использовать файлы DWG, используя [GroupDocs.Comparison](https://products.groupdocs.com/comparison/nodejs-java/) для получения отчета о различиях во многих DWG файлах
