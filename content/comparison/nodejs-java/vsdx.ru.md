...
steps:
    ...
    content: |
      Можно использовать файлы VSDX, используя [GroupDocs.Comparison](https://products.groupdocs.com/comparison/nodejs-java/) для получения отчета о различиях во многих VSDX файлах
