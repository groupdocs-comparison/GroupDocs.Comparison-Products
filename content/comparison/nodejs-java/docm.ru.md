...
steps:
    ...
    content: |
      Можно использовать файлы DOCM, используя [GroupDocs.Comparison](https://products.groupdocs.com/comparison/nodejs-java/) для получения отчета о различиях во многих DOCM файлах
