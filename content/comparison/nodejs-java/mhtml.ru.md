...
steps:
    ...
    content: |
      Можно использовать файлы MHTML, используя [GroupDocs.Comparison](https://products.groupdocs.com/comparison/nodejs-java/) для получения отчета о различиях во многих MHTML файлах
