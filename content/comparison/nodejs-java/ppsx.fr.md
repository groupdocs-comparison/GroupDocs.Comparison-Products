...
############################# Head ############################
head_title: "Comparez PPSX à l'aide de la bibliothèque JavaScript."
...
############################# Header ############################
title: "Comparaison de vos PPSX fichiers dans Node.js" 
description: "La bibliothèque de comparaison de documents basée sur Node.js permet de collecter et d'afficher des données sur toutes les distinctions dans les fichiers PPSX. Améliorez la productivité de vos solutions lors des tâches de comparaison de fichiers avec GroupDocs.Comparison."
...
steps:
    enable: true
    title: "Comment effectuer une comparaison de PPSX fichiers à l'aide de Node.js."
    content: |
      Il est possible d'utiliser PPSX fichiers en utilisant [GroupDocs.Comparison](https://products.groupdocs.com/comparison/nodejs-java/) pour obtenir un rapport sur les différences entre de nombreux fichiers PPSX
      ...
      2. Instanciez le comparateur et indiquez le chemin vers le premier des fichiers au format PPSX
      3. Ajouter un autre fichier PPSX à Comparer
