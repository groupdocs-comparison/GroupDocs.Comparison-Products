...
############################# Head ############################
head_title: "Compara PL con la biblioteca JavaScript."
...
############################# Header ############################
title: "Comparación de tus PL archivos en Node.js" 
description: "La biblioteca de comparación de documentos basada en Node.js brinda la oportunidad de recopilar y mostrar datos sobre cualquier distinción en los archivos PL. Mejore la productividad de sus soluciones en las tareas de comparación de archivos con GroupDocs.Comparison."
...
steps:
    enable: true
    title: "Cómo realizar una comparación de PL archivos con Node.js."
    content: |
      Es posible usar PL archivos usando [GroupDocs.Comparison](https://products.groupdocs.com/comparison/nodejs-java/) para obtener informes sobre las diferencias en muchos PL archivos
      ...
      2. Instancie el comparador y proporcione la ruta al primero de los archivos en formato PL
      3. Añadir otro archivo PL a Comparer
