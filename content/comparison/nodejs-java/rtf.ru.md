...
steps:
    ...
    content: |
      Можно использовать файлы RTF, используя [GroupDocs.Comparison](https://products.groupdocs.com/comparison/nodejs-java/) для получения отчета о различиях во многих RTF файлах
