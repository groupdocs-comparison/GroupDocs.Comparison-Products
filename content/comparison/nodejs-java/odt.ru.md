...
steps:
    ...
    content: |
      Можно использовать файлы ODT, используя [GroupDocs.Comparison](https://products.groupdocs.com/comparison/nodejs-java/) для получения отчета о различиях во многих ODT файлах
