...
############################# Head ############################
head_title: "Vergleiche HTM mit der JavaScript -Bibliothek."
...
############################# Header ############################
title: "Vergleichen Sie Ihre HTM Dateien in Node.js" 
description: "Die auf Node.js basierende Dokumentvergleichsbibliothek bietet die Möglichkeit, Daten zu Unterscheidungen in HTM Dateien zu sammeln und anzuzeigen. Steigern Sie die Produktivität Ihrer Lösungen bei Dateivergleichsaufgaben mit GroupDocs.Comparison."
...
steps:
    enable: true
    title: "So führen Sie einen Vergleich von HTM Dateien mit Node.js durch."
    content: |
      Es ist möglich, HTM Dateien mit [GroupDocs.Comparison](https://products.groupdocs.com/comparison/nodejs-java/) zu verwenden, um Berichte über Unterschiede in vielen HTM Dateien zu erhalten
      ...
      2. Instanziieren Sie den Comparer und geben Sie den Pfad zur ersten der Dateien im Format HTM an
      3. Eine weitere HTM Datei zu Comparer hinzufügen
