...
steps:
    ...
    content: |
      Можно использовать файлы XLSB, используя [GroupDocs.Comparison](https://products.groupdocs.com/comparison/nodejs-java/) для получения отчета о различиях во многих XLSB файлах
