...
steps:
    ...
    content: |
      Можно использовать файлы VDX, используя [GroupDocs.Comparison](https://products.groupdocs.com/comparison/nodejs-java/) для получения отчета о различиях во многих VDX файлах
