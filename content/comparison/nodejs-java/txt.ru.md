...
steps:
    ...
    content: |
      Можно использовать файлы TXT, используя [GroupDocs.Comparison](https://products.groupdocs.com/comparison/nodejs-java/) для получения отчета о различиях во многих TXT файлах
