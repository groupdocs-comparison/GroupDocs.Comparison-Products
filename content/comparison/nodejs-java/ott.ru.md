...
steps:
    ...
    content: |
      Можно использовать файлы OTT, используя [GroupDocs.Comparison](https://products.groupdocs.com/comparison/nodejs-java/) для получения отчета о различиях во многих OTT файлах
