...
############################# Head ############################
head_title: "Bandingkan XLT menggunakan Perpustakaan JavaScript."
...
############################# Header ############################
title: "Membandingkan file XLT Anda di Node.js" 
description: "Pustaka perbandingan dokumen berdasarkan Node.js memberikan kesempatan untuk mengumpulkan dan menampilkan data tentang perbedaan apa pun dalam file XLT. Tingkatkan produktivitas solusi Anda dalam tugas perbandingan file dengan GroupDocs.Comparison."
...
steps:
    enable: true
    title: "Cara melakukan perbandingan file XLT menggunakan Node.js."
    content: |
      Dimungkinkan untuk menggunakan file XLT menggunakan [GroupDocs.Comparison](https://products.groupdocs.com/comparison/nodejs-java/) untuk mendapatkan laporan tentang perbedaan di banyak file XLT
      ...
      2. Buat instance Comparer dan berikan path ke file pertama dalam format XLT
      3. Tambahkan file XLT lainnya ke Comparer
