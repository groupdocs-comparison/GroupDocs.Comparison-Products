...
############################# Header ############################
title: "Comparing your CPP files with Node.js GroupDocs.Comparison" 
description: "Documents comparing API based on Node.js provides opportunity to collect and display data about any distinctions in CPP files. Improve files comparing productivity with GroupDocs.Comparison."
...
steps:
    enable: true
    title: "How to perform CPP files comparison using Node.js."
    content: |
      It is possible to use CPP files using [GroupDocs.Comparison](https://products.groupdocs.com/comparison/nodejs-java/) for getting report about differences in many CPP files
      
      1. Install GroupDocs.Comparison for Node.js via Java using [NPM](https://www.npmjs.com/package/@groupdocs/groupdocs.comparison)
      2. Instantiate the Comparer and providing path to first of the files in the CPP format
      3. Add another CPP file to Comparer
