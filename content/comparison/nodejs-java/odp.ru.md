...
steps:
    ...
    content: |
      Можно использовать файлы ODP, используя [GroupDocs.Comparison](https://products.groupdocs.com/comparison/nodejs-java/) для получения отчета о различиях во многих ODP файлах
