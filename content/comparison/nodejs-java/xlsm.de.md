...
############################# Head ############################
head_title: "Vergleiche XLSM mit der JavaScript -Bibliothek."
...
############################# Header ############################
title: "Vergleichen Sie Ihre XLSM Dateien in Node.js" 
description: "Die auf Node.js basierende Dokumentvergleichsbibliothek bietet die Möglichkeit, Daten zu Unterscheidungen in XLSM Dateien zu sammeln und anzuzeigen. Steigern Sie die Produktivität Ihrer Lösungen bei Dateivergleichsaufgaben mit GroupDocs.Comparison."
...
steps:
    enable: true
    title: "So führen Sie einen Vergleich von XLSM Dateien mit Node.js durch."
    content: |
      Es ist möglich, XLSM Dateien mit [GroupDocs.Comparison](https://products.groupdocs.com/comparison/nodejs-java/) zu verwenden, um Berichte über Unterschiede in vielen XLSM Dateien zu erhalten
      ...
      2. Instanziieren Sie den Comparer und geben Sie den Pfad zur ersten der Dateien im Format XLSM an
      3. Eine weitere XLSM Datei zu Comparer hinzufügen
