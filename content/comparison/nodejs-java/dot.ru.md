...
steps:
    ...
    content: |
      Можно использовать файлы DOT, используя [GroupDocs.Comparison](https://products.groupdocs.com/comparison/nodejs-java/) для получения отчета о различиях во многих DOT файлах
