...
steps:
    ...
    content: |
      Можно использовать файлы HTML, используя [GroupDocs.Comparison](https://products.groupdocs.com/comparison/nodejs-java/) для получения отчета о различиях во многих HTML файлах
