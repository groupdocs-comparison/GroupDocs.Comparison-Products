...
steps:
    ...
    content: |
      Можно использовать файлы BMP, используя [GroupDocs.Comparison](https://products.groupdocs.com/comparison/nodejs-java/) для получения отчета о различиях во многих BMP файлах
