...
steps:
    ...
    content: |
      Можно использовать файлы VST, используя [GroupDocs.Comparison](https://products.groupdocs.com/comparison/nodejs-java/) для получения отчета о различиях во многих VST файлах
