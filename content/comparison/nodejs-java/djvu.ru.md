...
steps:
    ...
    content: |
      Можно использовать файлы DJVU, используя [GroupDocs.Comparison](https://products.groupdocs.com/comparison/nodejs-java/) для получения отчета о различиях во многих DJVU файлах
