...
############################# Head ############################
head_title: "Сравните PY с помощью библиотеки JavaScript."
head_description: "GroupDocs.Comparison for Node.js via Java - библиотека для создания подробных отчетов о различиях в файлах PY для Node.js приложений."

############################# Header ############################
title: "Сравнение ваших PY файлов в Node.js" 
description: "Библиотека сравнения документов на основе Node.js позволяет собирать и отображать данные о любых различиях в файлах PY. Повысьте производительность своих решений при выполнении задач сравнения файлов с помощью GroupDocs.Comparison."
...
steps:
    enable: true
    title: "Как выполнить сравнение файлов PY с помощью Node.js."
    content: |
      Всего несколько шагов достаточно для получения отчета о сравнении PY файлов с помощью [GroupDocs.Comparison](https://products.groupdocs.com/comparison/nodejs-java/)
      ...
      2. Создайте экземпляр Comparer и укажите путь к первому из файлов в формате PY
      3. Добавьте еще один файл PY в Comparer
