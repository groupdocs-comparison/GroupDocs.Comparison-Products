...
############################# Head ############################
head_title: "Bandingkan XLTM menggunakan Perpustakaan JavaScript."
...
############################# Header ############################
title: "Membandingkan file XLTM Anda di Node.js" 
description: "Pustaka perbandingan dokumen berdasarkan Node.js memberikan kesempatan untuk mengumpulkan dan menampilkan data tentang perbedaan apa pun dalam file XLTM. Tingkatkan produktivitas solusi Anda dalam tugas perbandingan file dengan GroupDocs.Comparison."
...
steps:
    enable: true
    title: "Cara melakukan perbandingan file XLTM menggunakan Node.js."
    content: |
      Dimungkinkan untuk menggunakan file XLTM menggunakan [GroupDocs.Comparison](https://products.groupdocs.com/comparison/nodejs-java/) untuk mendapatkan laporan tentang perbedaan di banyak file XLTM
      ...
      2. Buat instance Comparer dan berikan path ke file pertama dalam format XLTM
      3. Tambahkan file XLTM lainnya ke Comparer
