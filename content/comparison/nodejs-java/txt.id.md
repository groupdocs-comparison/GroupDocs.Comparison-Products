...
############################# Head ############################
head_title: "Bandingkan TXT menggunakan Perpustakaan JavaScript."
...
############################# Header ############################
title: "Membandingkan file TXT Anda di Node.js" 
description: "Pustaka perbandingan dokumen berdasarkan Node.js memberikan kesempatan untuk mengumpulkan dan menampilkan data tentang perbedaan apa pun dalam file TXT. Tingkatkan produktivitas solusi Anda dalam tugas perbandingan file dengan GroupDocs.Comparison."
...
steps:
    enable: true
    title: "Cara melakukan perbandingan file TXT menggunakan Node.js."
    content: |
      Dimungkinkan untuk menggunakan file TXT menggunakan [GroupDocs.Comparison](https://products.groupdocs.com/comparison/nodejs-java/) untuk mendapatkan laporan tentang perbedaan di banyak file TXT
      ...
      2. Buat instance Comparer dan berikan path ke file pertama dalam format TXT
      3. Tambahkan file TXT lainnya ke Comparer
