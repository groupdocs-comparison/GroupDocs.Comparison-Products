...
############################# Head ############################
head_title: "Confronta CS usando la libreria JavaScript."
...
############################# Header ############################
title: "Confrontando i tuoi file CS in Node.js" 
description: "La libreria di confronto dei documenti basata su Node.js offre l'opportunità di raccogliere e visualizzare dati su qualsiasi distinzione nei file CS. Migliora la produttività delle tue soluzioni nelle attività di confronto dei file con GroupDocs.Comparison."
...
steps:
    enable: true
    title: "Come eseguire il confronto dei file CS utilizzando Node.js."
    content: |
      È possibile utilizzare i file CS utilizzando [GroupDocs.Comparison](https://products.groupdocs.com/comparison/nodejs-java/) per ottenere report sulle differenze in molti file CS
      ...
      2. Crea un'istanza del Comparer e fornisci il percorso al primo dei file nel formato CS
      3. Aggiungi un altro file CS a Comparer
