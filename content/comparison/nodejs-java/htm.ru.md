...
steps:
    ...
    content: |
      Можно использовать файлы HTM, используя [GroupDocs.Comparison](https://products.groupdocs.com/comparison/nodejs-java/) для получения отчета о различиях во многих HTM файлах
