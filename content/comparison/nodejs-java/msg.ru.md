...
steps:
    ...
    content: |
      Можно использовать файлы MSG, используя [GroupDocs.Comparison](https://products.groupdocs.com/comparison/nodejs-java/) для получения отчета о различиях во многих MSG файлах
