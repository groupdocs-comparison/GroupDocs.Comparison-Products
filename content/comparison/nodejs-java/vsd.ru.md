...
steps:
    ...
    content: |
      Можно использовать файлы VSD, используя [GroupDocs.Comparison](https://products.groupdocs.com/comparison/nodejs-java/) для получения отчета о различиях во многих VSD файлах
