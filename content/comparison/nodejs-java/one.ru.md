...
steps:
    ...
    content: |
      Можно использовать файлы ONE, используя [GroupDocs.Comparison](https://products.groupdocs.com/comparison/nodejs-java/) для получения отчета о различиях во многих ONE файлах
