...
############################# Head ############################
head_title: "Confronta MOBI usando la libreria JavaScript."
...
############################# Header ############################
title: "Confrontando i tuoi file MOBI in Node.js" 
description: "La libreria di confronto dei documenti basata su Node.js offre l'opportunità di raccogliere e visualizzare dati su qualsiasi distinzione nei file MOBI. Migliora la produttività delle tue soluzioni nelle attività di confronto dei file con GroupDocs.Comparison."
...
steps:
    enable: true
    title: "Come eseguire il confronto dei file MOBI utilizzando Node.js."
    content: |
      È possibile utilizzare i file MOBI utilizzando [GroupDocs.Comparison](https://products.groupdocs.com/comparison/nodejs-java/) per ottenere report sulle differenze in molti file MOBI
      ...
      2. Crea un'istanza del Comparer e fornisci il percorso al primo dei file nel formato MOBI
      3. Aggiungi un altro file MOBI a Comparer
