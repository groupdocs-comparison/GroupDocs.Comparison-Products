...
############################# Head ############################
head_title: "Effortlessly compare DOTX documents using the Node.js PDF Comparison API with JavaScript."
...
############################# Header ############################
title: "Comparing your DOTX files with Node.js GroupDocs.Comparison" 
description: "Documents comparing API based on Node.js provides opportunity to collect and display data about any distinctions in DOTX files. Improve files comparing productivity with GroupDocs.Comparison."
...
steps:
    enable: true
    title: "How to perform DOTX files comparison using Node.js."
    content: |
      It is possible to use DOTX files using [GroupDocs.Comparison](https://products.groupdocs.com/comparison/nodejs-java/) for getting report about differences in many DOTX files.
