...
############################# Head ############################
head_title: "Compare RTF usando a biblioteca JavaScript."
...
############################# Header ############################
title: "Comparando seus RTF arquivos em Node.js" 
description: "A biblioteca de comparação de documentos baseada em Node.js oferece a oportunidade de coletar e exibir dados sobre quaisquer distinções em RTF arquivos. Aumente a produtividade de suas soluções em tarefas de comparação de arquivos com GroupDocs.Comparison."
...
steps:
    enable: true
    title: "Como realizar a comparação de RTF arquivos usando Node.js."
    content: |
      É possível usar RTF arquivos usando [GroupDocs.Comparison](https://products.groupdocs.com/comparison/nodejs-java/) para obter relatórios sobre diferenças em muitos RTF arquivos
      ...
      2. Instancie o Comparador e forneça o caminho para o primeiro dos arquivos no formato RTF
      3. Adicionar outro arquivo RTF ao Comparer
