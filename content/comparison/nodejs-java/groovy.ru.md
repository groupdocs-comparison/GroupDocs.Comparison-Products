...
steps:
    ...
    content: |
      Можно использовать файлы GROOVY, используя [GroupDocs.Comparison](https://products.groupdocs.com/comparison/nodejs-java/) для получения отчета о различиях во многих GROOVY файлах
