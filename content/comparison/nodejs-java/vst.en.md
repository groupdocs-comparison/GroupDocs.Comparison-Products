...
############################# Head ############################
head_title: "Effortlessly compare VST documents using the Node.js PDF Comparison Library with JavaScript."
...
############################# Header ############################
title: "Comparing your VST files in Node.js" 
description: "Document comparison library based on Node.js provides opportunity to collect and display data about any distinctions in VST files. Enhance the productivity of your solutions in file comparison tasks with GroupDocs.Comparison."
...
steps:
    enable: true
    title: "How to perform VST files comparison using Node.js."
    content: |
      It is possible to use VST files using [GroupDocs.Comparison](https://products.groupdocs.com/comparison/nodejs-java/) for getting report about differences in many VST files
      
      1. Install GroupDocs.Comparison for Node.js via Java using [NPM](https://www.npmjs.com/package/@groupdocs/groupdocs.comparison)
      2. Instantiate the Comparer and providing path to first of the files in the VST format
      3. Add another VST file to Comparer
