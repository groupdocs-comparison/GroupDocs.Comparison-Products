...
############################# Head ############################
head_title: "Compare TXT usando a biblioteca JavaScript."
...
############################# Header ############################
title: "Comparando seus TXT arquivos em Node.js" 
description: "A biblioteca de comparação de documentos baseada em Node.js oferece a oportunidade de coletar e exibir dados sobre quaisquer distinções em TXT arquivos. Aumente a produtividade de suas soluções em tarefas de comparação de arquivos com GroupDocs.Comparison."
...
steps:
    enable: true
    title: "Como realizar a comparação de TXT arquivos usando Node.js."
    content: |
      É possível usar TXT arquivos usando [GroupDocs.Comparison](https://products.groupdocs.com/comparison/nodejs-java/) para obter relatórios sobre diferenças em muitos TXT arquivos
      ...
      2. Instancie o Comparador e forneça o caminho para o primeiro dos arquivos no formato TXT
      3. Adicionar outro arquivo TXT ao Comparer
