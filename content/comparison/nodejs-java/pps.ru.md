...
steps:
    ...
    content: |
      Можно использовать файлы PPS, используя [GroupDocs.Comparison](https://products.groupdocs.com/comparison/nodejs-java/) для получения отчета о различиях во многих PPS файлах
