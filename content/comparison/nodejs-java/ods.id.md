...
############################# Head ############################
head_title: "Bandingkan ODS menggunakan Perpustakaan JavaScript."
...
############################# Header ############################
title: "Membandingkan file ODS Anda di Node.js" 
description: "Pustaka perbandingan dokumen berdasarkan Node.js memberikan kesempatan untuk mengumpulkan dan menampilkan data tentang perbedaan apa pun dalam file ODS. Tingkatkan produktivitas solusi Anda dalam tugas perbandingan file dengan GroupDocs.Comparison."
...
steps:
    enable: true
    title: "Cara melakukan perbandingan file ODS menggunakan Node.js."
    content: |
      Dimungkinkan untuk menggunakan file ODS menggunakan [GroupDocs.Comparison](https://products.groupdocs.com/comparison/nodejs-java/) untuk mendapatkan laporan tentang perbedaan di banyak file ODS
      ...
      2. Buat instance Comparer dan berikan path ke file pertama dalam format ODS
      3. Tambahkan file ODS lainnya ke Comparer
