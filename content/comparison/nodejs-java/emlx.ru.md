...
steps:
    ...
    content: |
      Можно использовать файлы EMLX, используя [GroupDocs.Comparison](https://products.groupdocs.com/comparison/nodejs-java/) для получения отчета о различиях во многих EMLX файлах
