...
############################# Head ############################
head_title: "Effortlessly compare POTX documents using the Node.js PDF Comparison Library with JavaScript."
...
############################# Header ############################
title: "Comparing your POTX files in Node.js" 
description: "Document comparison library based on Node.js provides opportunity to collect and display data about any distinctions in POTX files. Enhance the productivity of your solutions in file comparison tasks with GroupDocs.Comparison."
...
steps:
    enable: true
    title: "How to perform POTX files comparison using Node.js."
    content: |
      It is possible to use POTX files using [GroupDocs.Comparison](https://products.groupdocs.com/comparison/nodejs-java/) for getting report about differences in many POTX files
      
      1. Install GroupDocs.Comparison for Node.js via Java using [NPM](https://www.npmjs.com/package/@groupdocs/groupdocs.comparison)
      2. Instantiate the Comparer and providing path to first of the files in the POTX format
      3. Add another POTX file to Comparer
