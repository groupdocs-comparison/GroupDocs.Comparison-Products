...
############################# Head ############################
head_title: "Java XLSB Comparison API - Check XLSB Files for Differences"
head_description: "Compare and merge XLSB files in Java, J2EE, J2SE applications. Analyze differences summary in content, text & style of XLSB files, images and document formats."

############################# Header ############################
title: "Compare XLSB Files in Java" 
description: "Perform content comparison between more than two XLSB files in Java. Retrieve a list of differences and save the compared files to a single document."
...
steps:
    enable: true
    title: "How to compare several XLSB documents using Java"
    content: |
      Use [GroupDocs.Comparison](https://products.groupdocs.com/comparison/java/) to compare multiple XLSB files and generate a report detailing their differences
      ...
      2. Create an instance of the Comparer class setting path to one of XLSB files
      3. Add at least one additional XLSB to the Comparer instance
