...
############################# Head ############################
head_title: "Java PHP API di confronto - Confronta PHP file per le differenze"
head_description: "Confronta e unisci PHP file in applicazioni Java, J2EE, J2SE. Analizza il riepilogo delle differenze nel contenuto, nel testo e nello stile di PHP file, immagini e formati di documenti."

############################# Header ############################
title: "Confronta PHP File in Java"
description: "Esegui un confronto riga per riga tra più di due file PHP in Java. Recupera un elenco di differenze e salva i file confrontati in un unico documento."
...
steps:
    enable: true
    title_left: "Passi per confrontare i file PHP in Java"
    content_left: |
...
demos:
    enable: true
    title: "Demo dal vivo per confrontare PHP file"
    content: |
        Confronta subito PHP file visitando il sito web [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
