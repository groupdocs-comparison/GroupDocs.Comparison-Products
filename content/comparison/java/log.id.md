...
############################# Head ############################
head_title: "Java LOG API Perbandingan - Periksa LOG File untuk Perbedaan"
head_description: "Bandingkan dan gabungkan LOG file dalam aplikasi Java, J2EE, J2SE. Analisis ringkasan perbedaan dalam konten, teks & gaya."

############################# Header ############################
title: "Bandingkan LOG File di Java" 
description: "Lakukan perbandingan konten antara lebih dari dua LOG file di Java. Ambil daftar perbedaan dan simpan file yang dibandingkan ke satu dokumen."
...
steps:
    enable: true
    title: "Cara membandingkan beberapa dokumen LOG menggunakan Java"
    content: |
      Gunakan [GroupDocs.Comparison](https://products.groupdocs.com/comparison/java/) untuk membandingkan beberapa file LOG dan menghasilkan laporan yang merinci perbedaannya
      ...
      2. Buat instance jalur pengaturan kelas Comparer ke salah satu dari LOG file
      3. Tambahkan setidaknya satu LOG tambahan ke instance Comparer
