...
############################# Head ############################
head_title: "Java MOBI API Perbandingan - Periksa MOBI File untuk Perbedaan"
head_description: "Bandingkan dan gabungkan MOBI file dalam aplikasi Java, J2EE, J2SE. Analisis ringkasan perbedaan dalam konten, teks & gaya."

############################# Header ############################
title: "Bandingkan MOBI File di Java" 
description: "Lakukan perbandingan konten antara lebih dari dua MOBI file di Java. Ambil daftar perbedaan dan simpan file yang dibandingkan ke satu dokumen."
...
steps:
    enable: true
    title: "Cara membandingkan beberapa dokumen MOBI menggunakan Java"
    content: |
      Gunakan [GroupDocs.Comparison](https://products.groupdocs.com/comparison/java/) untuk membandingkan beberapa file MOBI dan menghasilkan laporan yang merinci perbedaannya
      ...
      2. Buat instance jalur pengaturan kelas Comparer ke salah satu dari MOBI file
      3. Tambahkan setidaknya satu MOBI tambahan ke instance Comparer
