...
############################# Head ############################
head_title: "API Perbandingan RB Java - Bandingkan File RB untuk Perbedaan"
head_description: "Bandingkan dan gabungkan file RB di aplikasi Java, J2EE, J2SE. Analisis perbedaan ringkasan dalam konten, teks & gaya file RB, gambar, dan format dokumen."

############################# Header ############################
title: "Bandingkan File RB di Jawa"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Membandingkan File RB di Java"
    content_left: |
        [GroupDocs.Comparison](/id/comparison/java/) memudahkan pengembang Java untuk membandingkan file RB dalam aplikasi mereka menggunakan beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung untuk Membandingkan RB File"
    content: |
        Bandingkan file RB sekarang dengan mengunjungi situs web [GroupDocs.Comparison](https://products.groupdocs.app/comparison/family). Demo langsung memiliki manfaat sebagai berikut.
