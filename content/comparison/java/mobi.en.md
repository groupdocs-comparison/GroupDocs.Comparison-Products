...
############################# Head ############################
head_title: "Java MOBI Comparison API - Check MOBI Files for Differences"
head_description: "Compare and merge MOBI files in Java, J2EE, J2SE applications. Analyze differences summary in content, text & style of MOBI files, images and document formats."

############################# Header ############################
title: "Compare MOBI Files in Java" 
description: "Perform content comparison between more than two MOBI files in Java. Retrieve a list of differences and save the compared files to a single document."
...
steps:
    enable: true
    title: "How to compare several MOBI documents using Java"
    content: |
      Use [GroupDocs.Comparison](https://products.groupdocs.com/comparison/java/) to compare multiple MOBI files and generate a report detailing their differences
      ...
      2. Create an instance of the Comparer class setting path to one of MOBI files
      3. Add at least one additional MOBI to the Comparer instance
