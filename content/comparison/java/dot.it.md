...
############################# Head ############################
head_title: "Java DOT API di confronto - Confronta DOT file per le differenze"
head_description: "Confronta e unisci DOT file in applicazioni Java, J2EE, J2SE. Analizza il riepilogo delle differenze nel contenuto, nel testo e nello stile di DOT file, immagini e formati di documenti."

############################# Header ############################
title: "Confronta DOT File in Java"
description: "Esegui un confronto riga per riga tra più di due file DOT in Java. Recupera un elenco di differenze e salva i file confrontati in un unico documento."
...
steps:
    enable: true
    title_left: "Passi per confrontare i file DOT in Java"
    content_left: |
...
demos:
    enable: true
    title: "Demo dal vivo per confrontare DOT file"
    content: |
        Confronta subito DOT file visitando il sito web [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
