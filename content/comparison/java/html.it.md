...
############################# Head ############################
head_title: "Java HTML API di confronto - Confronta HTML file per le differenze"
head_description: "Confronta e unisci HTML file in applicazioni Java, J2EE, J2SE. Analizza il riepilogo delle differenze nel contenuto, nel testo e nello stile di HTML file, immagini e formati di documenti."

############################# Header ############################
title: "Confronta HTML File in Java"
description: "Esegui un confronto riga per riga tra più di due file HTML in Java. Recupera un elenco di differenze e salva i file confrontati in un unico documento."
...
steps:
    enable: true
    title_left: "Passi per confrontare i file HTML in Java"
    content_left: |
...
demos:
    enable: true
    title: "Demo dal vivo per confrontare HTML file"
    content: |
        Confronta subito HTML file visitando il sito web [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
