...
############################# Head ############################
head_title: "API di confronto Java HTML - Verifica la presenza di differenze tra i file HTML"
head_description: "Confronta e unisci i file HTML nelle applicazioni Java, J2EE, J2SE. Analizza il riepilogo delle differenze in termini di contenuto, testo e stile."

############################# Header ############################
title: "Confronta HTML file in Java" 
description: "Esegui il confronto dei contenuti tra più di due file HTML in Java. Recupera un elenco di differenze e salva i file confrontati in un unico documento."
...
steps:
    enable: true
    title: "Come confrontare diversi documenti HTML utilizzando Java"
    content: |
      Usa [GroupDocs.Comparison](https://products.groupdocs.com/comparison/java/) per confrontare più file HTML e generare un rapporto che descriva in dettaglio le loro differenze
      ...
      2. Crea un'istanza della classe Comparer impostando il percorso di uno dei file HTML
      3. Aggiungi almeno un altro HTML all'istanza di Comparer
