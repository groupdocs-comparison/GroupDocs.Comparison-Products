...
head_description: "Сравнивайте и объединяйте файлы DJVU в приложениях Java, J2EE, J2SE. Проанализируйте сводку различий в содержании, тексте и усилителях. стиль файлов, изображений и форматов документов DJVU."
############################# Header ############################
