...
############################# Head ############################
head_title: "Java ODP Comparison API - Check ODP Files for Differences"
head_description: "Compare and merge ODP files in Java, J2EE, J2SE applications. Analyze differences summary in content, text & style of ODP files, images and document formats."

############################# Header ############################
title: "Compare ODP Files in Java" 
description: "Perform content comparison between more than two ODP files in Java. Retrieve a list of differences and save the compared files to a single document."
...
steps:
    enable: true
    title: "How to compare several ODP documents using Java"
    content: |
      Use [GroupDocs.Comparison](https://products.groupdocs.com/comparison/java/) to compare multiple ODP files and generate a report detailing their differences
      ...
      2. Create an instance of the Comparer class setting path to one of ODP files
      3. Add at least one additional ODP to the Comparer instance
