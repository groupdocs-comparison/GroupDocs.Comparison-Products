...
############################# Head ############################
head_title: "Java MHT Comparison API - Check MHT Files for Differences"
head_description: "Compare and merge MHT files in Java, J2EE, J2SE applications. Analyze differences summary in content, text & style of MHT files, images and document formats."

############################# Header ############################
title: "Compare MHT Files in Java" 
description: "Perform content comparison between more than two MHT files in Java. Retrieve a list of differences and save the compared files to a single document."
...
steps:
    enable: true
    title: "How to compare several MHT documents using Java"
    content: |
      Use [GroupDocs.Comparison](https://products.groupdocs.com/comparison/java/) to compare multiple MHT files and generate a report detailing their differences
      ...
      2. Create an instance of the Comparer class setting path to one of MHT files
      3. Add at least one additional MHT to the Comparer instance
