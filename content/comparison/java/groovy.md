...
############################# Head ############################
head_title: "Java GROOVY Comparison API - Compare GROOVY Files for Differences"
head_description: "Compare and merge GROOVY files in Java, J2EE, J2SE applications. Analyse differences summary in content, text & style of GROOVY files, images and document formats."

############################# Header ############################
title: "Compare GROOVY Files in Java"
description: "Perform a line-by-line comparison between more than two GROOVY files in Java. Retrieve a list of differences and save the compared files to a single document."
...
steps:
    enable: true
    title_left: "Steps for Comparing GROOVY Files in Java"
    content_left: |
        [GroupDocs.Comparison](/comparison/java/) makes it easy for Java developers to compare GROOVY files within their applications using a few lines of code.
...
demos:
    enable: true
    title: "Live Demos to Compare GROOVY Files"
    content: |
        Compare GROOVY files right now by visiting [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family) website.  
