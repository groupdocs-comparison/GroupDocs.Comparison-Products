...
############################# Head ############################
head_title: "Java LOG Vergleichs-API — LOG Dateien auf Unterschiede überprüfen"
head_description: "Vergleichen und führen Sie LOG Dateien in Java, J2EE- und J2SE-Anwendungen zusammen. Analysieren Sie die Unterschiede zusammenfassend in Inhalt, Text und Stil."

############################# Header ############################
title: "Vergleiche LOG Dateien in Java" 
description: "Führen Sie einen Inhaltsvergleich zwischen mehr als zwei LOG Dateien in Java durch. Rufen Sie eine Liste der Unterschiede ab und speichern Sie die verglichenen Dateien in einem einzigen Dokument."
...
steps:
    enable: true
    title: "So vergleichen Sie mehrere LOG Dokumente mit Java"
    content: |
      Verwenden Sie [GroupDocs.Comparison](https://products.groupdocs.com/comparison/java/), um mehrere LOG Dateien zu vergleichen und einen Bericht zu erstellen, in dem die Unterschiede detailliert beschrieben werden
      ...
      2. Erstellen Sie eine Instanz des Comparer-Klasseneinstellungspfads zu einer von LOG Dateien
      3. Fügen Sie der Comparer-Instanz mindestens eine weitere LOG hinzu
    ...
    code:
      ...
      content: |
        ...
        try (Comparer comparer = new Comparer("source.log") 
        {
            ...
            final Path resultPath = comparer.compare("result.log"); 
