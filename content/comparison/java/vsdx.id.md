...
############################# Head ############################
head_title: "Java VSDX API Perbandingan - Periksa VSDX File untuk Perbedaan"
head_description: "Bandingkan dan gabungkan VSDX file dalam aplikasi Java, J2EE, J2SE. Analisis ringkasan perbedaan dalam konten, teks & gaya."

############################# Header ############################
title: "Bandingkan VSDX File di Java" 
description: "Lakukan perbandingan konten antara lebih dari dua VSDX file di Java. Ambil daftar perbedaan dan simpan file yang dibandingkan ke satu dokumen."
...
steps:
    enable: true
    title: "Cara membandingkan beberapa dokumen VSDX menggunakan Java"
    content: |
      Gunakan [GroupDocs.Comparison](https://products.groupdocs.com/comparison/java/) untuk membandingkan beberapa file VSDX dan menghasilkan laporan yang merinci perbedaannya
      ...
      2. Buat instance jalur pengaturan kelas Comparer ke salah satu dari VSDX file
      3. Tambahkan setidaknya satu VSDX tambahan ke instance Comparer
