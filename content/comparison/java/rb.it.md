...
############################# Head ############################
head_title: "API di confronto Java RB - Verifica la presenza di differenze tra i file RB"
head_description: "Confronta e unisci i file RB nelle applicazioni Java, J2EE, J2SE. Analizza il riepilogo delle differenze in termini di contenuto, testo e stile."

############################# Header ############################
title: "Confronta RB file in Java" 
description: "Esegui il confronto dei contenuti tra più di due file RB in Java. Recupera un elenco di differenze e salva i file confrontati in un unico documento."
...
steps:
    enable: true
    title: "Come confrontare diversi documenti RB utilizzando Java"
    content: |
      Usa [GroupDocs.Comparison](https://products.groupdocs.com/comparison/java/) per confrontare più file RB e generare un rapporto che descriva in dettaglio le loro differenze
      ...
      2. Crea un'istanza della classe Comparer impostando il percorso di uno dei file RB
      3. Aggiungi almeno un altro RB all'istanza di Comparer
