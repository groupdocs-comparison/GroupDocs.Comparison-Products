...
############################# Head ############################
head_title: "Java RB API di confronto - Confronta RB file per le differenze"
head_description: "Confronta e unisci RB file in applicazioni Java, J2EE, J2SE. Analizza il riepilogo delle differenze nel contenuto, nel testo e nello stile di RB file, immagini e formati di documenti."

############################# Header ############################
title: "Confronta RB File in Java"
description: "Esegui un confronto riga per riga tra più di due file RB in Java. Recupera un elenco di differenze e salva i file confrontati in un unico documento."
...
steps:
    enable: true
    title_left: "Passi per confrontare i file RB in Java"
    content_left: |
...
demos:
    enable: true
    title: "Demo dal vivo per confrontare RB file"
    content: |
        Confronta subito RB file visitando il sito web [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
