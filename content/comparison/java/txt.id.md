...
############################# Head ############################
head_title: "Java TXT API Perbandingan - Periksa TXT File untuk Perbedaan"
head_description: "Bandingkan dan gabungkan TXT file dalam aplikasi Java, J2EE, J2SE. Analisis ringkasan perbedaan dalam konten, teks & gaya."

############################# Header ############################
title: "Bandingkan TXT File di Java" 
description: "Lakukan perbandingan konten antara lebih dari dua TXT file di Java. Ambil daftar perbedaan dan simpan file yang dibandingkan ke satu dokumen."
...
steps:
    enable: true
    title: "Cara membandingkan beberapa dokumen TXT menggunakan Java"
    content: |
      Gunakan [GroupDocs.Comparison](https://products.groupdocs.com/comparison/java/) untuk membandingkan beberapa file TXT dan menghasilkan laporan yang merinci perbedaannya
      ...
      2. Buat instance jalur pengaturan kelas Comparer ke salah satu dari TXT file
      3. Tambahkan setidaknya satu TXT tambahan ke instance Comparer
