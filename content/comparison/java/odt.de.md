...
############################# Head ############################
head_title: "Java ODT Vergleichs-API – Vergleichen Sie ODT-Dateien auf Unterschiede"
head_description: "Vergleichen und führen Sie ODT-Dateien in Java-, J2EE- und J2SE-Anwendungen zusammen. Analysieren Sie eine Zusammenfassung der Unterschiede in Inhalt, Text und Stil von ODT-Dateien, Bildern und Dokumentformaten."

############################# Header ############################
title: "Vergleichen Sie ODT Dateien in Java"
description: "Führen Sie einen zeilenweisen Vergleich zwischen mehr als zwei ODT-Dateien in Java durch. Rufen Sie eine Liste der Unterschiede ab und speichern Sie die verglichenen Dateien in einem einzigen Dokument."
...
steps:
    enable: true
    title_left: "Schritte zum Vergleichen von ODT-Dateien in Java"
    content_left: |
        [GroupDocs.Comparison](/comparison/java/) erleichtert Java-Entwicklern den Vergleich von ODT-Dateien in ihren Anwendungen mithilfe weniger Codezeilen.
    ...
    code: |
        ...
        try (Comparer comparer = new Comparer("C:\\source.odt")) {
            ...
            comparer.compare("C:\\result.odt"); // Ergebnisdatei mit dem angegebenen Namen erstellen
        }
        ...
        try (Comparer comparer = new Comparer(new FileInputStream("C:\\source.odt"))) {
            ...
            comparer.compare(new FileOutputStream("C:\\result.odt")); // Ergebnisdatei mit dem angegebenen Namen erstellen
        }
        ```
...
demos:
    ...
    content: |
        Vergleichen Sie jetzt ODT-Dateien auf der Website [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
