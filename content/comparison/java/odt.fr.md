...
############################# Head ############################
head_title: "Java API de comparaison ODT - Comparez les fichiers ODT pour les différences"
head_description: "Comparez et fusionnez les fichiers ODT dans les applications Java, J2EE, J2SE. Analysez le résumé des différences dans le contenu, le texte et le style des fichiers, images et formats de document ODT."

############################# Header ############################
title: "Comparez les fichiers ODT dans Java"
...
steps:
    ...
    code: |
        ...
        try (Comparer comparer = new Comparer("C:\\source.odt")) {
            ...
            comparer.compare("C:\\result.odt"); // Crée un fichier résultat avec le nom spécifié
        }
        ...
        try (Comparer comparer = new Comparer(new FileInputStream("C:\\source.odt"))) {
            ...
            comparer.compare(new FileOutputStream("C:\\result.odt")); // Crée un fichier résultat avec le nom spécifié
        }
        ```
...
demos:
    ...
    content: |
        Comparez les fichiers ODT dès maintenant en visitant le site Web [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
