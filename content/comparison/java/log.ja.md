...
head_title: "JavaLOG比較API-LOGファイルの違いを比較します"
head_description: "Java、J2EE、J2SEアプリケーションのLOGファイルを比較してマージします。コンテンツ、テキスト、およびテキストの違いの要約を分析します。ログファイル、画像、ドキュメント形式のスタイル."

title: "Javaでログファイルを比較する"
...
demos:
    enable: true
    title: "ログファイルを比較するためのライブデモ"
    content: |
        [GroupDocs.Comparisonライブデモ](https://products.groupdocs.app/comparison/family)サイトにアクセスして、今すぐLOGファイルを比較してください。  
        ライブデモには次の利点があります
