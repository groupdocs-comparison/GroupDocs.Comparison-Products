...
############################# Head ############################
head_title: "Java API de comparaison PPT - Comparez les fichiers PPT pour les différences"
head_description: "Comparez et fusionnez les fichiers PPT dans les applications Java, J2EE, J2SE. Analysez le résumé des différences dans le contenu, le texte et le style des fichiers, images et formats de document PPT."

############################# Header ############################
title: "Comparez les fichiers PPT dans Java"
...
steps:
    ...
    code: |
        ...
        try (Comparer comparer = new Comparer("C:\\source.ppt")) {
            ...
            comparer.compare("C:\\result.ppt"); // Crée un fichier résultat avec le nom spécifié
        }
        ...
        try (Comparer comparer = new Comparer(new FileInputStream("C:\\source.ppt"))) {
            ...
            comparer.compare(new FileOutputStream("C:\\result.ppt")); // Crée un fichier résultat avec le nom spécifié
        }
        ```
...
demos:
    ...
    content: |
        Comparez les fichiers PPT dès maintenant en visitant le site Web [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
