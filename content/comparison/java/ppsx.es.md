...
############################# Head ############################
head_title: "Java PPSX API de comparación: compruebe las diferencias en los archivos PPSX"
head_description: "Compare y combine PPSX archivos en aplicaciones Java, J2EE y J2SE. Analice el resumen de las diferencias en contenido, texto y estilo."

############################# Header ############################
title: "Compara PPSX archivos en Java" 
description: "Realice una comparación de contenido entre más de dos archivos PPSX en Java. Recupere una lista de diferencias y guarde los archivos comparados en un único documento."
...
steps:
    enable: true
    title: "Cómo comparar varios PPSX documentos usando Java"
    content: |
      Usa [GroupDocs.Comparison](https://products.groupdocs.com/comparison/java/) para comparar varios archivos PPSX y generar un informe en el que se detallen sus diferencias
      ...
      2. Cree una instancia de la ruta de configuración de la clase Comparer a uno de los PPSX archivos
      3. Agregue al menos un PPSX adicional a la instancia de Comparer
