...
############################# Head ############################
head_title: "Java MOBI API so sánh - Kiểm tra sự khác biệt của tập tin MOBI"
head_description: "So sánh và hợp nhất MOBI tệp trong các ứng dụng Java, J2EE, J2SE. Phân tích tóm tắt sự khác biệt trong nội dung, văn bản và phong cách."

############################# Header ############################
title: "So sánh MOBI tập tin trong Java" 
description: "Thực hiện so sánh nội dung giữa nhiều hơn hai MOBI tệp trong Java. Truy xuất danh sách các khác biệt và lưu các tệp đã so sánh vào một tài liệu duy nhất."
...
steps:
    enable: true
    title: "Cách so sánh một số tài liệu MOBI bằng cách sử dụng Java"
    content: |
      Sử dụng [GroupDocs.Comparison](https://products.groupdocs.com/comparison/java/) để so sánh nhiều tệp MOBI và tạo báo cáo chi tiết sự khác biệt của chúng
      ...
      2. Tạo một phiên bản của đường dẫn cài đặt lớp Comparer đến một trong MOBI tệp
      3. Thêm ít nhất một MOBI bổ sung vào phiên bản Comparer
