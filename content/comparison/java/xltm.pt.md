...
############################# Head ############################
head_title: "API de comparação Java XLTM - Compare arquivos XLTM em busca de diferenças"
...
############################# Header ############################
title: "Compare arquivos XLTM em Java"
...
steps:
    ...
    code: |
        ...
        try (Comparer comparer = new Comparer("C:\\source.xltm")) {
            ...
            comparer.compare("C:\\result.xltm"); // Crie um arquivo de resultado com o nome especificado
        }
        ...
        try (Comparer comparer = new Comparer(new FileInputStream("C:\\source.xltm"))) {
            ...
            comparer.compare(new FileOutputStream("C:\\result.xltm")); // Crie um arquivo de resultado com o nome especificado
        }
        ```
...
demos:
    ...
    content: |
        Compare arquivos XLTM agora mesmo visitando o site [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
