...
############################# Head ############################
head_title: "Java XLSB API Perbandingan - Periksa XLSB File untuk Perbedaan"
head_description: "Bandingkan dan gabungkan XLSB file dalam aplikasi Java, J2EE, J2SE. Analisis ringkasan perbedaan dalam konten, teks & gaya."

############################# Header ############################
title: "Bandingkan XLSB File di Java" 
description: "Lakukan perbandingan konten antara lebih dari dua XLSB file di Java. Ambil daftar perbedaan dan simpan file yang dibandingkan ke satu dokumen."
...
steps:
    enable: true
    title: "Cara membandingkan beberapa dokumen XLSB menggunakan Java"
    content: |
      Gunakan [GroupDocs.Comparison](https://products.groupdocs.com/comparison/java/) untuk membandingkan beberapa file XLSB dan menghasilkan laporan yang merinci perbedaannya
      ...
      2. Buat instance jalur pengaturan kelas Comparer ke salah satu dari XLSB file
      3. Tambahkan setidaknya satu XLSB tambahan ke instance Comparer
