...
############################# Head ############################
head_title: "Java DIFF 비교 API - DIFF 파일에 차이점이 있는지 확인하세요."
head_description: "Java, J2EE, J2SE 애플리케이션의 DIFF 개의 파일을 비교하고 병합합니다.콘텐츠, 텍스트 및 스타일의 차이점 요약을 분석합니다."

############################# Header ############################
title: "Java 의 DIFF 개 파일 비교" 
description: "Java 에 있는 두 개 이상의 DIFF 파일 간의 콘텐츠 비교를 수행합니다.차이점 목록을 검색하고 비교한 파일을 단일 문서에 저장합니다."
...
steps:
    enable: true
    title: "Java 을 사용하여 여러 DIFF 문서를 비교하는 방법"
    content: |
      [GroupDocs.Comparison](https://products.groupdocs.com/comparison/java/) 를 사용하여 여러 DIFF 개의 파일을 비교하고 차이점을 자세히 설명하는 보고서를 생성합니다.
      ...
      2. DIFF 파일 중 하나에 대한 Comparer 클래스 설정 경로의 인스턴스를 생성합니다.
      3. 콤퍼러 인스턴스에 DIFF 를 하나 이상 추가합니다.
