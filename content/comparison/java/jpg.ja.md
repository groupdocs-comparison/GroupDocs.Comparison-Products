...
head_title: "JavaJPG比較API-JPGファイルの違いを比較します"
head_description: "Java、J2EE、J2SEアプリケーションでJPGファイルを比較してマージします。コンテンツ、テキスト、およびテキストの違いの要約を分析します。 JPGファイル、画像、ドキュメント形式のスタイル."
...
steps:
    enable: true
    title_left: "JavaでJPGファイルを比較するための手順"
    content_left: |
