...
############################# Head ############################
head_title: "Java API de comparaison DOTX - Comparez les fichiers DOTX pour les différences"
head_description: "Comparez et fusionnez les fichiers DOTX dans les applications Java, J2EE, J2SE. Analysez le résumé des différences dans le contenu, le texte et le style des fichiers, images et formats de document DOTX."

############################# Header ############################
title: "Comparez les fichiers DOTX dans Java"
...
steps:
    ...
    code: |
        ...
        try (Comparer comparer = new Comparer("C:\\source.dotx")) {
            ...
            comparer.compare("C:\\result.dotx"); // Crée un fichier résultat avec le nom spécifié
        }
        ...
        try (Comparer comparer = new Comparer(new FileInputStream("C:\\source.dotx"))) {
            ...
            comparer.compare(new FileOutputStream("C:\\result.dotx")); // Crée un fichier résultat avec le nom spécifié
        }
        ```
...
demos:
    ...
    content: |
        Comparez les fichiers DOTX dès maintenant en visitant le site Web [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
