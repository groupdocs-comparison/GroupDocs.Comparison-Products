...
############################# Head ############################
head_title: "API de comparación Java OTT: compare archivos OTT en busca de diferencias"
head_description: "Compare y combine archivos OTT en aplicaciones Java, J2EE, J2SE. Analice el resumen de diferencias en contenido, texto y estilo de OTT archivos, imágenes y formatos de documentos."

############################# Header ############################
title: "Comparar archivos OTT en Java"
description: "Realice una comparación línea por línea entre más de dos archivos OTT en Java. Recupere una lista de diferencias y guarde los archivos comparados en un solo documento."
...
steps:
    enable: true
    title_left: "Pasos para comparar archivos OTT en Java"
    content_left: |
        [GroupDocs.Comparison](/comparison/java/) facilita a los desarrolladores de Java comparar archivos OTT dentro de sus aplicaciones utilizando unas pocas líneas de código.
    ...
    code: |
        ...
        try (Comparer comparer = new Comparer("C:\\source.ott")) {
            ...
            comparer.compare("C:\\result.ott"); // Crear archivo de resultados con el nombre especificado
        }
        ...
        try (Comparer comparer = new Comparer(new FileInputStream("C:\\source.ott"))) {
            ...
            comparer.compare(new FileOutputStream("C:\\result.ott")); // Crear archivo de resultados con el nombre especificado
        }
        ```
...
demos:
    enable: true
    title: "Demostraciones en vivo para comparar archivos OTT"
    content: |
        Compare archivos OTT ahora mismo visitando el sitio web [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-ott"
          ...
          content: |
            Los archivos con extensión OTT representan documentos de plantilla generados por aplicaciones de acuerdo con el formato estándar OpenDocument de OASIS. Estos se crean con aplicaciones de procesador de textos, como OpenOffice Writer, y pueden contener configuraciones que pueden usarse para generar nuevos documentos a partir de estos archivos de plantilla. Estas configuraciones incluyen márgenes de página, bordes, encabezados, pies de página y otras configuraciones de página. Estas plantillas se utilizan en documentos oficiales, como membretes de empresas y formularios estandarizados.
