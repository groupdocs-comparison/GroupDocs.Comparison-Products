...
head_title: "JavaDJVU比較API-違いについてDJVUファイルを比較する"
...
demos:
    ...
    content: |
        [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family)Webサイトにアクセスして、DJVUファイルを今すぐ比較してください。  
        ライブデモには次の利点があります
