...
############################# Head ############################
head_title: "Java GROOVY Comparison API - Check GROOVY Files for Differences"
head_description: "Compare and merge GROOVY files in Java, J2EE, J2SE applications. Analyze differences summary in content, text & style of GROOVY files, images and document formats."

############################# Header ############################
title: "Compare GROOVY Files in Java" 
description: "Perform content comparison between more than two GROOVY files in Java. Retrieve a list of differences and save the compared files to a single document."
...
steps:
    enable: true
    title: "How to compare several GROOVY documents using Java"
    content: |
      Use [GroupDocs.Comparison](https://products.groupdocs.com/comparison/java/) to compare multiple GROOVY files and generate a report detailing their differences
      ...
      2. Create an instance of the Comparer class setting path to one of GROOVY files
      3. Add at least one additional GROOVY to the Comparer instance
