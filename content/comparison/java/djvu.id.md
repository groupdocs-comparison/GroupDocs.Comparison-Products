...
############################# Head ############################
head_title: "Java DJVU API Perbandingan - Periksa DJVU File untuk Perbedaan"
head_description: "Bandingkan dan gabungkan DJVU file dalam aplikasi Java, J2EE, J2SE. Analisis ringkasan perbedaan dalam konten, teks & gaya."

############################# Header ############################
title: "Bandingkan DJVU File di Java" 
description: "Lakukan perbandingan konten antara lebih dari dua DJVU file di Java. Ambil daftar perbedaan dan simpan file yang dibandingkan ke satu dokumen."
...
steps:
    enable: true
    title: "Cara membandingkan beberapa dokumen DJVU menggunakan Java"
    content: |
      Gunakan [GroupDocs.Comparison](https://products.groupdocs.com/comparison/java/) untuk membandingkan beberapa file DJVU dan menghasilkan laporan yang merinci perbedaannya
      ...
      2. Buat instance jalur pengaturan kelas Comparer ke salah satu dari DJVU file
      3. Tambahkan setidaknya satu DJVU tambahan ke instance Comparer
