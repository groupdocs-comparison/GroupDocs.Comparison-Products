...
############################# Head ############################
head_title: "API de comparação Java DOCM - Compare arquivos DOCM em busca de diferenças"
head_description: "Compare e mescle arquivos DOCM em aplicativos Java, J2EE, J2SE. Analise o resumo das diferenças no conteúdo, texto e estilo de DOCM arquivos, imagens e formatos de documentos."

############################# Header ############################
title: "Compare arquivos DOCM em Java"
description: "Execute uma comparação linha por linha entre mais de dois arquivos DOCM em Java. Recupere uma lista de diferenças e salve os arquivos comparados em um único documento."
...
steps:
    enable: true
    title_left: "Etapas para comparar arquivos DOCM em Java"
    content_left: |
        [GroupDocs.Comparison](/comparison/java/) torna mais fácil para os desenvolvedores Java comparar arquivos DOCM em seus aplicativos usando algumas linhas de código.
    ...
    code: |
        ...
        try (Comparer comparer = new Comparer("C:\\source.docm")) {
            ...
            comparer.compare("C:\\result.docm"); // Crie um arquivo de resultado com o nome especificado
        }
        ...
        try (Comparer comparer = new Comparer(new FileInputStream("C:\\source.docm"))) {
            ...
            comparer.compare(new FileOutputStream("C:\\result.docm")); // Crie um arquivo de resultado com o nome especificado
        }
        ```
...
demos:
    enable: true
    title: "Demonstrações ao vivo para comparar arquivos DOCM"
    content: |
        Compare arquivos DOCM agora mesmo visitando o site [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-docm"
          ...
          content: |
            Arquivos DOCM são documentos gerados pelo Microsoft Word 2007 ou superior com a capacidade de executar macros. É semelhante ao formato de arquivo DOCX, mas a capacidade de executar macros o torna diferente do DOCX. Assim como o DOCX, os arquivos DOCM podem armazenar texto, imagens, tabelas, formas, gráficos e outros conteúdos. A capacidade de executar macros facilita a economia de tempo executando uma série de comandos na forma de ações gravadas para conclusão automática de uma tarefa . Os arquivos DOCM podem ser abertos e editados no Microsoft Word 2007 e superior.
