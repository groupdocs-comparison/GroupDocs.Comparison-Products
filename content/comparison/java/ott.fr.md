...
############################# Head ############################
head_title: "API de comparaison Java OTT - Comparez les fichiers OTT pour les différences"
head_description: "Comparez et fusionnez des fichiers OTT dans des applications Java, J2EE, J2SE. Analysez le résumé des différences dans le contenu, le texte et le style des fichiers, images et formats de documents OTT."

############################# Header ############################
title: "Comparez les fichiers OTT en Java"
description: "Effectuez une comparaison ligne par ligne entre plus de deux fichiers OTT en Java. Récupérez une liste des différences et enregistrez les fichiers comparés dans un seul document."
...
steps:
    enable: true
    title_left: "Étapes pour comparer les fichiers OTT en Java"
    content_left: |
        [GroupDocs.Comparison](/comparison/java/) permet aux développeurs Java de comparer facilement les fichiers OTT au sein de leurs applications à l'aide de quelques lignes de code.
    ...
    code: |
        ...
        try (Comparer comparer = new Comparer("C:\\source.ott")) {
            comparer.add("C:\\target.ott");
            comparer.compare("C:\\result.ott"); // Créer un fichier de résultats avec le nom spécifié
        }
        
        // Comparer les documents du flux
        
        try (Comparer comparer = new Comparer(new FileInputStream("C:\\source.ott"))) {
            comparer.add(new FileInputStream("C:\\target.ott"));
            comparer.compare(new FileOutputStream("C:\\result.ott")); // Créer un fichier de résultats avec le nom spécifié
        }
        ```
...
demos:
    enable: true
    title: "Démos en direct pour comparer les fichiers OTT"
    content: |
        Comparez dès maintenant les fichiers OTT en visitant le site Web [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-ott"
          ...
          content: |
            Les fichiers avec l'extension OTT représentent des documents modèles générés par des applications conformément au format standard OpenDocument d'OASIS. Ceux-ci sont créés avec des applications de traitement de texte telles que OpenOffice Writer gratuit et peuvent contenir des paramètres pouvant être utilisés pour générer de nouveaux documents à partir de ces fichiers modèles. Ces paramètres incluent les marges de page, les bordures, les en-têtes, les pieds de page et d'autres paramètres de page. De tels modèles sont utilisés dans les documents officiels tels que les papiers à en-tête des entreprises et les formulaires standardisés.
...
solutions:
    ...
    solution:
        # solution loop
        - img_alt: "GroupDocs.Comparison for .NET OTT"
