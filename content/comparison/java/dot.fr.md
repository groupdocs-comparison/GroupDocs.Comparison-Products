...
############################# Head ############################
head_title: "Java API de comparaison DOT - Comparez les fichiers DOT pour les différences"
head_description: "Comparez et fusionnez les fichiers DOT dans les applications Java, J2EE, J2SE. Analysez le résumé des différences dans le contenu, le texte et le style des fichiers, images et formats de document DOT."

############################# Header ############################
title: "Comparez les fichiers DOT dans Java"
...
steps:
    ...
    code: |
        ...
        try (Comparer comparer = new Comparer("C:\\source.dot")) {
            ...
            comparer.compare("C:\\result.dot"); // Crée un fichier résultat avec le nom spécifié
        }
        ...
        try (Comparer comparer = new Comparer(new FileInputStream("C:\\source.dot"))) {
            ...
            comparer.compare(new FileOutputStream("C:\\result.dot")); // Crée un fichier résultat avec le nom spécifié
        }
        ```
...
demos:
    ...
    content: |
        Comparez les fichiers DOT dès maintenant en visitant le site Web [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
