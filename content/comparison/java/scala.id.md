...
############################# Head ############################
head_title: "Java SCALA API Perbandingan - Periksa SCALA File untuk Perbedaan"
head_description: "Bandingkan dan gabungkan SCALA file dalam aplikasi Java, J2EE, J2SE. Analisis ringkasan perbedaan dalam konten, teks & gaya."

############################# Header ############################
title: "Bandingkan SCALA File di Java" 
description: "Lakukan perbandingan konten antara lebih dari dua SCALA file di Java. Ambil daftar perbedaan dan simpan file yang dibandingkan ke satu dokumen."
...
steps:
    enable: true
    title: "Cara membandingkan beberapa dokumen SCALA menggunakan Java"
    content: |
      Gunakan [GroupDocs.Comparison](https://products.groupdocs.com/comparison/java/) untuk membandingkan beberapa file SCALA dan menghasilkan laporan yang merinci perbedaannya
      ...
      2. Buat instance jalur pengaturan kelas Comparer ke salah satu dari SCALA file
      3. Tambahkan setidaknya satu SCALA tambahan ke instance Comparer
