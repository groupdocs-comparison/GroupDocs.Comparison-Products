...
############################# Head ############################
head_title: "Java OTT API di confronto - Confronta OTT file per le differenze"
head_description: "Confronta e unisci OTT file in applicazioni Java, J2EE, J2SE. Analizza il riepilogo delle differenze nel contenuto, nel testo e nello stile di OTT file, immagini e formati di documenti."

############################# Header ############################
title: "Confronta OTT File in Java"
description: "Esegui un confronto riga per riga tra più di due file OTT in Java. Recupera un elenco di differenze e salva i file confrontati in un unico documento."
...
steps:
    enable: true
    title_left: "Passi per confrontare i file OTT in Java"
    content_left: |
...
demos:
    enable: true
    title: "Demo dal vivo per confrontare OTT file"
    content: |
        Confronta subito OTT file visitando il sito web [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
