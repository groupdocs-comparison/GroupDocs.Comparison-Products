...
############################# Head ############################
head_title: "API di confronto Java OTT: confronta i file OTT per le differenze"
head_description: "Confronta e unisci file OTT nelle applicazioni Java, J2EE, J2SE. Analizza il riepilogo delle differenze nel contenuto, nel testo e nello stile di file, immagini e formati di documenti OTT."

############################# Header ############################
title: "Confronta i file OTT in Java"
description: "Esegui un confronto riga per riga tra più di due file OTT in Java. Recupera un elenco di differenze e salva i file confrontati in un singolo documento."
...
steps:
    enable: true
    title_left: "Passaggi per confrontare i file OTT in Java"
    content_left: |
        [GroupDocs.Comparison](/comparison/java/) consente agli sviluppatori Java di confrontare facilmente i file OTT all'interno delle loro applicazioni utilizzando poche righe di codice.
    ...
    code: |
        ...
        try (Comparer comparer = new Comparer("C:\\source.ott")) {
            ...
            comparer.compare("C:\\result.ott"); // Crea il file dei risultati con il nome specificato
        }
        ...
        try (Comparer comparer = new Comparer(new FileInputStream("C:\\source.ott"))) {
            ...
            comparer.compare(new FileOutputStream("C:\\result.ott")); // Crea il file dei risultati con il nome specificato
        }
        ```
...
demos:
    enable: true
    title: "Demo dal vivo per confrontare file OTT"
    content: |
        Confronta subito i file OTT visitando il sito web [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-ott"
          ...
          content: |
            I file con estensione OTT rappresentano documenti modello generati dalle applicazioni in conformità con il formato standard OpenDocument di OASIS. Questi vengono creati con applicazioni di elaborazione testi come OpenOffice Writer gratuito e possono contenere impostazioni che possono essere utilizzate per generare nuovi documenti da questi file modello. Queste impostazioni includono margini della pagina, bordi, intestazioni, piè di pagina e altre impostazioni della pagina. Tali modelli vengono utilizzati nei documenti ufficiali come carta intestata aziendale e moduli standardizzati.
