...
steps:
    ...
    content_left: |
        [GroupDocs.Comparison](/comparison/java/) erleichtert Java-Entwicklern den Vergleich von LESS-Dateien in ihren Anwendungen mit nur wenigen Codezeilen.
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-less"
          title: "Informationen zum Dateiformat LESS"
          content: |
            {{less}}
