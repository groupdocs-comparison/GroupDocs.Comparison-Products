...
############################# Head ############################
head_title: "Java CPP API сравнения — проверьте CPP файлы на наличие различий"
head_description: "Сравните и объедините CPP файлов в приложениях Java, J2EE, J2SE. Проанализируйте сводку различий в содержании, тексте и стиле."

############################# Header ############################
title: "Сравните CPP файлов в Java" 
description: "Выполните сравнение содержимого более чем двух CPP файлов в Java. Получите список различий и сохраните сравниваемые файлы в одном документе."
...
steps:
    enable: true
    title: "Как сравнить несколько CPP документов с помощью Java"
    content: |
      Используйте [GroupDocs.Comparison](https://products.groupdocs.com/comparison/java/) для сравнения нескольких CPP файлов и создания отчета с подробным описанием их различий
      ...
      2. Создайте экземпляр класса Comparer, задав путь к одному из CPP файлов
      3. Добавьте хотя бы один дополнительный CPP к экземпляру Comparer
