...
############################# Head ############################
head_title: "Java RB Comparison API - Compare RB Filesfor Differences"
...
description: "Perform a line-by-line comparison between more than two RB files in Java. Retrieve a list of differences and save the compared files to a single document."
...
steps:
    ...
    content_left: |
        [GroupDocs.Comparison](https://products.groupdocs.com/comparison/java) makes it easy for Java developers to compare RB files within their applications using a few lines of code.
...
demos:
    enable: true
    title: "Live Demos to Compare RB Files"
    content: |
