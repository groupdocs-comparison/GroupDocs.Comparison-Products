...
############################# Head ############################
head_title: "Java API de comparaison PDF - Comparez les fichiers PDF pour les différences"
head_description: "Comparez et fusionnez les fichiers PDF dans les applications Java, J2EE, J2SE. Analysez le résumé des différences dans le contenu, le texte et le style des fichiers, images et formats de document PDF."

############################# Header ############################
title: "Comparez les fichiers PDF dans Java"
...
steps:
    ...
    code: |
        ...
        try (Comparer comparer = new Comparer("C:\\source.pdf")) {
            ...
            comparer.compare("C:\\result.pdf"); // Crée un fichier résultat avec le nom spécifié
        }
        ...
        try (Comparer comparer = new Comparer(new FileInputStream("C:\\source.pdf"))) {
            ...
            comparer.compare(new FileOutputStream("C:\\result.pdf")); // Crée un fichier résultat avec le nom spécifié
        }
        ```
...
demos:
    ...
    content: |
        Comparez les fichiers PDF dès maintenant en visitant le site Web [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
