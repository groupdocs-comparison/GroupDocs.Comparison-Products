...
############################# Head ############################
head_title: "Java ODS API Perbandingan - Periksa ODS File untuk Perbedaan"
head_description: "Bandingkan dan gabungkan ODS file dalam aplikasi Java, J2EE, J2SE. Analisis ringkasan perbedaan dalam konten, teks & gaya."

############################# Header ############################
title: "Bandingkan ODS File di Java" 
description: "Lakukan perbandingan konten antara lebih dari dua ODS file di Java. Ambil daftar perbedaan dan simpan file yang dibandingkan ke satu dokumen."
...
steps:
    enable: true
    title: "Cara membandingkan beberapa dokumen ODS menggunakan Java"
    content: |
      Gunakan [GroupDocs.Comparison](https://products.groupdocs.com/comparison/java/) untuk membandingkan beberapa file ODS dan menghasilkan laporan yang merinci perbedaannya
      ...
      2. Buat instance jalur pengaturan kelas Comparer ke salah satu dari ODS file
      3. Tambahkan setidaknya satu ODS tambahan ke instance Comparer
