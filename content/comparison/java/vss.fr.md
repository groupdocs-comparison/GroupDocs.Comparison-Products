...
############################# Head ############################
head_title: "API de comparaison Java VSS - Comparez les fichiers VSS pour les différences"
head_description: "Comparez et fusionnez des fichiers VSS dans des applications Java, J2EE, J2SE. Analysez le résumé des différences dans le contenu, le texte et le style des fichiers, images et formats de documents VSS."

############################# Header ############################
title: "Comparez les fichiers VSS en Java"
description: "Effectuez une comparaison ligne par ligne entre plus de deux fichiers VSS en Java. Récupérez une liste des différences et enregistrez les fichiers comparés dans un seul document."
...
steps:
    enable: true
    title_left: "Étapes pour comparer les fichiers VSS en Java"
    content_left: |
        [GroupDocs.Comparison](/comparison/java/) permet aux développeurs Java de comparer facilement les fichiers VSS au sein de leurs applications à l'aide de quelques lignes de code.
    ...
    code: |
        ...
        try (Comparer comparer = new Comparer("C:\\source.vss")) {
            comparer.add("C:\\target.vss");
            comparer.compare("C:\\result.vss"); // Créer un fichier de résultats avec le nom spécifié
        }
        
        // Comparer les documents du flux
        
        try (Comparer comparer = new Comparer(new FileInputStream("C:\\source.vss"))) {
            comparer.add(new FileInputStream("C:\\target.vss"));
            comparer.compare(new FileOutputStream("C:\\result.vss")); // Créer un fichier de résultats avec le nom spécifié
        }
        ```
...
demos:
    enable: true
    title: "Démos en direct pour comparer les fichiers VSS"
    content: |
        Comparez dès maintenant les fichiers VSS en visitant le site Web [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-vss"
          ...
          content: |
            Les VSS sont des fichiers de gabarit créés avec Microsoft Visio 2007 et versions antérieures. Un format de fichier relativement nouveau est .VSSX qui a été introduit avec Microsoft Visio 2013. Les fichiers de pochoirs fournissent des objets de dessin qui peuvent être inclus dans un dessin .VSD Visio. Microsoft Visio lui-même est connu pour créer des éléments de dessin tels qu'une collection de formes, des connecteurs, des organigrammes, une disposition de réseau, des diagrammes UML, des diagrammes de logiciels, des modèles de bases de données, des mappages d'objets et d'autres informations similaires. Il dispose également de riches fonctionnalités de conversion de documents Visio vers d'autres formats de fichiers tels que PNG, BMP, PDF et autres. Visio est disponible pour Windows et Mac OS.
...
solutions:
    ...
    solution:
        # solution loop
        - img_alt: "GroupDocs.Comparison for .NET VSS"
