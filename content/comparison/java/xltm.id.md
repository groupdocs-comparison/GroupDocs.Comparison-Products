...
############################# Head ############################
head_title: "Java XLTM API Perbandingan - Periksa XLTM File untuk Perbedaan"
head_description: "Bandingkan dan gabungkan XLTM file dalam aplikasi Java, J2EE, J2SE. Analisis ringkasan perbedaan dalam konten, teks & gaya."

############################# Header ############################
title: "Bandingkan XLTM File di Java" 
description: "Lakukan perbandingan konten antara lebih dari dua XLTM file di Java. Ambil daftar perbedaan dan simpan file yang dibandingkan ke satu dokumen."
...
steps:
    enable: true
    title: "Cara membandingkan beberapa dokumen XLTM menggunakan Java"
    content: |
      Gunakan [GroupDocs.Comparison](https://products.groupdocs.com/comparison/java/) untuk membandingkan beberapa file XLTM dan menghasilkan laporan yang merinci perbedaannya
      ...
      2. Buat instance jalur pengaturan kelas Comparer ke salah satu dari XLTM file
      3. Tambahkan setidaknya satu XLTM tambahan ke instance Comparer
