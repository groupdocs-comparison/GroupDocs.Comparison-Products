...
############################# Head ############################
head_title: "Java SQL Comparison API - Check SQL Files for Differences"
head_description: "Compare and merge SQL files in Java, J2EE, J2SE applications. Analyze differences summary in content, text & style of SQL files, images and document formats."

############################# Header ############################
title: "Compare SQL Files in Java" 
description: "Perform content comparison between more than two SQL files in Java. Retrieve a list of differences and save the compared files to a single document."
...
steps:
    enable: true
    title: "How to compare several SQL documents using Java"
    content: |
      Use [GroupDocs.Comparison](https://products.groupdocs.com/comparison/java/) to compare multiple SQL files and generate a report detailing their differences
      ...
      2. Create an instance of the Comparer class setting path to one of SQL files
      3. Add at least one additional SQL to the Comparer instance
