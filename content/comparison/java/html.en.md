...
############################# Head ############################
head_title: "Java HTML Comparison API - Check HTML Files for Differences"
head_description: "Compare and merge HTML files in Java, J2EE, J2SE applications. Analyze differences summary in content, text & style of HTML files, images and document formats."

############################# Header ############################
title: "Compare HTML Files in Java" 
description: "Perform content comparison between more than two HTML files in Java. Retrieve a list of differences and save the compared files to a single document."
...
steps:
    enable: true
    title: "How to compare several HTML documents using Java"
    content: |
      Use [GroupDocs.Comparison](https://products.groupdocs.com/comparison/java/) to compare multiple HTML files and generate a report detailing their differences
      ...
      2. Create an instance of the Comparer class setting path to one of HTML files
      3. Add at least one additional HTML to the Comparer instance
