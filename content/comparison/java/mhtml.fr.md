...
############################# Head ############################
head_title: "API de comparaison Java MHTML - Vérifiez les différences dans les fichiers MHTML"
head_description: "Comparez et fusionnez MHTML fichiers dans les applications Java, J2EE et J2SE. Analysez le résumé des différences en termes de contenu, de texte et de style."

############################# Header ############################
title: "Comparer MHTML fichiers dans Java" 
description: "Effectuez une comparaison de contenu entre plus de deux MHTML fichiers dans Java. Récupérez une liste des différences et enregistrez les fichiers comparés dans un seul document."
...
steps:
    enable: true
    title: "Comment comparer plusieurs documents MHTML à l'aide de Java"
    content: |
      Utilisez [GroupDocs.Comparison](https://products.groupdocs.com/comparison/java/) pour comparer plusieurs MHTML fichiers et générer un rapport détaillant leurs différences
      ...
      2. Créez une instance de la classe Comparer en définissant le chemin d'accès à l'un des MHTML fichiers
      3. Ajoutez au moins un MHTML supplémentaire à l'instance Comparer
