...
############################# Head ############################
head_title: "Java XLT Comparison API - Compare XLT Files for Differences"
head_description: "Compare and merge XLT files in Java, J2EE, J2SE applications. Analyse differences summary in content, text &amp; style of XLT files, images and document formats."

############################# Header ############################
title: "Compare XLT Files in Java"
description: "Perform a line-by-line comparison between more than two XLT files in Java. Retrieve a list of differences and save the compared files to a single document."
...
steps:
    enable: true
    title_left: "Steps for Comparing XLT Files in Java"
    content_left: |
        [GroupDocs.Comparison](/comparison/java/) makes it easy for Java developers to compare XLT files within their applications using a few lines of code.
    ...
    code: |
        ...
        try (Comparer comparer = new Comparer("C:\\source.xlt")) {
            ...
            comparer.compare("C:\\result.xlt"); // Create result file with the specified name
        }
        ...
        try (Comparer comparer = new Comparer(new FileInputStream("C:\\source.xlt"))) {
            ...
            comparer.compare(new FileOutputStream("C:\\result.xlt")); // Create result file with the specified name
        }
        ```
...
demos:
    enable: true
    title: "Live Demos to Compare XLT Files"
    content: |
        Compare XLT files right now by visiting [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family) website.  
