...
############################# Head ############################
head_title: "Java XLSX Comparison API - Compare XLSX Files for Differences"
head_description: "Compare and merge XLSX files in Java, J2EE, J2SE applications. Analyse differences summary in content, text & style of XLSX files, images and document formats."

############################# Header ############################
title: "Compare XLSX Files in Java"
description: "Perform a line-by-line comparison between more than two XLSX files in Java. Retrieve a list of differences and save the compared files to a single document."
...
steps:
    enable: true
    title_left: "Steps for Comparing XLSX Files in Java"
    content_left: |
        [GroupDocs.Comparison](/comparison/java/) makes it easy for Java developers to compare XLSX files within their applications using a few lines of code.
    ...
    code: |
        ...
        try (Comparer comparer = new Comparer("C:\\source.xlsx")) {
            ...
            comparer.compare("C:\\result.xlsx"); // Create result file with the specified name
        }
        ...
        try (Comparer comparer = new Comparer(new FileInputStream("C:\\source.xlsx"))) {
            ...
            comparer.compare(new FileOutputStream("C:\\result.xlsx")); // Create result file with the specified name
        }
        ```
...
demos:
    enable: true
    title: "Live Demos to Compare XLSX Files"
    content: |
        Compare XLSX files right now by visiting [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family) website.  
