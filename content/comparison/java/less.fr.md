...
############################# Head ############################
head_title: "API de comparaison Java LESS - Comparez les fichiers LESS pour les différences"
head_description: "Comparez et fusionnez des fichiers LESS dans des applications Java, J2EE, J2SE. Analysez le résumé des différences dans le contenu, le texte et le style des fichiers, images et formats de documents LESS."

############################# Header ############################
title: "Comparez les fichiers LESS en Java"
description: "Effectuez une comparaison ligne par ligne entre plus de deux fichiers LESS en Java. Récupérez une liste des différences et enregistrez les fichiers comparés dans un seul document."
...
steps:
    enable: true
    title_left: "Étapes pour comparer les fichiers LESS en Java"
    content_left: |
        [GroupDocs.Comparison](/comparison/java/) permet aux développeurs Java de comparer facilement les fichiers LESS au sein de leurs applications à l'aide de quelques lignes de code.
    ...
    code: |
        ...
        try (Comparer comparer = new Comparer("C:\\source.less")) {
            comparer.add("C:\\target.less");
            comparer.compare("C:\\result.less"); // Créer un fichier de résultats avec le nom spécifié
        }
        
        // Comparer les documents du flux
        
        try (Comparer comparer = new Comparer(new FileInputStream("C:\\source.less"))) {
            comparer.add(new FileInputStream("C:\\target.less"));
            comparer.compare(new FileOutputStream("C:\\result.less")); // Créer un fichier de résultats avec le nom spécifié
        }
        ```
...
demos:
    enable: true
    title: "Démos en direct pour comparer les fichiers LESS"
    content: |
        Comparez dès maintenant les fichiers LESS en visitant le site Web [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-less"
          title: "À propos du format de fichier LESS"
          content: |
            {{less}}
...
solutions:
    ...
    solution:
        # solution loop
        - img_alt: "GroupDocs.Comparison for .NET LESS"
          image: "https://www.groupdocs.cloud/templates/groupdocs/images/product-logos/groupdocs-comparison-net.png"
          product: "GroupDocs.Comparison"
          platform: ".NET"
          link: "/comparison/net/less/"
