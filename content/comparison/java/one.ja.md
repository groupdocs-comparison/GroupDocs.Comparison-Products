...
steps:
    enable: true
    title_left: "Javaで1つのファイルを比較するための手順"
    content_left: |
        [GroupDocs.Comparison](/Comparison/java/)を使用すると、Java開発者は数行のコードを使用してアプリケーション内の1つのファイルを簡単に比較できます。
...
demos:
    ...
    content: |
        [GroupDocs.Comparisonライブデモ](https://products.groupdocs.app/comparison/family)サイトにアクセスして、現在1つのファイルを比較してください。  
        ライブデモには次の利点があります
