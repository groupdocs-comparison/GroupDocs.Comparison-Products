...
############################# Head ############################
head_title: "API di confronto Java ONE: confronta i file ONE per le differenze"
head_description: "Confronta e unisci file ONE nelle applicazioni Java, J2EE, J2SE. Analizza il riepilogo delle differenze nel contenuto, nel testo e nello stile di file, immagini e formati di documenti ONE."

############################# Header ############################
title: "Confronta i file ONE in Java"
description: "Esegui un confronto riga per riga tra più di due file ONE in Java. Recupera un elenco di differenze e salva i file confrontati in un singolo documento."
...
steps:
    enable: true
    title_left: "Passaggi per confrontare i file ONE in Java"
    content_left: |
...
demos:
    enable: true
    title: "Demo dal vivo per confrontare file ONE"
    content: |
        Confronta subito i file ONE visitando il sito web [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
