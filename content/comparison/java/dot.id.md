...
############################# Head ############################
head_title: "API Perbandingan DOT Java - Bandingkan File DOT untuk Perbedaan"
head_description: "Bandingkan dan gabungkan file DOT di aplikasi Java, J2EE, J2SE. Analisis perbedaan ringkasan dalam konten, teks & gaya file DOT, gambar, dan format dokumen."

############################# Header ############################
title: "Bandingkan File DOT di Jawa"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Membandingkan File DOT di Java"
    content_left: |
        [GroupDocs.Comparison](/id/comparison/java/) memudahkan pengembang Java untuk membandingkan file DOT dalam aplikasi mereka menggunakan beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung untuk Membandingkan DOT File"
    content: |
        Bandingkan file DOT sekarang dengan mengunjungi situs web [GroupDocs.Comparison](https://products.groupdocs.app/comparison/family). Demo langsung memiliki manfaat sebagai berikut.
