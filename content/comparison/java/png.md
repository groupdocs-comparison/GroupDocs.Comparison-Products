...
############################# Head ############################
head_title: "Java PNG Comparison API - Compare PNG Files for Differences"
head_description: "Compare and merge PNG files in Java, J2EE, J2SE applications. Analyse differences summary in content, text &amp; style of PNG files, images and document formats."

############################# Header ############################
title: "Compare PNG Files in Java"
description: "Perform a line-by-line comparison between more than two PNG files in Java. Retrieve a list of differences and save the compared files to a single document."
...
steps:
    enable: true
    title_left: "Steps for Comparing PNG Files in Java"
    content_left: |
        [GroupDocs.Comparison](/comparison/java/) makes it easy for Java developers to compare PNG files within their applications using a few lines of code.
    ...
    code: |
        ...
        try (Comparer comparer = new Comparer("C:\\source.png")) {
            ...
            comparer.compare("C:\\result.png"); // Create result file with the specified name
        }
        ...
        try (Comparer comparer = new Comparer(new FileInputStream("C:\\source.png"))) {
            ...
            comparer.compare(new FileOutputStream("C:\\result.png")); // Create result file with the specified name
        }
        ```
...
demos:
    enable: true
    title: "Live Demos to Compare PNG Files"
    content: |
        Compare PNG files right now by visiting [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family) website.  
