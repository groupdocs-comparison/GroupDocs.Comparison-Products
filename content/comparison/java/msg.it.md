...
############################# Head ############################
head_title: "API di confronto Java MSG - Verifica la presenza di differenze tra i file MSG"
head_description: "Confronta e unisci i file MSG nelle applicazioni Java, J2EE, J2SE. Analizza il riepilogo delle differenze in termini di contenuto, testo e stile."

############################# Header ############################
title: "Confronta MSG file in Java" 
description: "Esegui il confronto dei contenuti tra più di due file MSG in Java. Recupera un elenco di differenze e salva i file confrontati in un unico documento."
...
steps:
    enable: true
    title: "Come confrontare diversi documenti MSG utilizzando Java"
    content: |
      Usa [GroupDocs.Comparison](https://products.groupdocs.com/comparison/java/) per confrontare più file MSG e generare un rapporto che descriva in dettaglio le loro differenze
      ...
      2. Crea un'istanza della classe Comparer impostando il percorso di uno dei file MSG
      3. Aggiungi almeno un altro MSG all'istanza di Comparer
