...
############################# Head ############################
head_title: "API de comparação Java MOBI - compare arquivos MOBI para diferenças"
...
############################# Header ############################
title: "Comparar arquivos MOBI em Java"
...
steps:
    ...
    code: |
        ...
        try (Comparer comparer = new Comparer("C:\\source.mobi")) {
            ...
            comparer.compare("C:\\result.mobi"); // Cria arquivo de resultado com o nome especificado
        }
        ...
        try (Comparer comparer = new Comparer(new FileInputStream("C:\\source.mobi"))) {
            ...
            comparer.compare(new FileOutputStream("C:\\result.mobi")); // Cria arquivo de resultado com o nome especificado
        }
        ```
...
demos:
    ...
    content: |
        Compare os arquivos MOBI agora mesmo visitando o site [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-mobi"
          ...
          content: |
            O formato de arquivo MOBI é um dos formatos de arquivo de e-book mais usados. O formato é um aprimoramento do antigo formato OEB (Open Ebook Format) e foi usado como formato proprietário do Mobipocket Reader. Como o EPUB, ele é suportado por quase todos os leitores eletrônicos modernos, especificamente por dispositivos móveis com baixa largura de banda. O formato pode ser convertido em vários outros formatos, como PDF, EPUB e vários outros formatos usando aplicativos de software disponíveis publicamente, como o aplicativo Kindle. Existem várias empresas que oferecem livros MOBI gratuitos, como Project Gutenberg, Feedbooks e Open Library.
