...
############################# Head ############################
head_title: "API de comparação Java MOBI - Compare arquivos MOBI em busca de diferenças"
head_description: "Compare e mescle arquivos MOBI em aplicativos Java, J2EE, J2SE. Analise o resumo das diferenças no conteúdo, texto e estilo de MOBI arquivos, imagens e formatos de documentos."

############################# Header ############################
title: "Compare arquivos MOBI em Java"
description: "Execute uma comparação linha por linha entre mais de dois arquivos MOBI em Java. Recupere uma lista de diferenças e salve os arquivos comparados em um único documento."
...
steps:
    enable: true
    title_left: "Etapas para comparar arquivos MOBI em Java"
    content_left: |
        [GroupDocs.Comparison](/comparison/java/) torna mais fácil para os desenvolvedores Java comparar arquivos MOBI em seus aplicativos usando algumas linhas de código.
    ...
    code: |
        ...
        try (Comparer comparer = new Comparer("C:\\source.mobi")) {
            ...
            comparer.compare("C:\\result.mobi"); // Crie um arquivo de resultado com o nome especificado
        }
        ...
        try (Comparer comparer = new Comparer(new FileInputStream("C:\\source.mobi"))) {
            ...
            comparer.compare(new FileOutputStream("C:\\result.mobi")); // Crie um arquivo de resultado com o nome especificado
        }
        ```
...
demos:
    enable: true
    title: "Demonstrações ao vivo para comparar arquivos MOBI"
    content: |
        Compare arquivos MOBI agora mesmo visitando o site [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-mobi"
          title: "Sobre o formato de arquivo MOBI"
          content: |
            O formato de arquivo MOBI é um dos formatos de arquivo de e-book mais amplamente usados. O formato é um aprimoramento do antigo formato OEB (Open Ebook Format) e foi usado como formato proprietário do Mobipocket Reader. Assim como o EPUB, ele é suportado por quase todos os leitores eletrônicos modernos, especificamente por dispositivos móveis com baixa largura de banda. O formato pode ser convertido para vários outros formatos, como PDF, EPUB e vários outros formatos usando aplicativos de software disponíveis publicamente, como o aplicativo Kindle. Existem várias empresas que oferecem livros MOBI gratuitos, como Project Gutenberg, Feedbooks e Open Library.
