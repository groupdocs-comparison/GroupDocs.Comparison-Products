...
############################# Head ############################
head_title: "Java HTM API di confronto - Confronta HTM file per le differenze"
head_description: "Confronta e unisci HTM file in applicazioni Java, J2EE, J2SE. Analizza il riepilogo delle differenze nel contenuto, nel testo e nello stile di HTM file, immagini e formati di documenti."

############################# Header ############################
title: "Confronta HTM File in Java"
description: "Esegui un confronto riga per riga tra più di due file HTM in Java. Recupera un elenco di differenze e salva i file confrontati in un unico documento."
...
steps:
    enable: true
    title_left: "Passi per confrontare i file HTM in Java"
    content_left: |
...
demos:
    enable: true
    title: "Demo dal vivo per confrontare HTM file"
    content: |
        Confronta subito HTM file visitando il sito web [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
