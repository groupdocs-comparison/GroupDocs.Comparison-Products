...
############################# Head ############################
head_title: "Java LESS API di confronto - Confronta LESS file per le differenze"
head_description: "Confronta e unisci LESS file in applicazioni Java, J2EE, J2SE. Analizza il riepilogo delle differenze nel contenuto, nel testo e nello stile di LESS file, immagini e formati di documenti."

############################# Header ############################
title: "Confronta LESS File in Java"
description: "Esegui un confronto riga per riga tra più di due file LESS in Java. Recupera un elenco di differenze e salva i file confrontati in un unico documento."
...
steps:
    enable: true
    title_left: "Passi per confrontare i file LESS in Java"
    content_left: |
...
demos:
    enable: true
    title: "Demo dal vivo per confrontare LESS file"
    content: |
        Confronta subito LESS file visitando il sito web [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
