...
############################# Head ############################
head_title: "Java DIFF Comparison API - Check DIFF Files for Differences"
head_description: "Compare and merge DIFF files in Java, J2EE, J2SE applications. Analyze differences summary in content, text & style of DIFF files, images and document formats."

############################# Header ############################
title: "Compare DIFF Files in Java" 
description: "Perform content comparison between more than two DIFF files in Java. Retrieve a list of differences and save the compared files to a single document."
...
steps:
    enable: true
    title: "How to compare several DIFF documents using Java"
    content: |
      Use [GroupDocs.Comparison](https://products.groupdocs.com/comparison/java/) to compare multiple DIFF files and generate a report detailing their differences
      ...
      2. Create an instance of the Comparer class setting path to one of DIFF files
      3. Add at least one additional DIFF to the Comparer instance
