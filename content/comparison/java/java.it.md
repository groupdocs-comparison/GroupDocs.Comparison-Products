...
############################# Head ############################
head_title: "Java JAVA API di confronto - Confronta JAVA file per le differenze"
head_description: "Confronta e unisci JAVA file in applicazioni Java, J2EE, J2SE. Analizza il riepilogo delle differenze nel contenuto, nel testo e nello stile di JAVA file, immagini e formati di documenti."

############################# Header ############################
title: "Confronta JAVA File in Java"
description: "Esegui un confronto riga per riga tra più di due file JAVA in Java. Recupera un elenco di differenze e salva i file confrontati in un unico documento."
...
steps:
    enable: true
    title_left: "Passi per confrontare i file JAVA in Java"
    content_left: |
...
demos:
    enable: true
    title: "Demo dal vivo per confrontare JAVA file"
    content: |
        Confronta subito JAVA file visitando il sito web [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
