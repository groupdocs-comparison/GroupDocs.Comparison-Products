...
############################# Head ############################
head_title: "Java DICOM API Perbandingan - Periksa DICOM File untuk Perbedaan"
head_description: "Bandingkan dan gabungkan DICOM file dalam aplikasi Java, J2EE, J2SE. Analisis ringkasan perbedaan dalam konten, teks & gaya."

############################# Header ############################
title: "Bandingkan DICOM File di Java" 
description: "Lakukan perbandingan konten antara lebih dari dua DICOM file di Java. Ambil daftar perbedaan dan simpan file yang dibandingkan ke satu dokumen."
...
steps:
    enable: true
    title: "Cara membandingkan beberapa dokumen DICOM menggunakan Java"
    content: |
      Gunakan [GroupDocs.Comparison](https://products.groupdocs.com/comparison/java/) untuk membandingkan beberapa file DICOM dan menghasilkan laporan yang merinci perbedaannya
      ...
      2. Buat instance jalur pengaturan kelas Comparer ke salah satu dari DICOM file
      3. Tambahkan setidaknya satu DICOM tambahan ke instance Comparer
