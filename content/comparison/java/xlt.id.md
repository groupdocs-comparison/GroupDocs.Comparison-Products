...
############################# Head ############################
head_title: "API Perbandingan XLT Java - Bandingkan File XLT untuk Perbedaan"
head_description: "Bandingkan dan gabungkan file XLT di aplikasi Java, J2EE, J2SE. Analisis perbedaan ringkasan dalam konten, teks & gaya file XLT, gambar, dan format dokumen."

############################# Header ############################
title: "Bandingkan File XLT di Jawa"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Membandingkan File XLT di Java"
    content_left: |
        [GroupDocs.Comparison](/id/comparison/java/) memudahkan pengembang Java untuk membandingkan file XLT dalam aplikasi mereka menggunakan beberapa baris kode.
    ...
    code: |
        ...
        try (Comparer comparer = new Comparer(new FileInputStream("C:\\source.xlt"))) {
            ...
            comparer.compare(new FileOutputStream("C:\\result.xlt"));
        }
        ```
...
demos:
    enable: true
    title: "Demo Langsung untuk Membandingkan XLT File"
    content: |
        Bandingkan file XLT sekarang dengan mengunjungi situs web [GroupDocs.Comparison](https://products.groupdocs.app/comparison/family). Demo langsung memiliki manfaat sebagai berikut.
