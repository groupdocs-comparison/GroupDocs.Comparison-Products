...
############################# Head ############################
head_title: "Java VSD API di confronto - Confronta VSD file per le differenze"
head_description: "Confronta e unisci VSD file in applicazioni Java, J2EE, J2SE. Analizza il riepilogo delle differenze nel contenuto, nel testo e nello stile di VSD file, immagini e formati di documenti."

############################# Header ############################
title: "Confronta VSD File in Java"
description: "Esegui un confronto riga per riga tra più di due file VSD in Java. Recupera un elenco di differenze e salva i file confrontati in un unico documento."
...
steps:
    enable: true
    title_left: "Passi per confrontare i file VSD in Java"
    content_left: |
...
demos:
    enable: true
    title: "Demo dal vivo per confrontare VSD file"
    content: |
        Confronta subito VSD file visitando il sito web [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
