...
############################# Head ############################
head_title: "Java JSON API di confronto - Confronta JSON file per le differenze"
head_description: "Confronta e unisci JSON file in applicazioni Java, J2EE, J2SE. Analizza il riepilogo delle differenze nel contenuto, nel testo e nello stile di JSON file, immagini e formati di documenti."

############################# Header ############################
title: "Confronta JSON File in Java"
description: "Esegui un confronto riga per riga tra più di due file JSON in Java. Recupera un elenco di differenze e salva i file confrontati in un unico documento."
...
steps:
    enable: true
    title_left: "Passi per confrontare i file JSON in Java"
    content_left: |
...
demos:
    enable: true
    title: "Demo dal vivo per confrontare JSON file"
    content: |
        Confronta subito JSON file visitando il sito web [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
