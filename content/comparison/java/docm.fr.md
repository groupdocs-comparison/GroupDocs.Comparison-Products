...
############################# Head ############################
head_title: "API de comparaison Java DOCM - Comparez les fichiers DOCM pour les différences"
head_description: "Comparez et fusionnez des fichiers DOCM dans des applications Java, J2EE, J2SE. Analysez le résumé des différences dans le contenu, le texte et le style des fichiers, images et formats de documents DOCM."

############################# Header ############################
title: "Comparez les fichiers DOCM en Java"
description: "Effectuez une comparaison ligne par ligne entre plus de deux fichiers DOCM en Java. Récupérez une liste des différences et enregistrez les fichiers comparés dans un seul document."
...
steps:
    enable: true
    title_left: "Étapes pour comparer les fichiers DOCM en Java"
    content_left: |
        [GroupDocs.Comparison](/comparison/java/) permet aux développeurs Java de comparer facilement les fichiers DOCM au sein de leurs applications à l'aide de quelques lignes de code.
    ...
    code: |
        ...
        try (Comparer comparer = new Comparer("C:\\source.docm")) {
            ...
            comparer.compare("C:\\result.docm"); // Créer un fichier de résultats avec le nom spécifié
        }
        ...
        try (Comparer comparer = new Comparer(new FileInputStream("C:\\source.docm"))) {
            ...
            comparer.compare(new FileOutputStream("C:\\result.docm")); // Créer un fichier de résultats avec le nom spécifié
        }
        ```
...
demos:
    enable: true
    title: "Démos en direct pour comparer les fichiers DOCM"
    content: |
        Comparez dès maintenant les fichiers DOCM en visitant le site Web [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-docm"
          ...
          content: |
            Les fichiers DOCM sont des documents générés par Microsoft Word 2007 ou version ultérieure avec la possibilité d'exécuter des macros. Il est similaire au format de fichier DOCX mais la possibilité d'exécuter des macros le rend différent du DOCX. Comme DOCX, les fichiers DOCM peuvent stocker du texte, des images, des tableaux, des formes, des graphiques et d'autres contenus. La possibilité d'exécuter des macros permet de gagner facilement du temps en exécutant une série de commandes sous forme d'actions enregistrées pour l'exécution automatique d'une tâche. . Les fichiers DOCM peuvent être ouverts et modifiés dans Microsoft Word 2007 et supérieur.
