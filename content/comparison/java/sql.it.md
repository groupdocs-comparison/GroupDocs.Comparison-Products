...
############################# Head ############################
head_title: "Java SQL API di confronto - Confronta SQL file per le differenze"
head_description: "Confronta e unisci SQL file in applicazioni Java, J2EE, J2SE. Analizza il riepilogo delle differenze nel contenuto, nel testo e nello stile di SQL file, immagini e formati di documenti."

############################# Header ############################
title: "Confronta SQL File in Java"
description: "Esegui un confronto riga per riga tra più di due file SQL in Java. Recupera un elenco di differenze e salva i file confrontati in un unico documento."
...
steps:
    enable: true
    title_left: "Passi per confrontare i file SQL in Java"
    content_left: |
...
demos:
    enable: true
    title: "Demo dal vivo per confrontare SQL file"
    content: |
        Confronta subito SQL file visitando il sito web [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
