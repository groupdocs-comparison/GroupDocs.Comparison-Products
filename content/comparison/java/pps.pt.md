...
############################# Head ############################
head_title: "API de comparação Java PPS - Compare arquivos PPS em busca de diferenças"
head_description: "Compare e mescle arquivos PPS em aplicativos Java, J2EE, J2SE. Analise o resumo das diferenças no conteúdo, texto e estilo de PPS arquivos, imagens e formatos de documentos."

############################# Header ############################
title: "Compare arquivos PPS em Java"
description: "Execute uma comparação linha por linha entre mais de dois arquivos PPS em Java. Recupere uma lista de diferenças e salve os arquivos comparados em um único documento."
...
steps:
    enable: true
    title_left: "Etapas para comparar arquivos PPS em Java"
    content_left: |
        [GroupDocs.Comparison](/comparison/java/) torna mais fácil para os desenvolvedores Java comparar arquivos PPS em seus aplicativos usando algumas linhas de código.
    ...
    code: |
        ...
        try (Comparer comparer = new Comparer("C:\\source.pps")) {
            comparer.add("C:\\target.pps");
            comparer.compare("C:\\result.pps"); // Crie um arquivo de resultado com o nome especificado
        }
        
        // Compare documentos do fluxo
        
        try (Comparer comparer = new Comparer(new FileInputStream("C:\\source.pps"))) {
            comparer.add(new FileInputStream("C:\\target.pps"));
            comparer.compare(new FileOutputStream("C:\\result.pps")); // Crie um arquivo de resultado com o nome especificado
        }
        ```
...
demos:
    enable: true
    title: "Demonstrações ao vivo para comparar arquivos PPS"
    content: |
        Compare arquivos PPS agora mesmo visitando o site [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-pps"
          ...
          content: |
            Os arquivos PPS, PowerPoint Slide Show, são criados usando o Microsoft PowerPoint para fins de apresentação de slides. A leitura e criação de arquivos PPS são suportadas pelo Microsoft PowerPoint 97-2003. A versão mais recente deste formato de arquivo é o PPSX, que é baseado nos padrões Office OpenXML. Os arquivos PPS ainda podem ser lidos pelas versões mais recentes do Microsoft PowerPoint, mas os arquivos recém-criados só podem ser salvos no formato de arquivo PPSX. Quando um arquivo PPS é compartilhado com outro usuário e aberto, ele inicia como um show do Powerpoint, ao contrário do arquivo PPT que abre no modo editável.
...
solutions:
    ...
    solution:
        # solution loop
        - img_alt: "GroupDocs.Comparison for .NET PPS"
