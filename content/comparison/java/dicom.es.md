...
############################# Head ############################
head_title: "Java DICOM API de comparación: compruebe las diferencias en los archivos DICOM"
head_description: "Compare y combine DICOM archivos en aplicaciones Java, J2EE y J2SE. Analice el resumen de las diferencias en contenido, texto y estilo."

############################# Header ############################
title: "Compara DICOM archivos en Java" 
description: "Realice una comparación de contenido entre más de dos archivos DICOM en Java. Recupere una lista de diferencias y guarde los archivos comparados en un único documento."
...
steps:
    enable: true
    title: "Cómo comparar varios DICOM documentos usando Java"
    content: |
      Usa [GroupDocs.Comparison](https://products.groupdocs.com/comparison/java/) para comparar varios archivos DICOM y generar un informe en el que se detallen sus diferencias
      ...
      2. Cree una instancia de la ruta de configuración de la clase Comparer a uno de los DICOM archivos
      3. Agregue al menos un DICOM adicional a la instancia de Comparer
