...
############################# Head ############################
head_title: "Java EMLX API di confronto - Confronta EMLX file per le differenze"
head_description: "Confronta e unisci EMLX file in applicazioni Java, J2EE, J2SE. Analizza il riepilogo delle differenze nel contenuto, nel testo e nello stile di EMLX file, immagini e formati di documenti."

############################# Header ############################
title: "Confronta EMLX File in Java"
description: "Esegui un confronto riga per riga tra più di due file EMLX in Java. Recupera un elenco di differenze e salva i file confrontati in un unico documento."
...
steps:
    enable: true
    title_left: "Passi per confrontare i file EMLX in Java"
    content_left: |
...
demos:
    enable: true
    title: "Demo dal vivo per confrontare EMLX file"
    content: |
        Confronta subito EMLX file visitando il sito web [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
