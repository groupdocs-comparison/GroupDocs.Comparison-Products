...
############################# Head ############################
head_title: "API Perbandingan ODP Java - Bandingkan File ODP untuk Perbedaan"
head_description: "Bandingkan dan gabungkan file ODP di aplikasi Java, J2EE, J2SE. Analisis perbedaan ringkasan dalam konten, teks & gaya file ODP, gambar, dan format dokumen."

############################# Header ############################
title: "Bandingkan File ODP di Jawa"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Membandingkan File ODP di Java"
    content_left: |
        [GroupDocs.Comparison](/id/comparison/java/) memudahkan pengembang Java untuk membandingkan file ODP dalam aplikasi mereka menggunakan beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung untuk Membandingkan ODP File"
    content: |
        Bandingkan file ODP sekarang dengan mengunjungi situs web [GroupDocs.Comparison](https://products.groupdocs.app/comparison/family). Demo langsung memiliki manfaat sebagai berikut.
