...
############################# Head ############################
head_title: "API Perbandingan PL Java - Bandingkan File PL untuk Perbedaan"
head_description: "Bandingkan dan gabungkan file PL di aplikasi Java, J2EE, J2SE. Analisis perbedaan ringkasan dalam konten, teks & gaya file PL, gambar, dan format dokumen."

############################# Header ############################
title: "Bandingkan File PL di Jawa"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Membandingkan File PL di Java"
    content_left: |
        [GroupDocs.Comparison](/id/comparison/java/) memudahkan pengembang Java untuk membandingkan file PL dalam aplikasi mereka menggunakan beberapa baris kode.
    ...
    code: |
        ...
        try (Comparer comparer = new Comparer(new FileInputStream("C:\\source.pl"))) {
            ...
            comparer.compare(new FileOutputStream("C:\\result.pl"));
        }
        ```
...
demos:
    enable: true
    title: "Demo Langsung untuk Membandingkan PL File"
    content: |
        Bandingkan file PL sekarang dengan mengunjungi situs web [GroupDocs.Comparison](https://products.groupdocs.app/comparison/family). Demo langsung memiliki manfaat sebagai berikut.
...
about_formats:
    ...
    format:
        # format loop
        - icon: "far fa-file-pl"
          title: "Tentang Format Berkas PL"
          content: |
            {{PL}}
