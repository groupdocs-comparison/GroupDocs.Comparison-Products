...
############################# Head ############################
head_title: "JavaEML比較API-EMLファイルの違いを比較する"
...
steps:
    enable: true
    title_left: "JavaでEMLファイルを比較する手順"
    content_left: |
        [GroupDocs.Comparison](/ja/comparison/java/)を使用すると、Java開発者は数行のコードを使用してアプリケーション内のEMLファイルを簡単に比較できます。
