...
############################# Head ############################
head_title: "Java POT Comparison API - Check POT Files for Differences"
head_description: "Compare and merge POT files in Java, J2EE, J2SE applications. Analyze differences summary in content, text & style of POT files, images and document formats."

############################# Header ############################
title: "Compare POT Files in Java" 
description: "Perform content comparison between more than two POT files in Java. Retrieve a list of differences and save the compared files to a single document."
...
steps:
    enable: true
    title: "How to compare several POT documents using Java"
    content: |
      Use [GroupDocs.Comparison](https://products.groupdocs.com/comparison/java/) to compare multiple POT files and generate a report detailing their differences
      ...
      2. Create an instance of the Comparer class setting path to one of POT files
      3. Add at least one additional POT to the Comparer instance
