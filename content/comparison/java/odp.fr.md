...
############################# Head ############################
head_title: "API de comparaison Java ODP - Vérifiez les différences dans les fichiers ODP"
head_description: "Comparez et fusionnez ODP fichiers dans les applications Java, J2EE et J2SE. Analysez le résumé des différences en termes de contenu, de texte et de style."

############################# Header ############################
title: "Comparer ODP fichiers dans Java" 
description: "Effectuez une comparaison de contenu entre plus de deux ODP fichiers dans Java. Récupérez une liste des différences et enregistrez les fichiers comparés dans un seul document."
...
steps:
    enable: true
    title: "Comment comparer plusieurs documents ODP à l'aide de Java"
    content: |
      Utilisez [GroupDocs.Comparison](https://products.groupdocs.com/comparison/java/) pour comparer plusieurs ODP fichiers et générer un rapport détaillant leurs différences
      ...
      2. Créez une instance de la classe Comparer en définissant le chemin d'accès à l'un des ODP fichiers
      3. Ajoutez au moins un ODP supplémentaire à l'instance Comparer
