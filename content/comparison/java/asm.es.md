...
############################# Head ############################
head_title: "API de comparación de Java ASM - Compara archivos de ASM en busca de diferencias"
head_description: "Compare y combine archivos ASM en aplicaciones Java, J2EE, J2SE. Analice el resumen de diferencias en contenido, texto y estilo de ASM archivos, imágenes y formatos de documentos."

############################# Header ############################
title: "Compara archivos ASM en Java"
description: "Realice una comparación línea por línea entre más de dos archivos ASM en Java. Recupere una lista de diferencias y guarde los archivos comparados en un solo documento."
...
steps:
    enable: true
    title_left: "Pasos para comparar archivos ASM en Java"
    content_left: |
        [GroupDocs.Comparison](/comparison/java/) facilita a los desarrolladores de Java comparar archivos ASM dentro de sus aplicaciones utilizando unas pocas líneas de código.
    ...
    code: |
        ...
        try (Comparer comparer = new Comparer("C:\\source.asm")) {
            ...
            comparer.compare("C:\\result.asm"); // Crear archivo de resultados con el nombre especificado
        }
        ...
        try (Comparer comparer = new Comparer(new FileInputStream("C:\\source.asm"))) {
            ...
            comparer.compare(new FileOutputStream("C:\\result.asm")); // Crear archivo de resultados con el nombre especificado
        }
        ```
...
demos:
    enable: true
    title: "Demostraciones en vivo para comparar archivos ASM"
    content: |
        Compare archivos ASM ahora mismo visitando el sitio web [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
