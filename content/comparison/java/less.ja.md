...
head_title: "JavaLESS比較API-LESSファイルの違いを比較します"
...
steps:
    ...
    content_left: |
        [GroupDocs.Comparison](/Comparison/java/)を使用すると、Java開発者は、数行のコードを使用して、アプリケーション内のLESSファイルを簡単に比較できます。
...
demos:
    ...
    content: |
        [GroupDocs.Comparisonライブデモ](https://products.groupdocs.app/comparison/family)サイトにアクセスして、今すぐLESSファイルを比較してください。  
        ライブデモには次の利点があります
