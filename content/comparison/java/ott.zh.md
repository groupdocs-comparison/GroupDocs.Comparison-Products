...
############################# Head ############################
head_title: "Java OTT 比较 API - 比较 OTT 文件的差异"
head_description: "比较和合并 Java、J2EE、J2SE 应用程序中的 OTT 文件。分析 OTT 文件、图像和文档格式在内容、文本和样式方面的差异摘要。"

############################# Header ############################
title: "在Java中比较OTT文件"
description: "在 Java 中对两个以上的 OTT 文件进行逐行比较。检索差异列表并将比较的文件保存到单个文档中。"
...
steps:
    enable: true
    title_left: "在 Java 中比较 OTT 文件的步骤"
    content_left: |
        [GroupDocs.Comparison](/comparison/java/) 使 Java 开发人员可以使用几行代码轻松比较其应用程序中的 OTT 文件。
    ...
    code: |
        ...
        try (Comparer comparer = new Comparer("C:\\source.ott")) {
            ...
            comparer.compare("C:\\result.ott"); // 创建指定名称的结果文件
        }
        ...
        try (Comparer comparer = new Comparer(new FileInputStream("C:\\source.ott"))) {
            ...
            comparer.compare(new FileOutputStream("C:\\result.ott")); // 创建指定名称的结果文件
        }
        ```
...
demos:
    enable: true
    title: "比较 OTT 文件的现场演示"
    content: |
        立即访问 [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family) 网站比较 OTT 文件。
        现场演示有以下好处
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-ott"
          title: "关于 OTT 文件格式"
          content: |
            带有 OTT 扩展名的文件代表应用程序生成的符合 OASIS 的 OpenDocument 标准格式的模板文档。它们是使用文字处理器应用程序创建的，例如免费的 OpenOffice Writer，并且可以保存可用于从这些模板文件生成新文档的设置。这些设置包括页边距、边框、页眉、页脚和其他页面设置。此类模板用于公司信头和标准化表格等官方文件。
