...
head_description: "Compare and merge XLTM files in Java, J2EE, J2SE applications. Analyze differences summary in content, text & style."
...
steps:
    enable: true
    title: "How to compare several XLTM documents using Java"
    content: |
      Use [GroupDocs.Comparison](https://products.groupdocs.com/comparison/java/) to compare multiple XLTM files and generate a report detailing their differences
      ...
      2. Create an instance of the Comparer class setting path to one of XLTM files
      3. Add at least one additional XLTM to the Comparer instance
