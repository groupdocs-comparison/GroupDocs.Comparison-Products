...
############################# Head ############################
head_title: "Java DWG Vergleichs-API — DWG Dateien auf Unterschiede überprüfen"
head_description: "Vergleichen und führen Sie DWG Dateien in Java, J2EE- und J2SE-Anwendungen zusammen. Analysieren Sie die Unterschiede zusammenfassend in Inhalt, Text und Stil."

############################# Header ############################
title: "Vergleiche DWG Dateien in Java" 
description: "Führen Sie einen Inhaltsvergleich zwischen mehr als zwei DWG Dateien in Java durch. Rufen Sie eine Liste der Unterschiede ab und speichern Sie die verglichenen Dateien in einem einzigen Dokument."
...
steps:
    enable: true
    title: "So vergleichen Sie mehrere DWG Dokumente mit Java"
    content: |
      Verwenden Sie [GroupDocs.Comparison](https://products.groupdocs.com/comparison/java/), um mehrere DWG Dateien zu vergleichen und einen Bericht zu erstellen, in dem die Unterschiede detailliert beschrieben werden
      ...
      2. Erstellen Sie eine Instanz des Comparer-Klasseneinstellungspfads zu einer von DWG Dateien
      3. Fügen Sie der Comparer-Instanz mindestens eine weitere DWG hinzu
