...
############################# Head ############################
head_title: "API de comparación Java ODT: compare archivos ODT en busca de diferencias"
head_description: "Compare y combine archivos ODT en aplicaciones Java, J2EE, J2SE. Analice el resumen de diferencias en contenido, texto y estilo de ODT archivos, imágenes y formatos de documentos."

############################# Header ############################
title: "Comparar archivos ODT en Java"
description: "Realice una comparación línea por línea entre más de dos archivos ODT en Java. Recupere una lista de diferencias y guarde los archivos comparados en un solo documento."
...
steps:
    enable: true
    title_left: "Pasos para comparar archivos ODT en Java"
    content_left: |
        [GroupDocs.Comparison](/comparison/java/) facilita a los desarrolladores de Java comparar archivos ODT dentro de sus aplicaciones utilizando unas pocas líneas de código.
    ...
    code: |
        ...
        try (Comparer comparer = new Comparer("C:\\source.odt")) {
            ...
            comparer.compare("C:\\result.odt"); // Crear archivo de resultados con el nombre especificado
        }
        ...
        try (Comparer comparer = new Comparer(new FileInputStream("C:\\source.odt"))) {
            ...
            comparer.compare(new FileOutputStream("C:\\result.odt")); // Crear archivo de resultados con el nombre especificado
        }
        ```
...
demos:
    enable: true
    title: "Demostraciones en vivo para comparar archivos ODT"
    content: |
        Compare archivos ODT ahora mismo visitando el sitio web [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-odt"
          ...
          content: |
            Los archivos ODT son un tipo de documentos creados con aplicaciones de procesamiento de textos que se basan en el formato de archivo de texto OpenDocument. Estos se crean con aplicaciones de procesador de textos, como OpenOffice Writer, y pueden contener contenido como texto, imágenes, objetos y estilos. El archivo ODT es para el procesador de textos Writer lo que DOCX es para Microsoft Word. Varias aplicaciones, incluidas Google Docs y el procesador de textos basado en web de Google incluido con Google Drive, pueden abrir los archivos ODT para editarlos. Microsoft Word también puede abrir archivos ODT y guardarlos en otros formatos como DOC y DOCX.
