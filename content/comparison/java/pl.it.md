...
############################# Head ############################
head_title: "Java PL API di confronto - Confronta PL file per le differenze"
head_description: "Confronta e unisci PL file in applicazioni Java, J2EE, J2SE. Analizza il riepilogo delle differenze nel contenuto, nel testo e nello stile di PL file, immagini e formati di documenti."

############################# Header ############################
title: "Confronta PL File in Java"
description: "Esegui un confronto riga per riga tra più di due file PL in Java. Recupera un elenco di differenze e salva i file confrontati in un unico documento."
...
steps:
    enable: true
    title_left: "Passi per confrontare i file PL in Java"
    content_left: |
...
demos:
    enable: true
    title: "Demo dal vivo per confrontare PL file"
    content: |
        Confronta subito PL file visitando il sito web [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
