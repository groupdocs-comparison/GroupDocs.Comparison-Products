...
############################# Head ############################
head_title: "Java XLS Comparison API - Compare XLS Files for Differences"
...
steps:
    ...
    content_left: |
        [GroupDocs.Comparison](/comparison/java/) makes it easy for Java developers to compare XLS files within their applications using a few lines of code.
