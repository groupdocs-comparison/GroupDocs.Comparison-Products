...
############################# Head ############################
head_title: "API de comparação Java SCALA - Compare arquivos SCALA em busca de diferenças"
...
steps:
    ...
    code: |
        ...
        try (Comparer comparer = new Comparer("C:\\source.scala")) {
            ...
            comparer.compare("C:\\result.scala"); // Crie um arquivo de resultado com o nome especificado
        }
        ...
        try (Comparer comparer = new Comparer(new FileInputStream("C:\\source.scala"))) {
            ...
            comparer.compare(new FileOutputStream("C:\\result.scala")); // Crie um arquivo de resultado com o nome especificado
        }
        ```
...
demos:
    ...
    content: |
        Compare arquivos SCALA agora mesmo visitando o site [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
