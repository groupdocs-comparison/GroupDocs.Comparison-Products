...
############################# Head ############################
head_title: "Java SQL API Perbandingan - Periksa SQL File untuk Perbedaan"
head_description: "Bandingkan dan gabungkan SQL file dalam aplikasi Java, J2EE, J2SE. Analisis ringkasan perbedaan dalam konten, teks & gaya."

############################# Header ############################
title: "Bandingkan SQL File di Java" 
description: "Lakukan perbandingan konten antara lebih dari dua SQL file di Java. Ambil daftar perbedaan dan simpan file yang dibandingkan ke satu dokumen."
...
steps:
    enable: true
    title: "Cara membandingkan beberapa dokumen SQL menggunakan Java"
    content: |
      Gunakan [GroupDocs.Comparison](https://products.groupdocs.com/comparison/java/) untuk membandingkan beberapa file SQL dan menghasilkan laporan yang merinci perbedaannya
      ...
      2. Buat instance jalur pengaturan kelas Comparer ke salah satu dari SQL file
      3. Tambahkan setidaknya satu SQL tambahan ke instance Comparer
