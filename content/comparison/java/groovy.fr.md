...
############################# Head ############################
head_title: "Java API de comparaison GROOVY - Comparez les fichiers GROOVY pour les différences"
head_description: "Comparez et fusionnez les fichiers GROOVY dans les applications Java, J2EE, J2SE. Analysez le résumé des différences dans le contenu, le texte et le style des fichiers, images et formats de document GROOVY."

############################# Header ############################
title: "Comparez les fichiers GROOVY dans Java"
...
steps:
    ...
    code: |
        ...
        try (Comparer comparer = new Comparer("C:\\source.groovy")) {
            ...
            comparer.compare("C:\\result.groovy"); // Crée un fichier résultat avec le nom spécifié
        }
        ...
        try (Comparer comparer = new Comparer(new FileInputStream("C:\\source.groovy"))) {
            ...
            comparer.compare(new FileOutputStream("C:\\result.groovy")); // Crée un fichier résultat avec le nom spécifié
        }
        ```
...
demos:
    ...
    content: |
        Comparez les fichiers GROOVY dès maintenant en visitant le site Web [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
