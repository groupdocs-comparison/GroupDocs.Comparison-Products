...
############################# Head ############################
head_title: "Java RB Comparison API - Check RB Files for Differences"
head_description: "Compare and merge RB files in Java, J2EE, J2SE applications. Analyze differences summary in content, text & style of RB files, images and document formats."

############################# Header ############################
title: "Compare RB Files in Java" 
description: "Perform content comparison between more than two RB files in Java. Retrieve a list of differences and save the compared files to a single document."
...
steps:
    enable: true
    title: "How to compare several RB documents using Java"
    content: |
      Use [GroupDocs.Comparison](https://products.groupdocs.com/comparison/java/) to compare multiple RB files and generate a report detailing their differences
      ...
      2. Create an instance of the Comparer class setting path to one of RB files
      3. Add at least one additional RB to the Comparer instance
