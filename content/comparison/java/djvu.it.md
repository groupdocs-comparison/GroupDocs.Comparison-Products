...
############################# Head ############################
head_title: "Java DJVU API di confronto - Confronta DJVU file per le differenze"
head_description: "Confronta e unisci DJVU file in applicazioni Java, J2EE, J2SE. Analizza il riepilogo delle differenze nel contenuto, nel testo e nello stile di DJVU file, immagini e formati di documenti."

############################# Header ############################
title: "Confronta DJVU File in Java"
description: "Esegui un confronto riga per riga tra più di due file DJVU in Java. Recupera un elenco di differenze e salva i file confrontati in un unico documento."
...
steps:
    enable: true
    title_left: "Passi per confrontare i file DJVU in Java"
    content_left: |
...
demos:
    enable: true
    title: "Demo dal vivo per confrontare DJVU file"
    content: |
        Confronta subito DJVU file visitando il sito web [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
