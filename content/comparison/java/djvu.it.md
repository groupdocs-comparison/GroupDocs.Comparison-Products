...
############################# Head ############################
head_title: "API di confronto Java DJVU: confronta i file DJVU per le differenze"
head_description: "Confronta e unisci file DJVU nelle applicazioni Java, J2EE, J2SE. Analizza il riepilogo delle differenze nel contenuto, nel testo e nello stile di file, immagini e formati di documenti DJVU."

############################# Header ############################
title: "Confronta i file DJVU in Java"
description: "Esegui un confronto riga per riga tra più di due file DJVU in Java. Recupera un elenco di differenze e salva i file confrontati in un singolo documento."
...
steps:
    enable: true
    title_left: "Passaggi per confrontare i file DJVU in Java"
    content_left: |
        [GroupDocs.Comparison](/comparison/java/) consente agli sviluppatori Java di confrontare facilmente i file DJVU all'interno delle loro applicazioni utilizzando poche righe di codice.
    ...
    code: |
        ...
        try (Comparer comparer = new Comparer("C:\\source.djvu")) {
            ...
            comparer.compare("C:\\result.djvu"); // Crea il file dei risultati con il nome specificato
        }
        ...
        try (Comparer comparer = new Comparer(new FileInputStream("C:\\source.djvu"))) {
            ...
            comparer.compare(new FileOutputStream("C:\\result.djvu")); // Crea il file dei risultati con il nome specificato
        }
        ```
...
demos:
    enable: true
    title: "Demo dal vivo per confrontare file DJVU"
    content: |
        Confronta subito i file DJVU visitando il sito web [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-djvu"
          ...
          content: |
            DjVu, pronunciato come “déjà vu”, è un formato di file grafico destinato a documenti e libri scansionati, in particolare quelli che contengono una combinazione di testo, disegni, immagini e fotografie. È stato sviluppato da AT&T Labs. Utilizza molteplici tecniche come la separazione dei livelli di immagine del testo e delle immagini di sfondo, il caricamento progressivo, la codifica aritmetica e la compressione con perdita per le immagini bitonali. Poiché il file DJVU può contenere immagini a colori, fotografie, testi e disegni compressi ma di alta qualità e può essere salvato in meno spazio, viene quindi utilizzato sul Web come eBook, manuali, giornali, documenti antichi, ecc.
...
solutions:
    ...
    solution:
        # solution loop
        - img_alt: "GroupDocs.Comparison for .NET DJVU"
          image: "https://www.groupdocs.cloud/templates/groupdocs/images/product-logos/groupdocs-comparison-net.png"
          product: "GroupDocs.Comparison"
          platform: ".NET"
          link: "/comparison/net/djvu/"
