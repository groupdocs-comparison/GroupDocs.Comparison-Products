...
############################# Head ############################
head_title: "API de comparação Java XLSM - compare arquivos XLSM para diferenças"
...
############################# Header ############################
title: "Comparar arquivos XLSM em Java"
...
steps:
    ...
    code: |
        ...
        try (Comparer comparer = new Comparer("C:\\source.xlsm")) {
            ...
            comparer.compare("C:\\result.xlsm"); // Cria arquivo de resultado com o nome especificado
        }
        ...
        try (Comparer comparer = new Comparer(new FileInputStream("C:\\source.xlsm"))) {
            ...
            comparer.compare(new FileOutputStream("C:\\result.xlsm")); // Cria arquivo de resultado com o nome especificado
        }
        ```
...
demos:
    ...
    content: |
        Compare os arquivos XLSM agora mesmo visitando o site [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
