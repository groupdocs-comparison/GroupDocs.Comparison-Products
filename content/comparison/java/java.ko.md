...
description: "Java에서 2개 이상의 JAVA 파일 간에 라인별로 비교를 수행합니다. 차이점 목록을 검색하고 비교된 파일을 단일 문서에 저장합니다."
...
demos:
    enable: true
    title: "JAVA 파일을 비교하기 위한 라이브 데모"
    content: |
        지금 바로 [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family) 웹사이트를 방문하여 JAVA 파일을 비교하세요.
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-java"
          title: "JAVA 파일 형식 정보"
          content: |
            Java는 여러 플랫폼에서 실행할 수 있는 범용 객체 지향 언어입니다. Java 소스 코드는 확장자가 .java인 파일에 포함되어 있습니다. Java는 모바일 애플리케이션, 웹 애플리케이션, 데스크탑 애플리케이션, 게임 등의 개발에 사용됩니다. Java는 Windows, Mac, Linux, Raspberry Pi 등을 포함한 여러 플랫폼에서 작동합니다. Java는 C# 및 C++와 매우 유사하므로 이 언어 사이를 전환하십시오.
