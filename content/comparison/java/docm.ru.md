...
############################# Head ############################
head_title: "Java DOCM API сравнения — проверьте DOCM файлы на наличие различий"
head_description: "Сравните и объедините DOCM файлов в приложениях Java, J2EE, J2SE. Проанализируйте сводку различий в содержании, тексте и стиле."

############################# Header ############################
title: "Сравните DOCM файлов в Java" 
description: "Выполните сравнение содержимого более чем двух DOCM файлов в Java. Получите список различий и сохраните сравниваемые файлы в одном документе."
...
steps:
    enable: true
    title: "Как сравнить несколько DOCM документов с помощью Java"
    content: |
      Используйте [GroupDocs.Comparison](https://products.groupdocs.com/comparison/java/) для сравнения нескольких DOCM файлов и создания отчета с подробным описанием их различий
      ...
      2. Создайте экземпляр класса Comparer, задав путь к одному из DOCM файлов
      3. Добавьте хотя бы один дополнительный DOCM к экземпляру Comparer
