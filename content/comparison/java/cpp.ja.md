...
############################# Head ############################
head_title: "JavaCPP比較API-CPPファイルの違いを比較する"
...
steps:
    enable: true
    title_left: "JavaでCPPファイルを比較する手順"
    content_left: |
        [GroupDocs.Comparison](/ja/comparison/java/)を使用すると、Java開発者は数行のコードを使用してアプリケーション内のCPPファイルを簡単に比較できます。
