...
############################# Head ############################
head_title: "API di confronto Java ODS: confronta i file ODS per le differenze"
head_description: "Confronta e unisci file ODS nelle applicazioni Java, J2EE, J2SE. Analizza il riepilogo delle differenze nel contenuto, nel testo e nello stile di file, immagini e formati di documenti ODS."

############################# Header ############################
title: "Confronta i file ODS in Java"
description: "Esegui un confronto riga per riga tra più di due file ODS in Java. Recupera un elenco di differenze e salva i file confrontati in un singolo documento."
...
steps:
    enable: true
    title_left: "Passaggi per confrontare i file ODS in Java"
    content_left: |
        [GroupDocs.Comparison](/comparison/java/) consente agli sviluppatori Java di confrontare facilmente i file ODS all'interno delle loro applicazioni utilizzando poche righe di codice.
    ...
    code: |
        ...
        try (Comparer comparer = new Comparer("C:\\source.ods")) {
            ...
            comparer.compare("C:\\result.ods"); // Crea il file dei risultati con il nome specificato
        }
        ...
        try (Comparer comparer = new Comparer(new FileInputStream("C:\\source.ods"))) {
            ...
            comparer.compare(new FileOutputStream("C:\\result.ods")); // Crea il file dei risultati con il nome specificato
        }
        ```
...
demos:
    enable: true
    title: "Demo dal vivo per confrontare file ODS"
    content: |
        Confronta subito i file ODS visitando il sito web [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
