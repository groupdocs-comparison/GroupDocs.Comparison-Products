...
############################# Head ############################
head_title: "Java API de comparaison PPSX - Comparez les fichiers PPSX pour les différences"
head_description: "Comparez et fusionnez les fichiers PPSX dans les applications Java, J2EE, J2SE. Analysez le résumé des différences dans le contenu, le texte et le style des fichiers, images et formats de document PPSX."

############################# Header ############################
title: "Comparez les fichiers PPSX dans Java"
...
steps:
    ...
    code: |
        ...
        try (Comparer comparer = new Comparer("C:\\source.ppsx")) {
            ...
            comparer.compare("C:\\result.ppsx"); // Crée un fichier résultat avec le nom spécifié
        }
        ...
        try (Comparer comparer = new Comparer(new FileInputStream("C:\\source.ppsx"))) {
            ...
            comparer.compare(new FileOutputStream("C:\\result.ppsx")); // Crée un fichier résultat avec le nom spécifié
        }
        ```
...
demos:
    ...
    content: |
        Comparez les fichiers PPSX dès maintenant en visitant le site Web [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
