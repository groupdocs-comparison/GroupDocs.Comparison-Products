...
############################# Head ############################
head_title: "Utilize the Comparison API to compare CSV documents using Java."
...
############################# Header ############################
title: "CSV document comparison in Java applications" 
description: "GroupDocs.Comparison API for getting and displaying differences in CSV documents using applications based on Java, J2EE, and J2SE. Easily obtain detailed reports for a brilliant experience."
...
steps:
    enable: true
    title: "How to compare several CSV documents using Java"
    content: |
      Use [GroupDocs.Comparison](https://products.groupdocs.com/comparison/java/) to compare multiple CSV files and generate a report detailing their differences
      ...
      2. Create an instance of the Comparer class setting path to one of CSV files
      3. Add at least one additional CSV to the Comparer instance
