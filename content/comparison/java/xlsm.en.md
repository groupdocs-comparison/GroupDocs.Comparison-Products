...
############################# Head ############################
head_title: "Java XLSM Comparison API - Check XLSM Files for Differences"
head_description: "Compare and merge XLSM files in Java, J2EE, J2SE applications. Analyze differences summary in content, text & style of XLSM files, images and document formats."

############################# Header ############################
title: "Compare XLSM Files in Java" 
description: "Perform content comparison between more than two XLSM files in Java. Retrieve a list of differences and save the compared files to a single document."
...
steps:
    enable: true
    title: "How to compare several XLSM documents using Java"
    content: |
      Use [GroupDocs.Comparison](https://products.groupdocs.com/comparison/java/) to compare multiple XLSM files and generate a report detailing their differences
      ...
      2. Create an instance of the Comparer class setting path to one of XLSM files
      3. Add at least one additional XLSM to the Comparer instance
