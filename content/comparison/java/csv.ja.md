...
head_description: "Java、J2EE、J2SEアプリケーションでCSVファイルを比較してマージします。コンテンツ、テキスト、およびテキストの違いの要約を分析します。 CSVファイル、画像、ドキュメント形式のスタイル."
...
steps:
    ...
    content_left: |
        [GroupDocs.Comparison](/compareson/java/)を使用すると、Java開発者は数行のコードを使用してアプリケーション内のCSVファイルを簡単に比較できます。
