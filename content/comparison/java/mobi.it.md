...
############################# Head ############################
head_title: "Java MOBI API di confronto - Confronta MOBI file per le differenze"
head_description: "Confronta e unisci MOBI file in applicazioni Java, J2EE, J2SE. Analizza il riepilogo delle differenze nel contenuto, nel testo e nello stile di MOBI file, immagini e formati di documenti."

############################# Header ############################
title: "Confronta MOBI File in Java"
description: "Esegui un confronto riga per riga tra più di due file MOBI in Java. Recupera un elenco di differenze e salva i file confrontati in un unico documento."
...
steps:
    enable: true
    title_left: "Passi per confrontare i file MOBI in Java"
    content_left: |
...
demos:
    enable: true
    title: "Demo dal vivo per confrontare MOBI file"
    content: |
        Confronta subito MOBI file visitando il sito web [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
