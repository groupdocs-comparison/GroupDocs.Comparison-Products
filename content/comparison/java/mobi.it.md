...
############################# Head ############################
head_title: "API di confronto Java MOBI: confronta i file MOBI per le differenze"
head_description: "Confronta e unisci file MOBI nelle applicazioni Java, J2EE, J2SE. Analizza il riepilogo delle differenze nel contenuto, nel testo e nello stile di file, immagini e formati di documenti MOBI."

############################# Header ############################
title: "Confronta i file MOBI in Java"
description: "Esegui un confronto riga per riga tra più di due file MOBI in Java. Recupera un elenco di differenze e salva i file confrontati in un singolo documento."
...
steps:
    enable: true
    title_left: "Passaggi per confrontare i file MOBI in Java"
    content_left: |
        [GroupDocs.Comparison](/comparison/java/) consente agli sviluppatori Java di confrontare facilmente i file MOBI all'interno delle loro applicazioni utilizzando poche righe di codice.
    ...
    code: |
        ...
        try (Comparer comparer = new Comparer("C:\\source.mobi")) {
            ...
            comparer.compare("C:\\result.mobi"); // Crea il file dei risultati con il nome specificato
        }
        ...
        try (Comparer comparer = new Comparer(new FileInputStream("C:\\source.mobi"))) {
            ...
            comparer.compare(new FileOutputStream("C:\\result.mobi")); // Crea il file dei risultati con il nome specificato
        }
        ```
...
demos:
    enable: true
    title: "Demo dal vivo per confrontare file MOBI"
    content: |
        Confronta subito i file MOBI visitando il sito web [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-mobi"
          title: "Informazioni sul formato file MOBI"
          content: |
            Il formato file MOBI è uno dei formati file ebook più utilizzati. Il formato è un miglioramento del vecchio formato OEB (Open Ebook Format) ed è stato utilizzato come formato proprietario per Mobipocket Reader. Come EPUB, è supportato da quasi tutti i moderni e-reader, in particolare dai dispositivi mobili con larghezza di banda ridotta. Il formato può essere convertito in molti altri formati come PDF, EPUB e molti altri formati utilizzando applicazioni software disponibili pubblicamente come l'app Kindle. Esistono diverse aziende che offrono libri MOBI gratuiti come Project Gutenberg, Feedbooks e Open Library.
