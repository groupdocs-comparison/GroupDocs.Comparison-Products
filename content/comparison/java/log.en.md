...
############################# Head ############################
head_title: "Java LOG Comparison API - Check LOG Files for Differences"
head_description: "Compare and merge LOG files in Java, J2EE, J2SE applications. Analyze differences summary in content, text & style of LOG files, images and document formats."

############################# Header ############################
title: "Compare LOG Files in Java" 
description: "Perform content comparison between more than two LOG files in Java. Retrieve a list of differences and save the compared files to a single document."
...
steps:
    enable: true
    title: "How to compare several LOG documents using Java"
    content: |
      Use [GroupDocs.Comparison](https://products.groupdocs.com/comparison/java/) to compare multiple LOG files and generate a report detailing their differences
      ...
      2. Create an instance of the Comparer class setting path to one of LOG files
      3. Add at least one additional LOG to the Comparer instance
