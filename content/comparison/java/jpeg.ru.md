...
############################# Head ############################
head_title: "Проанализируйте JPEG s с помощью сравнительных отчетов через Java."
...
############################# Header ############################
title: "Сравните JPEG изображений с нашей библиотекой Java" 
...
steps:
    ...
    content: |
      ...
      3. Добавить JPEG файлов к сравнению
