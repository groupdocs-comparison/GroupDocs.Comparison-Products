...
############################# Head ############################
head_title: "API Perbandingan Java DIFF - Bandingkan File DIFF untuk Mengetahui Perbedaannya"
head_description: "Bandingkan dan gabungkan file DIFF dalam aplikasi Java, J2EE, J2SE. Analisis ringkasan perbedaan dalam konten, teks & gaya file DIFF, gambar dan format dokumen."

############################# Header ############################
title: "Bandingkan File DIFF di Java"
description: "Lakukan perbandingan baris demi baris antara lebih dari dua file DIFF di Java. Ambil daftar perbedaan dan simpan file yang dibandingkan ke satu dokumen."
...
steps:
    enable: true
    title_left: "Langkah-langkah Membandingkan File DIFF di Java"
    content_left: |
        [GroupDocs.Comparison](/comparison/java/) memudahkan pengembang Java untuk membandingkan file DIFF dalam aplikasi mereka menggunakan beberapa baris kode.
    ...
    code: |
        ...
        try (Comparer comparer = new Comparer("C:\\source.diff")) {
            ...
            comparer.compare("C:\\result.diff"); // Buat file hasil dengan nama yang ditentukan
        }
        ...
        try (Comparer comparer = new Comparer(new FileInputStream("C:\\source.diff"))) {
            ...
            comparer.compare(new FileOutputStream("C:\\result.diff")); // Buat file hasil dengan nama yang ditentukan
        }
        ```
...
demos:
    enable: true
    title: "Demo Langsung untuk Membandingkan File DIFF"
    content: |
        Bandingkan file DIFF sekarang dengan mengunjungi situs web [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-diff"
          title: "Tentang Format File DIFF"
          content: |
            File DIFF adalah file tunggal yang menunjukkan perbedaan antara satu atau lebih file teks atau sumber. Itu dibuat oleh Mercurial, alat manajemen kontrol bagi pengembang untuk mendapatkan perbedaan antar file dan menerapkan tambalan. Melalui file DIFF, pengembang membagikan perubahannya kepada pengembang lain sehingga perubahan tersebut dapat diperbarui untuk menghasilkan versi file teks yang lebih baru. File DIFF dapat dibuka di Mercurial.
