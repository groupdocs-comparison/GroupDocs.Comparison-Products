...
############################# Head ############################
head_title: "Java DIFF API Perbandingan - Periksa DIFF File untuk Perbedaan"
head_description: "Bandingkan dan gabungkan DIFF file dalam aplikasi Java, J2EE, J2SE. Analisis ringkasan perbedaan dalam konten, teks & gaya."

############################# Header ############################
title: "Bandingkan DIFF File di Java" 
description: "Lakukan perbandingan konten antara lebih dari dua DIFF file di Java. Ambil daftar perbedaan dan simpan file yang dibandingkan ke satu dokumen."
...
steps:
    enable: true
    title: "Cara membandingkan beberapa dokumen DIFF menggunakan Java"
    content: |
      Gunakan [GroupDocs.Comparison](https://products.groupdocs.com/comparison/java/) untuk membandingkan beberapa file DIFF dan menghasilkan laporan yang merinci perbedaannya
      ...
      2. Buat instance jalur pengaturan kelas Comparer ke salah satu dari DIFF file
      3. Tambahkan setidaknya satu DIFF tambahan ke instance Comparer
