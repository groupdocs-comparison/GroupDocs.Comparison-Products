...
############################# Head ############################
head_title: "API di confronto Java SCALA - Verifica la presenza di differenze tra i file SCALA"
head_description: "Confronta e unisci i file SCALA nelle applicazioni Java, J2EE, J2SE. Analizza il riepilogo delle differenze in termini di contenuto, testo e stile."

############################# Header ############################
title: "Confronta SCALA file in Java" 
description: "Esegui il confronto dei contenuti tra più di due file SCALA in Java. Recupera un elenco di differenze e salva i file confrontati in un unico documento."
...
steps:
    enable: true
    title: "Come confrontare diversi documenti SCALA utilizzando Java"
    content: |
      Usa [GroupDocs.Comparison](https://products.groupdocs.com/comparison/java/) per confrontare più file SCALA e generare un rapporto che descriva in dettaglio le loro differenze
      ...
      2. Crea un'istanza della classe Comparer impostando il percorso di uno dei file SCALA
      3. Aggiungi almeno un altro SCALA all'istanza di Comparer
