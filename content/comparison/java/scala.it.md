...
############################# Head ############################
head_title: "Java SCALA API di confronto - Confronta SCALA file per le differenze"
head_description: "Confronta e unisci SCALA file in applicazioni Java, J2EE, J2SE. Analizza il riepilogo delle differenze nel contenuto, nel testo e nello stile di SCALA file, immagini e formati di documenti."

############################# Header ############################
title: "Confronta SCALA File in Java"
description: "Esegui un confronto riga per riga tra più di due file SCALA in Java. Recupera un elenco di differenze e salva i file confrontati in un unico documento."
...
steps:
    enable: true
    title_left: "Passi per confrontare i file SCALA in Java"
    content_left: |
...
demos:
    enable: true
    title: "Demo dal vivo per confrontare SCALA file"
    content: |
        Confronta subito SCALA file visitando il sito web [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
