...
############################# Head ############################
head_title: "Java LESS Comparison API - Compare LESS Files for Differences"
head_description: "Compare and merge LESS files in Java, J2EE, J2SE applications. Analyse differences summary in content, text & style of LESS files, images and document formats."

############################# Header ############################
title: "Compare LESS Files in Java"
description: "Perform a line-by-line comparison between more than two LESS files in Java. Retrieve a list of differences and save the compared files to a single document."
...
steps:
    enable: true
    title_left: "Steps for Comparing LESS Files in Java"
    content_left: |
        [GroupDocs.Comparison](/comparison/java/) makes it easy for Java developers to compare LESS files within their applications using a few lines of code.
    ...
    code: |
        ...
        try (Comparer comparer = new Comparer("C:\\source.less")) {
            ...
            comparer.compare("C:\\result.less"); // Create result file with the specified name
        }
        ...
        try (Comparer comparer = new Comparer(new FileInputStream("C:\\source.less"))) {
            ...
            comparer.compare(new FileOutputStream("C:\\result.less")); // Create result file with the specified name
        }
        ```
...
demos:
    enable: true
    title: "Live Demos to Compare LESS Files"
    content: |
        Compare LESS files right now by visiting [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family) website.  
