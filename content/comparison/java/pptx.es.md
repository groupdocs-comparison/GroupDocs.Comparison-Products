...
############################# Head ############################
head_title: "API de comparación de Java PPTX - Compara archivos de PPTX en busca de diferencias"
head_description: "Compare y combine archivos PPTX en aplicaciones Java, J2EE, J2SE. Analice el resumen de diferencias en contenido, texto y estilo de PPTX archivos, imágenes y formatos de documentos."

############################# Header ############################
title: "Compara archivos PPTX en Java"
description: "Realice una comparación línea por línea entre más de dos archivos PPTX en Java. Recupere una lista de diferencias y guarde los archivos comparados en un solo documento."
...
steps:
    enable: true
    title_left: "Pasos para comparar archivos PPTX en Java"
    content_left: |
        [GroupDocs.Comparison](/comparison/java/) facilita a los desarrolladores de Java comparar archivos PPTX dentro de sus aplicaciones utilizando unas pocas líneas de código.
    ...
    code: |
        ...
        try (Comparer comparer = new Comparer("C:\\source.pptx")) {
            ...
            comparer.compare("C:\\result.pptx"); // Crear archivo de resultados con el nombre especificado
        }
        ...
        try (Comparer comparer = new Comparer(new FileInputStream("C:\\source.pptx"))) {
            ...
            comparer.compare(new FileOutputStream("C:\\result.pptx")); // Crear archivo de resultados con el nombre especificado
        }
        ```
...
demos:
    enable: true
    title: "Demostraciones en vivo para comparar archivos PPTX"
    content: |
        Compare archivos PPTX ahora mismo visitando el sitio web [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
