...
############################# Head ############################
head_title: "API di confronto Java RTF - Verifica la presenza di differenze tra i file RTF"
head_description: "Confronta e unisci i file RTF nelle applicazioni Java, J2EE, J2SE. Analizza il riepilogo delle differenze in termini di contenuto, testo e stile."

############################# Header ############################
title: "Confronta RTF file in Java" 
description: "Esegui il confronto dei contenuti tra più di due file RTF in Java. Recupera un elenco di differenze e salva i file confrontati in un unico documento."
...
steps:
    enable: true
    title: "Come confrontare diversi documenti RTF utilizzando Java"
    content: |
      Usa [GroupDocs.Comparison](https://products.groupdocs.com/comparison/java/) per confrontare più file RTF e generare un rapporto che descriva in dettaglio le loro differenze
      ...
      2. Crea un'istanza della classe Comparer impostando il percorso di uno dei file RTF
      3. Aggiungi almeno un altro RTF all'istanza di Comparer
