...
############################# Head ############################
head_title: "Java RTF API di confronto - Confronta RTF file per le differenze"
head_description: "Confronta e unisci RTF file in applicazioni Java, J2EE, J2SE. Analizza il riepilogo delle differenze nel contenuto, nel testo e nello stile di RTF file, immagini e formati di documenti."

############################# Header ############################
title: "Confronta RTF File in Java"
description: "Esegui un confronto riga per riga tra più di due file RTF in Java. Recupera un elenco di differenze e salva i file confrontati in un unico documento."
...
steps:
    enable: true
    title_left: "Passi per confrontare i file RTF in Java"
    content_left: |
...
demos:
    enable: true
    title: "Demo dal vivo per confrontare RTF file"
    content: |
        Confronta subito RTF file visitando il sito web [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
