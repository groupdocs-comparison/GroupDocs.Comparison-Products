...
############################# Head ############################
head_title: "Java VSDX API di confronto - Confronta VSDX file per le differenze"
head_description: "Confronta e unisci VSDX file in applicazioni Java, J2EE, J2SE. Analizza il riepilogo delle differenze nel contenuto, nel testo e nello stile di VSDX file, immagini e formati di documenti."

############################# Header ############################
title: "Confronta VSDX File in Java"
description: "Esegui un confronto riga per riga tra più di due file VSDX in Java. Recupera un elenco di differenze e salva i file confrontati in un unico documento."
...
steps:
    enable: true
    title_left: "Passi per confrontare i file VSDX in Java"
    content_left: |
...
demos:
    enable: true
    title: "Demo dal vivo per confrontare VSDX file"
    content: |
        Confronta subito VSDX file visitando il sito web [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
