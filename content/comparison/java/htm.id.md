...
############################# Head ############################
head_title: "Java HTM API Perbandingan - Periksa HTM File untuk Perbedaan"
head_description: "Bandingkan dan gabungkan HTM file dalam aplikasi Java, J2EE, J2SE. Analisis ringkasan perbedaan dalam konten, teks & gaya."

############################# Header ############################
title: "Bandingkan HTM File di Java" 
description: "Lakukan perbandingan konten antara lebih dari dua HTM file di Java. Ambil daftar perbedaan dan simpan file yang dibandingkan ke satu dokumen."
...
steps:
    enable: true
    title: "Cara membandingkan beberapa dokumen HTM menggunakan Java"
    content: |
      Gunakan [GroupDocs.Comparison](https://products.groupdocs.com/comparison/java/) untuk membandingkan beberapa file HTM dan menghasilkan laporan yang merinci perbedaannya
      ...
      2. Buat instance jalur pengaturan kelas Comparer ke salah satu dari HTM file
      3. Tambahkan setidaknya satu HTM tambahan ke instance Comparer
