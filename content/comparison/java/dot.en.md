...
############################# Head ############################
head_title: "Java DOT Comparison API - Check DOT Files for Differences"
head_description: "Compare and merge DOT files in Java, J2EE, J2SE applications. Analyze differences summary in content, text & style of DOT files, images and document formats."

############################# Header ############################
title: "Compare DOT Files in Java" 
description: "Perform content comparison between more than two DOT files in Java. Retrieve a list of differences and save the compared files to a single document."
