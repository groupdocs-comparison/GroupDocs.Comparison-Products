...
############################# Head ############################
head_title: "API de comparação Java DOTX - Compare arquivos DOTX em busca de diferenças"
head_description: "Compare e mescle arquivos DOTX em aplicativos Java, J2EE, J2SE. Analise o resumo das diferenças no conteúdo, texto e estilo de DOTX arquivos, imagens e formatos de documentos."

############################# Header ############################
title: "Compare arquivos DOTX em Java"
description: "Execute uma comparação linha por linha entre mais de dois arquivos DOTX em Java. Recupere uma lista de diferenças e salve os arquivos comparados em um único documento."
...
steps:
    enable: true
    title_left: "Etapas para comparar arquivos DOTX em Java"
    content_left: |
        [GroupDocs.Comparison](/comparison/java/) torna mais fácil para os desenvolvedores Java comparar arquivos DOTX em seus aplicativos usando algumas linhas de código.
    ...
    code: |
        ...
        try (Comparer comparer = new Comparer("C:\\source.dotx")) {
            ...
            comparer.compare("C:\\result.dotx"); // Crie um arquivo de resultado com o nome especificado
        }
        ...
        try (Comparer comparer = new Comparer(new FileInputStream("C:\\source.dotx"))) {
            ...
            comparer.compare(new FileOutputStream("C:\\result.dotx")); // Crie um arquivo de resultado com o nome especificado
        }
        ```
...
demos:
    enable: true
    title: "Demonstrações ao vivo para comparar arquivos DOTX"
    content: |
        Compare arquivos DOTX agora mesmo visitando o site [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
