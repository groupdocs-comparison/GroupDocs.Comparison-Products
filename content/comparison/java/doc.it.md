...
############################# Head ############################
head_title: "Java DOC API di confronto - Confronta DOC file per le differenze"
head_description: "Confronta e unisci DOC file in applicazioni Java, J2EE, J2SE. Analizza il riepilogo delle differenze nel contenuto, nel testo e nello stile di DOC file, immagini e formati di documenti."

############################# Header ############################
title: "Confronta DOC File in Java"
description: "Esegui un confronto riga per riga tra più di due file DOC in Java. Recupera un elenco di differenze e salva i file confrontati in un unico documento."
...
steps:
    enable: true
    title_left: "Passi per confrontare i file DOC in Java"
    content_left: |
...
demos:
    enable: true
    title: "Demo dal vivo per confrontare DOC file"
    content: |
        Confronta subito DOC file visitando il sito web [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
