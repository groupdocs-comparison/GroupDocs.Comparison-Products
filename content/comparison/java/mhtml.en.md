...
############################# Head ############################
head_title: "Java MHTML Comparison API - Check MHTML Files for Differences"
head_description: "Compare and merge MHTML files in Java, J2EE, J2SE applications. Analyze differences summary in content, text & style of MHTML files, images and document formats."

############################# Header ############################
title: "Compare MHTML Files in Java" 
description: "Perform content comparison between more than two MHTML files in Java. Retrieve a list of differences and save the compared files to a single document."
...
steps:
    enable: true
    title: "How to compare several MHTML documents using Java"
    content: |
      Use [GroupDocs.Comparison](https://products.groupdocs.com/comparison/java/) to compare multiple MHTML files and generate a report detailing their differences
      ...
      2. Create an instance of the Comparer class setting path to one of MHTML files
      3. Add at least one additional MHTML to the Comparer instance
