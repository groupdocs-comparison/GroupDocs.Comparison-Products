...
############################# Head ############################
head_title: "Java VDX API Perbandingan - Periksa VDX File untuk Perbedaan"
head_description: "Bandingkan dan gabungkan VDX file dalam aplikasi Java, J2EE, J2SE. Analisis ringkasan perbedaan dalam konten, teks & gaya."

############################# Header ############################
title: "Bandingkan VDX File di Java" 
description: "Lakukan perbandingan konten antara lebih dari dua VDX file di Java. Ambil daftar perbedaan dan simpan file yang dibandingkan ke satu dokumen."
...
steps:
    enable: true
    title: "Cara membandingkan beberapa dokumen VDX menggunakan Java"
    content: |
      Gunakan [GroupDocs.Comparison](https://products.groupdocs.com/comparison/java/) untuk membandingkan beberapa file VDX dan menghasilkan laporan yang merinci perbedaannya
      ...
      2. Buat instance jalur pengaturan kelas Comparer ke salah satu dari VDX file
      3. Tambahkan setidaknya satu VDX tambahan ke instance Comparer
