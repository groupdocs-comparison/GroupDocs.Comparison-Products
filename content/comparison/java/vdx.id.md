...
############################# Head ############################
head_title: "API Perbandingan VDX Java - Bandingkan File VDX untuk Perbedaan"
head_description: "Bandingkan dan gabungkan file VDX di aplikasi Java, J2EE, J2SE. Analisis perbedaan ringkasan dalam konten, teks & gaya file VDX, gambar, dan format dokumen."

############################# Header ############################
title: "Bandingkan File VDX di Jawa"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Membandingkan File VDX di Java"
    content_left: |
        [GroupDocs.Comparison](/id/comparison/java/) memudahkan pengembang Java untuk membandingkan file VDX dalam aplikasi mereka menggunakan beberapa baris kode.
    ...
    code: |
        ...
        try (Comparer comparer = new Comparer(new FileInputStream("C:\\source.vdx"))) {
            ...
            comparer.compare(new FileOutputStream("C:\\result.vdx"));
        }
        ```
...
demos:
    enable: true
    title: "Demo Langsung untuk Membandingkan VDX File"
    content: |
        Bandingkan file VDX sekarang dengan mengunjungi situs web [GroupDocs.Comparison](https://products.groupdocs.app/comparison/family). Demo langsung memiliki manfaat sebagai berikut.
