...
############################# Head ############################
head_title: "Java DCM Comparison API - Check DCM Files for Differences"
head_description: "Compare and merge DCM files in Java, J2EE, J2SE applications. Analyze differences summary in content, text & style of DCM files, images and document formats."

############################# Header ############################
title: "Compare DCM Files in Java" 
description: "Perform content comparison between more than two DCM files in Java. Retrieve a list of differences and save the compared files to a single document."
...
steps:
    enable: true
    title: "How to compare several DCM documents using Java"
    content: |
      Use [GroupDocs.Comparison](https://products.groupdocs.com/comparison/java/) to compare multiple DCM files and generate a report detailing their differences
      ...
      2. Create an instance of the Comparer class setting path to one of DCM files
      3. Add at least one additional DCM to the Comparer instance
