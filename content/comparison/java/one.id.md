...
############################# Head ############################
head_title: "API Perbandingan ONE Java - Bandingkan File ONE untuk Perbedaan"
head_description: "Bandingkan dan gabungkan file ONE di aplikasi Java, J2EE, J2SE. Analisis perbedaan ringkasan dalam konten, teks & gaya file ONE, gambar, dan format dokumen."

############################# Header ############################
title: "Bandingkan File ONE di Jawa"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Membandingkan File ONE di Java"
    content_left: |
        [GroupDocs.Comparison](/id/comparison/java/) memudahkan pengembang Java untuk membandingkan file ONE dalam aplikasi mereka menggunakan beberapa baris kode.
    ...
    code: |
        ...
        try (Comparer comparer = new Comparer(new FileInputStream("C:\\source.one"))) {
            ...
            comparer.compare(new FileOutputStream("C:\\result.one"));
        }
        ```
...
demos:
    enable: true
    title: "Demo Langsung untuk Membandingkan ONE File"
    content: |
        Bandingkan file ONE sekarang dengan mengunjungi situs web [GroupDocs.Comparison](https://products.groupdocs.app/comparison/family). Demo langsung memiliki manfaat sebagai berikut.
