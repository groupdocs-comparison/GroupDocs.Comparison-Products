...
############################# Head ############################
head_title: "Java BMP Comparison API - Check BMP Files for Differences"
head_description: "Compare and merge BMP files in Java, J2EE, J2SE applications. Analyze differences summary in content, text & style of BMP files, images and document formats."

############################# Header ############################
title: "Compare BMP Files in Java" 
description: "Perform content comparison between more than two BMP files in Java. Retrieve a list of differences and save the compared files to a single document."
...
steps:
    enable: true
    title: "How to compare several BMP documents using Java"
    content: |
      Use [GroupDocs.Comparison](https://products.groupdocs.com/comparison/java/) to compare multiple BMP files and generate a report detailing their differences
      ...
      2. Create an instance of the Comparer class setting path to one of BMP files
      3. Add at least one additional BMP to the Comparer instance
