...
############################# Head ############################
head_title: "API di confronto Java DIFF - Verifica la presenza di differenze tra i file DIFF"
head_description: "Confronta e unisci i file DIFF nelle applicazioni Java, J2EE, J2SE. Analizza il riepilogo delle differenze in termini di contenuto, testo e stile."

############################# Header ############################
title: "Confronta DIFF file in Java" 
description: "Esegui il confronto dei contenuti tra più di due file DIFF in Java. Recupera un elenco di differenze e salva i file confrontati in un unico documento."
...
steps:
    enable: true
    title: "Come confrontare diversi documenti DIFF utilizzando Java"
    content: |
      Usa [GroupDocs.Comparison](https://products.groupdocs.com/comparison/java/) per confrontare più file DIFF e generare un rapporto che descriva in dettaglio le loro differenze
      ...
      2. Crea un'istanza della classe Comparer impostando il percorso di uno dei file DIFF
      3. Aggiungi almeno un altro DIFF all'istanza di Comparer
