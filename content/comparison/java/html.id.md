...
############################# Head ############################
head_title: "API Perbandingan HTML Java - Bandingkan File HTML untuk Perbedaan"
head_description: "Bandingkan dan gabungkan file HTML di aplikasi Java, J2EE, J2SE. Analisis perbedaan ringkasan dalam konten, teks & gaya file HTML, gambar, dan format dokumen."

############################# Header ############################
title: "Bandingkan File HTML di Jawa"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Membandingkan File HTML di Java"
    content_left: |
        [GroupDocs.Comparison](/id/comparison/java/) memudahkan pengembang Java untuk membandingkan file HTML dalam aplikasi mereka menggunakan beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung untuk Membandingkan HTML File"
    content: |
        Bandingkan file HTML sekarang dengan mengunjungi situs web [GroupDocs.Comparison](https://products.groupdocs.app/comparison/family). Demo langsung memiliki manfaat sebagai berikut.
