...
############################# Head ############################
head_title: "Java HTML API Perbandingan - Periksa HTML File untuk Perbedaan"
head_description: "Bandingkan dan gabungkan HTML file dalam aplikasi Java, J2EE, J2SE. Analisis ringkasan perbedaan dalam konten, teks & gaya."

############################# Header ############################
title: "Bandingkan HTML File di Java" 
description: "Lakukan perbandingan konten antara lebih dari dua HTML file di Java. Ambil daftar perbedaan dan simpan file yang dibandingkan ke satu dokumen."
...
steps:
    enable: true
    title: "Cara membandingkan beberapa dokumen HTML menggunakan Java"
    content: |
      Gunakan [GroupDocs.Comparison](https://products.groupdocs.com/comparison/java/) untuk membandingkan beberapa file HTML dan menghasilkan laporan yang merinci perbedaannya
      ...
      2. Buat instance jalur pengaturan kelas Comparer ke salah satu dari HTML file
      3. Tambahkan setidaknya satu HTML tambahan ke instance Comparer
