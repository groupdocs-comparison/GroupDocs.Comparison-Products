...
############################# Head ############################
head_title: "Java ODP Comparison API - Compare ODP Files for Differences"
head_description: "Compare and merge ODP files in Java, J2EE, J2SE applications. Analyse differences summary in content, text &amp; style of ODP files, images and document formats."

############################# Header ############################
title: "Compare ODP Files in Java"
description: "Perform a line-by-line comparison between more than two ODP files in Java. Retrieve a list of differences and save the compared files to a single document."
...
steps:
    enable: true
    title_left: "Steps for Comparing ODP Files in Java"
    content_left: |
        [GroupDocs.Comparison](/comparison/java/) makes it easy for Java developers to compare ODP files within their applications using a few lines of code.
...
demos:
    enable: true
    title: "Live Demos to Compare ODP Files"
    content: |
        Compare ODP files right now by visiting [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family) website.  
