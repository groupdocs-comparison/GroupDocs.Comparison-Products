...
############################# Head ############################
head_title: "API di confronto Java PPS: confronta i file PPS per le differenze"
head_description: "Confronta e unisci file PPS nelle applicazioni Java, J2EE, J2SE. Analizza il riepilogo delle differenze nel contenuto, nel testo e nello stile di file, immagini e formati di documenti PPS."

############################# Header ############################
title: "Confronta i file PPS in Java"
description: "Esegui un confronto riga per riga tra più di due file PPS in Java. Recupera un elenco di differenze e salva i file confrontati in un singolo documento."
...
steps:
    enable: true
    title_left: "Passaggi per confrontare i file PPS in Java"
    content_left: |
        [GroupDocs.Comparison](/comparison/java/) consente agli sviluppatori Java di confrontare facilmente i file PPS all'interno delle loro applicazioni utilizzando poche righe di codice.
    ...
    code: |
        ...
        try (Comparer comparer = new Comparer("C:\\source.pps")) {
            ...
            comparer.compare("C:\\result.pps"); // Crea il file dei risultati con il nome specificato
        }
        ...
        try (Comparer comparer = new Comparer(new FileInputStream("C:\\source.pps"))) {
            ...
            comparer.compare(new FileOutputStream("C:\\result.pps")); // Crea il file dei risultati con il nome specificato
        }
        ```
...
demos:
    enable: true
    title: "Demo dal vivo per confrontare file PPS"
    content: |
        Confronta subito i file PPS visitando il sito web [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-pps"
          ...
          content: |
            PPS, presentazione di diapositive di PowerPoint, i file vengono creati utilizzando Microsoft PowerPoint per scopi di presentazione. La lettura e la creazione di file PPS sono supportate da Microsoft PowerPoint 97-2003. La versione più recente di questo formato di file è PPSX che si basa sugli standard Office OpenXML. I file PPS possono ancora essere letti dalle ultime versioni di Microsoft PowerPoint, ma i file appena creati possono essere salvati solo nel formato file PPSX. Quando un file PPS viene condiviso con un altro utente e aperto, si avvia come spettacolo Powerpoint a differenza del file PPT che si apre in modalità modificabile.
