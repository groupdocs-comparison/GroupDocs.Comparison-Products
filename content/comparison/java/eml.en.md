...
############################# Head ############################
head_title: "Java EML Comparison API - Check EML Files for Differences"
head_description: "Compare and merge EML files in Java, J2EE, J2SE applications. Analyze differences summary in content, text & style of EML files, images and document formats."

############################# Header ############################
title: "Compare EML Files in Java" 
description: "Perform content comparison between more than two EML files in Java. Retrieve a list of differences and save the compared files to a single document."
...
steps:
    ...
    content: |
      Use [GroupDocs.Comparison](https://products.groupdocs.com/comparison/java/) to compare multiple EML files and generate a report detailing their differences
      ...
      2. Create an instance of the Comparer class setting path to one of EML files
      3. Add at least one additional EML to the Comparer instance
