...
############################# Head ############################
head_title: "API di confronto Java ASM - Verifica la presenza di differenze tra i file ASM"
head_description: "Confronta e unisci i file ASM nelle applicazioni Java, J2EE, J2SE. Analizza il riepilogo delle differenze in termini di contenuto, testo e stile."

############################# Header ############################
title: "Confronta ASM file in Java" 
description: "Esegui il confronto dei contenuti tra più di due file ASM in Java. Recupera un elenco di differenze e salva i file confrontati in un unico documento."
...
steps:
    enable: true
    title: "Come confrontare diversi documenti ASM utilizzando Java"
    content: |
      Usa [GroupDocs.Comparison](https://products.groupdocs.com/comparison/java/) per confrontare più file ASM e generare un rapporto che descriva in dettaglio le loro differenze
      ...
      2. Crea un'istanza della classe Comparer impostando il percorso di uno dei file ASM
      3. Aggiungi almeno un altro ASM all'istanza di Comparer
