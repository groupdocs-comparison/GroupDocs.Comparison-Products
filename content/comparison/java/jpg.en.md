...
############################# Head ############################
head_title: "Java JPG Comparison API - Compare JPG Files for Differences"
head_description: "Compare and merge JPG files in Java, J2EE, J2SE applications. Analyse differences summary in content, text & style of JPG files, images and document formats."

############################# Header ############################
title: "Compare JPG Files in Java"
description: "Perform a line-by-line comparison between more than two JPG files in Java. Retrieve a list of differences and save the compared files to a single document."
...
steps:
    enable: true
    title_left: "Steps for Comparing JPG Files in Java"
    content_left: |
        [GroupDocs.Comparison](/comparison/java/) makes it easy for Java developers to compare JPG files within their applications using a few lines of code.
    ...
    code: |
        ...
        try (Comparer comparer = new Comparer("C:\\source.jpg")) {
            ...
            comparer.compare("C:\\result.jpg"); // Create result file with the specified name
        }
        ...
        try (Comparer comparer = new Comparer(new FileInputStream("C:\\source.jpg"))) {
            ...
            comparer.compare(new FileOutputStream("C:\\result.jpg")); // Create result file with the specified name
        }
        ```
...
demos:
    enable: true
    title: "Live Demos to Compare JPG Files"
    content: |
        Compare JPG files right now by visiting [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family) website.  
