...
head_title: "JavaDOC比較API-DOCファイルの違いを比較します"
...
steps:
    enable: true
    title_left: "JavaでDOCファイルを比較するための手順"
    content_left: |
...
demos:
    ...
    content: |
        [GroupDocs.Comparisonライブデモ](https://products.groupdocs.app/comparison/family)サイトにアクセスして、今すぐDOCファイルを比較してください。  
        ライブデモには次の利点があります
