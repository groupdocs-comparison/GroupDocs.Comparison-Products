...
############################# Head ############################
head_title: "API Perbandingan GROOVY Java - Bandingkan File GROOVY untuk Perbedaan"
head_description: "Bandingkan dan gabungkan file GROOVY di aplikasi Java, J2EE, J2SE. Analisis perbedaan ringkasan dalam konten, teks & gaya file GROOVY, gambar, dan format dokumen."

############################# Header ############################
title: "Bandingkan File GROOVY di Jawa"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Membandingkan File GROOVY di Java"
    content_left: |
        [GroupDocs.Comparison](/id/comparison/java/) memudahkan pengembang Java untuk membandingkan file GROOVY dalam aplikasi mereka menggunakan beberapa baris kode.
...
demos:
    enable: true
    title: "Demo Langsung untuk Membandingkan GROOVY File"
    content: |
        Bandingkan file GROOVY sekarang dengan mengunjungi situs web [GroupDocs.Comparison](https://products.groupdocs.app/comparison/family). Demo langsung memiliki manfaat sebagai berikut.
