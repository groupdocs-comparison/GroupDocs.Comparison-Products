...
############################# Head ############################
head_title: "Java GROOVY API Perbandingan - Periksa GROOVY File untuk Perbedaan"
head_description: "Bandingkan dan gabungkan GROOVY file dalam aplikasi Java, J2EE, J2SE. Analisis ringkasan perbedaan dalam konten, teks & gaya."

############################# Header ############################
title: "Bandingkan GROOVY File di Java" 
description: "Lakukan perbandingan konten antara lebih dari dua GROOVY file di Java. Ambil daftar perbedaan dan simpan file yang dibandingkan ke satu dokumen."
...
steps:
    enable: true
    title: "Cara membandingkan beberapa dokumen GROOVY menggunakan Java"
    content: |
      Gunakan [GroupDocs.Comparison](https://products.groupdocs.com/comparison/java/) untuk membandingkan beberapa file GROOVY dan menghasilkan laporan yang merinci perbedaannya
      ...
      2. Buat instance jalur pengaturan kelas Comparer ke salah satu dari GROOVY file
      3. Tambahkan setidaknya satu GROOVY tambahan ke instance Comparer
