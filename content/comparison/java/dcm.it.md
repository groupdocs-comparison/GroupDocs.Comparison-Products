...
############################# Head ############################
head_title: "API di confronto Java DCM - Verifica la presenza di differenze tra i file DCM"
head_description: "Confronta e unisci i file DCM nelle applicazioni Java, J2EE, J2SE. Analizza il riepilogo delle differenze in termini di contenuto, testo e stile."

############################# Header ############################
title: "Confronta DCM file in Java" 
description: "Esegui il confronto dei contenuti tra più di due file DCM in Java. Recupera un elenco di differenze e salva i file confrontati in un unico documento."
...
steps:
    enable: true
    title: "Come confrontare diversi documenti DCM utilizzando Java"
    content: |
      Usa [GroupDocs.Comparison](https://products.groupdocs.com/comparison/java/) per confrontare più file DCM e generare un rapporto che descriva in dettaglio le loro differenze
      ...
      2. Crea un'istanza della classe Comparer impostando il percorso di uno dei file DCM
      3. Aggiungi almeno un altro DCM all'istanza di Comparer
