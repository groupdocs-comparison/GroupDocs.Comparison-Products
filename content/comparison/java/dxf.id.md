...
############################# Head ############################
head_title: "Java DXF API Perbandingan - Periksa DXF File untuk Perbedaan"
head_description: "Bandingkan dan gabungkan DXF file dalam aplikasi Java, J2EE, J2SE. Analisis ringkasan perbedaan dalam konten, teks & gaya."

############################# Header ############################
title: "Bandingkan DXF File di Java" 
description: "Lakukan perbandingan konten antara lebih dari dua DXF file di Java. Ambil daftar perbedaan dan simpan file yang dibandingkan ke satu dokumen."
...
steps:
    enable: true
    title: "Cara membandingkan beberapa dokumen DXF menggunakan Java"
    content: |
      Gunakan [GroupDocs.Comparison](https://products.groupdocs.com/comparison/java/) untuk membandingkan beberapa file DXF dan menghasilkan laporan yang merinci perbedaannya
      ...
      2. Buat instance jalur pengaturan kelas Comparer ke salah satu dari DXF file
      3. Tambahkan setidaknya satu DXF tambahan ke instance Comparer
