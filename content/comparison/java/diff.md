...
############################# Head ############################
head_title: "Java DIFF Comparison API - Compare DIFF Files for Differences"
head_description: "Compare and merge DIFF files in Java, J2EE, J2SE applications. Analyse differences summary in content, text &amp; style of DIFF files, images and document formats."

############################# Header ############################
title: "Compare DIFF Files in Java"
description: "Perform a line-by-line comparison between more than two DIFF files in Java. Retrieve a list of differences and save the compared files to a single document."
...
steps:
    enable: true
    title_left: "Steps for Comparing DIFF Files in Java"
    content_left: |
        [GroupDocs.Comparison](/comparison/java/) makes it easy for Java developers to compare DIFF files within their applications using a few lines of code.
    ...
    code: |
        ...
        try (Comparer comparer = new Comparer("C:\\source.diff")) {
            ...
            comparer.compare("C:\\result.diff"); // Create result file with the specified name
        }
        ...
        try (Comparer comparer = new Comparer(new FileInputStream("C:\\source.diff"))) {
            ...
            comparer.compare(new FileOutputStream("C:\\result.diff")); // Create result file with the specified name
        }
        ```
...
demos:
    enable: true
    title: "Live Demos to Compare DIFF Files"
    content: |
        Compare DIFF files right now by visiting [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family) website.  
