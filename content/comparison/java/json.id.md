...
############################# Head ############################
head_title: "Java JSON API Perbandingan - Periksa JSON File untuk Perbedaan"
head_description: "Bandingkan dan gabungkan JSON file dalam aplikasi Java, J2EE, J2SE. Analisis ringkasan perbedaan dalam konten, teks & gaya."

############################# Header ############################
title: "Bandingkan JSON File di Java" 
description: "Lakukan perbandingan konten antara lebih dari dua JSON file di Java. Ambil daftar perbedaan dan simpan file yang dibandingkan ke satu dokumen."
...
steps:
    enable: true
    title: "Cara membandingkan beberapa dokumen JSON menggunakan Java"
    content: |
      Gunakan [GroupDocs.Comparison](https://products.groupdocs.com/comparison/java/) untuk membandingkan beberapa file JSON dan menghasilkan laporan yang merinci perbedaannya
      ...
      2. Buat instance jalur pengaturan kelas Comparer ke salah satu dari JSON file
      3. Tambahkan setidaknya satu JSON tambahan ke instance Comparer
