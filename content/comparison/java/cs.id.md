...
############################# Head ############################
head_title: "API Perbandingan Java CS - Bandingkan File CS untuk Mengetahui Perbedaannya"
head_description: "Bandingkan dan gabungkan file CS dalam aplikasi Java, J2EE, J2SE. Analisis ringkasan perbedaan dalam konten, teks & gaya file CS, gambar dan format dokumen."

############################# Header ############################
title: "Bandingkan File CS di Java"
description: "Lakukan perbandingan baris demi baris antara lebih dari dua file CS di Java. Ambil daftar perbedaan dan simpan file yang dibandingkan ke satu dokumen."
...
steps:
    enable: true
    title_left: "Langkah-langkah Membandingkan File CS di Java"
    content_left: |
        [GroupDocs.Comparison](/comparison/java/) memudahkan pengembang Java untuk membandingkan file CS dalam aplikasi mereka menggunakan beberapa baris kode.
    ...
    code: |
        ...
        try (Comparer comparer = new Comparer("C:\\source.cs")) {
            ...
            comparer.compare("C:\\result.cs"); // Buat file hasil dengan nama yang ditentukan
        }
        ...
        try (Comparer comparer = new Comparer(new FileInputStream("C:\\source.cs"))) {
            ...
            comparer.compare(new FileOutputStream("C:\\result.cs")); // Buat file hasil dengan nama yang ditentukan
        }
        ```
...
demos:
    enable: true
    title: "Demo Langsung untuk Membandingkan File CS"
    content: |
        Bandingkan file CS sekarang dengan mengunjungi situs web [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
