...
############################# Head ############################
head_title: "Java XLT Comparison API - Check XLT Files for Differences"
head_description: "Compare and merge XLT files in Java, J2EE, J2SE applications. Analyze differences summary in content, text & style of XLT files, images and document formats."

############################# Header ############################
title: "Compare XLT Files in Java" 
description: "Perform content comparison between more than two XLT files in Java. Retrieve a list of differences and save the compared files to a single document."
...
steps:
    ...
    content: |
      Use [GroupDocs.Comparison](https://products.groupdocs.com/comparison/java/) to compare multiple XLT files and generate a report detailing their differences
      ...
      2. Create an instance of the Comparer class setting path to one of XLT files
      3. Add at least one additional XLT to the Comparer instance
