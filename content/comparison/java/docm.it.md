...
############################# Head ############################
head_title: "Java DOCM API di confronto - Confronta DOCM file per le differenze"
head_description: "Confronta e unisci DOCM file in applicazioni Java, J2EE, J2SE. Analizza il riepilogo delle differenze nel contenuto, nel testo e nello stile di DOCM file, immagini e formati di documenti."

############################# Header ############################
title: "Confronta DOCM File in Java"
description: "Esegui un confronto riga per riga tra più di due file DOCM in Java. Recupera un elenco di differenze e salva i file confrontati in un unico documento."
...
steps:
    enable: true
    title_left: "Passi per confrontare i file DOCM in Java"
    content_left: |
...
demos:
    enable: true
    title: "Demo dal vivo per confrontare DOCM file"
    content: |
        Confronta subito DOCM file visitando il sito web [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
