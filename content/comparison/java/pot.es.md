...
############################# Head ############################
head_title: "API de comparación Java POT: compare archivos POT en busca de diferencias"
head_description: "Compare y combine archivos POT en aplicaciones Java, J2EE, J2SE. Analice el resumen de diferencias en contenido, texto y estilo de POT archivos, imágenes y formatos de documentos."

############################# Header ############################
title: "Comparar archivos POT en Java"
description: "Realice una comparación línea por línea entre más de dos archivos POT en Java. Recupere una lista de diferencias y guarde los archivos comparados en un solo documento."
...
steps:
    enable: true
    title_left: "Pasos para comparar archivos POT en Java"
    content_left: |
        [GroupDocs.Comparison](/comparison/java/) facilita a los desarrolladores de Java comparar archivos POT dentro de sus aplicaciones utilizando unas pocas líneas de código.
    ...
    code: |
        ...
        try (Comparer comparer = new Comparer("C:\\source.pot")) {
            ...
            comparer.compare("C:\\result.pot"); // Crear archivo de resultados con el nombre especificado
        }
        ...
        try (Comparer comparer = new Comparer(new FileInputStream("C:\\source.pot"))) {
            ...
            comparer.compare(new FileOutputStream("C:\\result.pot")); // Crear archivo de resultados con el nombre especificado
        }
        ```
...
demos:
    enable: true
    title: "Demostraciones en vivo para comparar archivos POT"
    content: |
        Compare archivos POT ahora mismo visitando el sitio web [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
