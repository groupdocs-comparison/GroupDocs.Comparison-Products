...
############################# Head ############################
head_title: "Analiza JPG imágenes con GroupDocs.Comparison for Java."
head_description: "La API GroupDocs.Comparison for Java genera informes útiles para JPG imágenes. Soporta Java, J2EE y J2SE."

############################# Header ############################
title: "Analice los cambios en JPG archivos mediante nuestra solución Java" 
description: "Las aplicaciones Java, J2EE o J2SE que utilizan la API GroupDocs.Comparison pueden generar JPG informes detallados."
...
about:
    enable: true
    title: "Explore la API GroupDocs.Comparison for Java"
    link: "/comparison/java/"
    link_title: "Obtenga más información"
    picture: "about_viewer.svg" # 480 X 400
    content: |
       La solución nativa Java, GroupDocs.Comparison, crea informes detallados sobre JPG alteraciones. Es compatible con los formatos de imagen más populares para su comparación y posterior procesamiento.

############################# Steps ############################
steps:
    enable: true
    title: "Compara JPG archivos con Java"
    content: |
      Recupere datos de diferencias de JPG con [GroupDocs.Comparison](https://products.groupdocs.com/comparison/java/)
      
      1. Mejora la funcionalidad de tu producto añadiendo GroupDocs.Comparison for Java de [Maven](https://releases.groupdocs.com/java/repo/com/groupdocs/groupdocs-comparison/)
      2. Cree una instancia de Comparer con la ruta JPG
      3. Añadir otras JPG imágenes al procesamiento
...
more_formats:
    enable: true
    title: "Realice un seguimiento de los cambios en las diferentes versiones de JPG imágenes con Java"
    exclude: "JPG"
    description: "Detecta alteraciones en JPG imágenes con GroupDocs.Comparison for Java. Mejore los procesos empresariales con informes detallados."
    items: 
        # format loop 1
