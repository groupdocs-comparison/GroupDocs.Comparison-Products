...
############################# Head ############################
head_title: "API de comparação Java HTML - Compare arquivos HTML em busca de diferenças"
head_description: "Compare e mescle arquivos HTML em aplicativos Java, J2EE, J2SE. Analise o resumo das diferenças no conteúdo, texto e estilo de HTML arquivos, imagens e formatos de documentos."

############################# Header ############################
title: "Compare arquivos HTML em Java"
description: "Execute uma comparação linha por linha entre mais de dois arquivos HTML em Java. Recupere uma lista de diferenças e salve os arquivos comparados em um único documento."
...
steps:
    enable: true
    title_left: "Etapas para comparar arquivos HTML em Java"
    content_left: |
        [GroupDocs.Comparison](/comparison/java/) torna mais fácil para os desenvolvedores Java comparar arquivos HTML em seus aplicativos usando algumas linhas de código.
    ...
    code: |
        ...
        try (Comparer comparer = new Comparer("C:\\source.html")) {
            ...
            comparer.compare("C:\\result.html"); // Crie um arquivo de resultado com o nome especificado
        }
        ...
        try (Comparer comparer = new Comparer(new FileInputStream("C:\\source.html"))) {
            ...
            comparer.compare(new FileOutputStream("C:\\result.html")); // Crie um arquivo de resultado com o nome especificado
        }
        ```
...
demos:
    enable: true
    title: "Demonstrações ao vivo para comparar arquivos HTML"
    content: |
        Compare arquivos HTML agora mesmo visitando o site [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
...
solutions:
    ...
    solution:
        # solution loop
        - img_alt: "GroupDocs.Comparison for .NET HTML"
