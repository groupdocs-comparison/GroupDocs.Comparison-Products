...
############################# Head ############################
head_title: "Java DOCM Comparison API - Check DOCM Files for Differences"
head_description: "Compare and merge DOCM files in Java, J2EE, J2SE applications. Analyze differences summary in content, text & style of DOCM files, images and document formats."

############################# Header ############################
title: "Compare DOCM Files in Java" 
description: "Perform content comparison between more than two DOCM files in Java. Retrieve a list of differences and save the compared files to a single document."
