...
############################# Head ############################
head_title: "Java OTT Comparison API - Check OTT Files for Differences"
head_description: "Compare and merge OTT files in Java, J2EE, J2SE applications. Analyze differences summary in content, text & style of OTT files, images and document formats."

############################# Header ############################
title: "Compare OTT Files in Java" 
description: "Perform content comparison between more than two OTT files in Java. Retrieve a list of differences and save the compared files to a single document."
...
steps:
    enable: true
    title: "How to compare several OTT documents using Java"
    content: |
      Use [GroupDocs.Comparison](https://products.groupdocs.com/comparison/java/) to compare multiple OTT files and generate a report detailing their differences
      ...
      2. Create an instance of the Comparer class setting path to one of OTT files
      3. Add at least one additional OTT to the Comparer instance
