...
############################# Head ############################
head_title: "Java OTT Comparison API - Compare OTT Files for Differences"
head_description: "Compare and merge OTT files in Java, J2EE, J2SE applications. Analyse differences summary in content, text & style of OTT files, images and document formats."

############################# Header ############################
title: "Compare OTT Files in Java"
description: "Perform a line-by-line comparison between more than two OTT files in Java. Retrieve a list of differences and save the compared files to a single document."
...
steps:
    enable: true
    title_left: "Steps for Comparing OTT Files in Java"
    content_left: |
        [GroupDocs.Comparison](/comparison/java/) makes it easy for Java developers to compare OTT files within their applications using a few lines of code.
    ...
    code: |
        ...
        try (Comparer comparer = new Comparer("C:\\source.ott")) {
            ...
            comparer.compare("C:\\result.ott"); // Create result file with the specified name
        }
        ...
        try (Comparer comparer = new Comparer(new FileInputStream("C:\\source.ott"))) {
            ...
            comparer.compare(new FileOutputStream("C:\\result.ott")); // Create result file with the specified name
        }
        ```
...
demos:
    enable: true
    title: "Live Demos to Compare OTT Files"
    content: |
        Compare OTT files right now by visiting [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family) website.  
