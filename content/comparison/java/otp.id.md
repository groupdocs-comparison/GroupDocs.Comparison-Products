...
############################# Head ############################
head_title: "Java OTP API Perbandingan - Periksa OTP File untuk Perbedaan"
head_description: "Bandingkan dan gabungkan OTP file dalam aplikasi Java, J2EE, J2SE. Analisis ringkasan perbedaan dalam konten, teks & gaya."

############################# Header ############################
title: "Bandingkan OTP File di Java" 
description: "Lakukan perbandingan konten antara lebih dari dua OTP file di Java. Ambil daftar perbedaan dan simpan file yang dibandingkan ke satu dokumen."
...
steps:
    enable: true
    title: "Cara membandingkan beberapa dokumen OTP menggunakan Java"
    content: |
      Gunakan [GroupDocs.Comparison](https://products.groupdocs.com/comparison/java/) untuk membandingkan beberapa file OTP dan menghasilkan laporan yang merinci perbedaannya
      ...
      2. Buat instance jalur pengaturan kelas Comparer ke salah satu dari OTP file
      3. Tambahkan setidaknya satu OTP tambahan ke instance Comparer
