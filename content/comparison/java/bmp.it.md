...
############################# Head ############################
head_title: "Java BMP API di confronto - Confronta BMP file per le differenze"
head_description: "Confronta e unisci BMP file in applicazioni Java, J2EE, J2SE. Analizza il riepilogo delle differenze nel contenuto, nel testo e nello stile di BMP file, immagini e formati di documenti."

############################# Header ############################
title: "Confronta BMP File in Java"
description: "Esegui un confronto riga per riga tra più di due file BMP in Java. Recupera un elenco di differenze e salva i file confrontati in un unico documento."
...
steps:
    enable: true
    title_left: "Passi per confrontare i file BMP in Java"
    content_left: |
...
demos:
    enable: true
    title: "Demo dal vivo per confrontare BMP file"
    content: |
        Confronta subito BMP file visitando il sito web [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
