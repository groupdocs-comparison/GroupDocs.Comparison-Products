...
############################# Head ############################
head_title: "Utilize the Comparison API to compare GIF documents using Java."
...
############################# Header ############################
title: "GIF document comparison in Java applications" 
description: "GroupDocs.Comparison API for getting and displaying differences in GIF documents using applications based on Java, J2EE, and J2SE. Easily obtain detailed reports for a brilliant experience."
...
steps:
    ...
    content: |
      It is possible to use GIF files using [GroupDocs.Comparison](https://products.groupdocs.com/comparison/java/) for getting report about differences in many GIF files.
