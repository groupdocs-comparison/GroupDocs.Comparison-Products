...
############################# Head ############################
head_title: "Java DJVU Comparison API - Compare DJVU Files for Differences"
head_description: "Compare and merge DJVU files in Java, J2EE, J2SE applications. Analyse differences summary in content, text & style of DJVU files, images and document formats."

############################# Header ############################
title: "Compare DJVU Files in Java"
description: "Perform a line-by-line comparison between more than two DJVU files in Java. Retrieve a list of differences and save the compared files to a single document."
...
steps:
    enable: true
    title_left: "Steps for Comparing DJVU Files in Java"
    content_left: |
        [GroupDocs.Comparison](/comparison/java/) makes it easy for Java developers to compare DJVU files within their applications using a few lines of code.
    ...
    code: |
        ...
        try (Comparer comparer = new Comparer("C:\\source.djvu")) {
            ...
            comparer.compare("C:\\result.djvu"); // Create result file with the specified name
        }
        ...
        try (Comparer comparer = new Comparer(new FileInputStream("C:\\source.djvu"))) {
            ...
            comparer.compare(new FileOutputStream("C:\\result.djvu")); // Create result file with the specified name
        }
        ```
...
demos:
    enable: true
    title: "Live Demos to Compare DJVU Files"
    content: |
        Compare DJVU files right now by visiting [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family) website.  
