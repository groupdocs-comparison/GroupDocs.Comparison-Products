...
############################# Head ############################
head_title: "Java DJVU Comparison API - Check DJVU Files for Differences"
head_description: "Compare and merge DJVU files in Java, J2EE, J2SE applications. Analyze differences summary in content, text & style of DJVU files, images and document formats."

############################# Header ############################
title: "Compare DJVU Files in Java" 
description: "Perform content comparison between more than two DJVU files in Java. Retrieve a list of differences and save the compared files to a single document."
...
steps:
    enable: true
    title: "How to compare several DJVU documents using Java"
    content: |
      Use [GroupDocs.Comparison](https://products.groupdocs.com/comparison/java/) to compare multiple DJVU files and generate a report detailing their differences
      ...
      2. Create an instance of the Comparer class setting path to one of DJVU files
      3. Add at least one additional DJVU to the Comparer instance
