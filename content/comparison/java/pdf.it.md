...
############################# Head ############################
head_title: "Java PDF API di confronto - Confronta PDF file per le differenze"
head_description: "Confronta e unisci PDF file in applicazioni Java, J2EE, J2SE. Analizza il riepilogo delle differenze nel contenuto, nel testo e nello stile di PDF file, immagini e formati di documenti."

############################# Header ############################
title: "Confronta PDF File in Java"
description: "Esegui un confronto riga per riga tra più di due file PDF in Java. Recupera un elenco di differenze e salva i file confrontati in un unico documento."
...
steps:
    enable: true
    title_left: "Passi per confrontare i file PDF in Java"
    content_left: |
...
demos:
    enable: true
    title: "Demo dal vivo per confrontare PDF file"
    content: |
        Confronta subito PDF file visitando il sito web [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
