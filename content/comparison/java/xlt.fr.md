...
############################# Head ############################
head_title: "API de comparaison Java XLT - Vérifiez les différences dans les fichiers XLT"
head_description: "Comparez et fusionnez XLT fichiers dans les applications Java, J2EE et J2SE. Analysez le résumé des différences en termes de contenu, de texte et de style."

############################# Header ############################
title: "Comparer XLT fichiers dans Java" 
description: "Effectuez une comparaison de contenu entre plus de deux XLT fichiers dans Java. Récupérez une liste des différences et enregistrez les fichiers comparés dans un seul document."
...
steps:
    enable: true
    title: "Comment comparer plusieurs documents XLT à l'aide de Java"
    content: |
      Utilisez [GroupDocs.Comparison](https://products.groupdocs.com/comparison/java/) pour comparer plusieurs XLT fichiers et générer un rapport détaillant leurs différences
      ...
      2. Créez une instance de la classe Comparer en définissant le chemin d'accès à l'un des XLT fichiers
      3. Ajoutez au moins un XLT supplémentaire à l'instance Comparer
