...
############################# Head ############################
head_title: "API de comparación de Java SCALA - Compara archivos de SCALA en busca de diferencias"
head_description: "Compare y combine archivos SCALA en aplicaciones Java, J2EE, J2SE. Analice el resumen de diferencias en contenido, texto y estilo de SCALA archivos, imágenes y formatos de documentos."

############################# Header ############################
title: "Compara archivos SCALA en Java"
description: "Realice una comparación línea por línea entre más de dos archivos SCALA en Java. Recupere una lista de diferencias y guarde los archivos comparados en un solo documento."
...
steps:
    enable: true
    title_left: "Pasos para comparar archivos SCALA en Java"
    content_left: |
        [GroupDocs.Comparison](/comparison/java/) facilita a los desarrolladores de Java comparar archivos SCALA dentro de sus aplicaciones utilizando unas pocas líneas de código.
    ...
    code: |
        ...
        try (Comparer comparer = new Comparer("C:\\source.scala")) {
            ...
            comparer.compare("C:\\result.scala"); // Crear archivo de resultados con el nombre especificado
        }
        ...
        try (Comparer comparer = new Comparer(new FileInputStream("C:\\source.scala"))) {
            ...
            comparer.compare(new FileOutputStream("C:\\result.scala")); // Crear archivo de resultados con el nombre especificado
        }
        ```
...
demos:
    enable: true
    title: "Demostraciones en vivo para comparar archivos SCALA"
    content: |
        Compare archivos SCALA ahora mismo visitando el sitio web [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
