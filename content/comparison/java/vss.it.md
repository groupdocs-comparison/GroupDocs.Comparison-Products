...
############################# Head ############################
head_title: "API di confronto Java VSS - Verifica la presenza di differenze tra i file VSS"
head_description: "Confronta e unisci i file VSS nelle applicazioni Java, J2EE, J2SE. Analizza il riepilogo delle differenze in termini di contenuto, testo e stile."

############################# Header ############################
title: "Confronta VSS file in Java" 
description: "Esegui il confronto dei contenuti tra più di due file VSS in Java. Recupera un elenco di differenze e salva i file confrontati in un unico documento."
...
steps:
    enable: true
    title: "Come confrontare diversi documenti VSS utilizzando Java"
    content: |
      Usa [GroupDocs.Comparison](https://products.groupdocs.com/comparison/java/) per confrontare più file VSS e generare un rapporto che descriva in dettaglio le loro differenze
      ...
      2. Crea un'istanza della classe Comparer impostando il percorso di uno dei file VSS
      3. Aggiungi almeno un altro VSS all'istanza di Comparer
