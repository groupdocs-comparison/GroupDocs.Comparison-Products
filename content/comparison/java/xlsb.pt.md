...
############################# Head ############################
head_title: "API de comparação Java XLSB - Compare arquivos XLSB em busca de diferenças"
head_description: "Compare e mescle arquivos XLSB em aplicativos Java, J2EE, J2SE. Analise o resumo das diferenças no conteúdo, texto e estilo de XLSB arquivos, imagens e formatos de documentos."

############################# Header ############################
title: "Compare arquivos XLSB em Java"
description: "Execute uma comparação linha por linha entre mais de dois arquivos XLSB em Java. Recupere uma lista de diferenças e salve os arquivos comparados em um único documento."
...
steps:
    enable: true
    title_left: "Etapas para comparar arquivos XLSB em Java"
    content_left: |
        [GroupDocs.Comparison](/comparison/java/) torna mais fácil para os desenvolvedores Java comparar arquivos XLSB em seus aplicativos usando algumas linhas de código.
    ...
    code: |
        ...
        try (Comparer comparer = new Comparer("C:\\source.xlsb")) {
            ...
            comparer.compare("C:\\result.xlsb"); // Crie um arquivo de resultado com o nome especificado
        }
        ...
        try (Comparer comparer = new Comparer(new FileInputStream("C:\\source.xlsb"))) {
            ...
            comparer.compare(new FileOutputStream("C:\\result.xlsb")); // Crie um arquivo de resultado com o nome especificado
        }
        ```
...
demos:
    enable: true
    title: "Demonstrações ao vivo para comparar arquivos XLSB"
    content: |
        Compare arquivos XLSB agora mesmo visitando o site [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
