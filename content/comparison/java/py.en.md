...
############################# Head ############################
head_title: "Java PY Comparison API - Check PY Files for Differences"
head_description: "Compare and merge PY files in Java, J2EE, J2SE applications. Analyze differences summary in content, text & style of PY files, images and document formats."

############################# Header ############################
title: "Compare PY Files in Java" 
description: "Perform content comparison between more than two PY files in Java. Retrieve a list of differences and save the compared files to a single document."
...
steps:
    enable: true
    title: "How to compare several PY documents using Java"
    content: |
      Use [GroupDocs.Comparison](https://products.groupdocs.com/comparison/java/) to compare multiple PY files and generate a report detailing their differences
      ...
      2. Create an instance of the Comparer class setting path to one of PY files
      3. Add at least one additional PY to the Comparer instance
