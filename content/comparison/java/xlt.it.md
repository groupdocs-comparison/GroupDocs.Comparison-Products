...
############################# Head ############################
head_title: "Java XLT API di confronto - Confronta XLT file per le differenze"
head_description: "Confronta e unisci XLT file in applicazioni Java, J2EE, J2SE. Analizza il riepilogo delle differenze nel contenuto, nel testo e nello stile di XLT file, immagini e formati di documenti."

############################# Header ############################
title: "Confronta XLT File in Java"
description: "Esegui un confronto riga per riga tra più di due file XLT in Java. Recupera un elenco di differenze e salva i file confrontati in un unico documento."
...
steps:
    enable: true
    title_left: "Passi per confrontare i file XLT in Java"
    content_left: |
...
demos:
    enable: true
    title: "Demo dal vivo per confrontare XLT file"
    content: |
        Confronta subito XLT file visitando il sito web [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
