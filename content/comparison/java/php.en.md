...
############################# Head ############################
head_title: "Java PHP Comparison API - Check PHP Files for Differences"
head_description: "Compare and merge PHP files in Java, J2EE, J2SE applications. Analyze differences summary in content, text & style of PHP files, images and document formats."

############################# Header ############################
title: "Compare PHP Files in Java" 
description: "Perform content comparison between more than two PHP files in Java. Retrieve a list of differences and save the compared files to a single document."
...
steps:
    enable: true
    title: "How to compare several PHP documents using Java"
    content: |
      Use [GroupDocs.Comparison](https://products.groupdocs.com/comparison/java/) to compare multiple PHP files and generate a report detailing their differences
      ...
      2. Create an instance of the Comparer class setting path to one of PHP files
      3. Add at least one additional PHP to the Comparer instance
