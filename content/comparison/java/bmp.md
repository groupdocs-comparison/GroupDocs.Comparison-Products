...
############################# Head ############################
head_title: "Java BMP Comparison API - Compare BMP Files for Differences"
head_description: "Compare and merge BMP files in Java, J2EE, J2SE applications. Analyse differences summary in content, text &amp; style of BMP files, images and document formats."

############################# Header ############################
title: "Compare BMP Files in Java"
description: "Perform a line-by-line comparison between more than two BMP files in Java. Retrieve a list of differences and save the compared files to a single document."
...
steps:
    enable: true
    title_left: "Steps for Comparing BMP Files in Java"
    content_left: |
        [GroupDocs.Comparison](/comparison/java/) makes it easy for Java developers to compare BMP files within their applications using a few lines of code.
    ...
    code: |
        ...
        try (Comparer comparer = new Comparer("C:\\source.bmp")) {
            ...
            comparer.compare("C:\\result.bmp"); // Create result file with the specified name
        }
        ...
        try (Comparer comparer = new Comparer(new FileInputStream("C:\\source.bmp"))) {
            ...
            comparer.compare(new FileOutputStream("C:\\result.bmp")); // Create result file with the specified name
        }
        ```
...
demos:
    enable: true
    title: "Live Demos to Compare BMP Files"
    content: |
        Compare BMP files right now by visiting [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family) website.  
