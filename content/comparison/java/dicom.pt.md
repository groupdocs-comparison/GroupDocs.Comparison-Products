...
############################# Head ############################
head_title: "Java DICOM API de comparação - Verifique se há diferenças nos arquivos DICOM"
head_description: "Compare e mescle DICOM arquivos em aplicativos Java, J2EE e J2SE. Analise o resumo das diferenças em conteúdo, texto e estilo."

############################# Header ############################
title: "Compare arquivos DICOM em Java" 
description: "Faça uma comparação de conteúdo entre mais de dois DICOM arquivos em Java. Recupere uma lista de diferenças e salve os arquivos comparados em um único documento."
...
steps:
    enable: true
    title: "Como comparar vários documentos DICOM usando Java"
    content: |
      Use [GroupDocs.Comparison](https://products.groupdocs.com/comparison/java/) para comparar vários DICOM arquivos e gerar um relatório detalhando suas diferenças
      ...
      2. Crie uma instância do caminho de configuração da classe Comparer para um dos DICOM arquivos
      3. Adicione pelo menos um DICOM adicional à instância do Comparer
