...
############################# Head ############################
head_title: "API de comparação Java DICOM - Compare arquivos DICOM em busca de diferenças"
head_description: "Compare e mescle arquivos DICOM em aplicativos Java, J2EE, J2SE. Analise o resumo das diferenças no conteúdo, texto e estilo de DICOM arquivos, imagens e formatos de documentos."

############################# Header ############################
title: "Compare arquivos DICOM em Java"
description: "Execute uma comparação linha por linha entre mais de dois arquivos DICOM em Java. Recupere uma lista de diferenças e salve os arquivos comparados em um único documento."
...
steps:
    enable: true
    title_left: "Etapas para comparar arquivos DICOM em Java"
    content_left: |
        [GroupDocs.Comparison](/comparison/java/) torna mais fácil para os desenvolvedores Java comparar arquivos DICOM em seus aplicativos usando algumas linhas de código.
    ...
    code: |
        ...
        try (Comparer comparer = new Comparer("C:\\source.dicom")) {
            ...
            comparer.compare("C:\\result.dicom"); // Crie um arquivo de resultado com o nome especificado
        }
        ...
        try (Comparer comparer = new Comparer(new FileInputStream("C:\\source.dicom"))) {
            ...
            comparer.compare(new FileOutputStream("C:\\result.dicom")); // Crie um arquivo de resultado com o nome especificado
        }
        ```
...
demos:
    enable: true
    title: "Demonstrações ao vivo para comparar arquivos DICOM"
    content: |
        Compare arquivos DICOM agora mesmo visitando o site [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-dicom"
          ...
          content: |
            DICOM é a sigla para Digital Imaging and Communications in Medicine e pertence à área de Informática Médica. DICOM é a combinação de definição de formato de arquivo e um protocolo de comunicação de rede. DICOM usa a extensão .DCM. .DCM existe em dois formatos diferentes, ou seja, formato 1.xe formato 2.x. O formato DCM 1.x está disponível em duas versões normal e estendida. DICOM é usado para a integração de dispositivos de imagens médicas, como impressoras, servidores, scanners, etc., de vários fornecedores e também contém dados de identificação de cada paciente para exclusividade. Os arquivos DICOM podem ser compartilhados entre duas partes se forem capazes de receber dados de imagem no formato DICOM. A parte de comunicação do DICOM é o protocolo da camada de aplicação e usa TCP/IP para comunicação entre entidades. Os protocolos HTTP e HTTPS são usados ​​para os serviços web do DICOM. As versões suportadas pelos serviços web são 1.0, 1.1, 2 ou posteriores.
...
solutions:
    ...
    solution:
        # solution loop
        - img_alt: "GroupDocs.Comparison for .NET DICOM"
          image: "https://www.groupdocs.cloud/templates/groupdocs/images/product-logos/groupdocs-comparison-net.png"
          product: "GroupDocs.Comparison"
          platform: ".NET"
          link: "/comparison/net/dicom/"
