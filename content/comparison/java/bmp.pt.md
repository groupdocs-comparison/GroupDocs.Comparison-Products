...
############################# Head ############################
head_title: "API de comparação Java BMP - compare arquivos BMP para diferenças"
...
############################# Header ############################
title: "Comparar arquivos BMP em Java"
...
steps:
    ...
    code: |
        ...
        try (Comparer comparer = new Comparer("C:\\source.bmp")) {
            ...
            comparer.compare("C:\\result.bmp"); // Cria arquivo de resultado com o nome especificado
        }
        ...
        try (Comparer comparer = new Comparer(new FileInputStream("C:\\source.bmp"))) {
            ...
            comparer.compare(new FileOutputStream("C:\\result.bmp")); // Cria arquivo de resultado com o nome especificado
        }
        ```
...
demos:
    ...
    content: |
        Compare os arquivos BMP agora mesmo visitando o site [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
