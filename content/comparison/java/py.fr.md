...
############################# Head ############################
head_title: "Java API de comparaison PY - Comparez les fichiers PY pour les différences"
head_description: "Comparez et fusionnez les fichiers PY dans les applications Java, J2EE, J2SE. Analysez le résumé des différences dans le contenu, le texte et le style des fichiers, images et formats de document PY."

############################# Header ############################
title: "Comparez les fichiers PY dans Java"
...
steps:
    ...
    code: |
        ...
        try (Comparer comparer = new Comparer("C:\\source.py")) {
            ...
            comparer.compare("C:\\result.py"); // Crée un fichier résultat avec le nom spécifié
        }
        ...
        try (Comparer comparer = new Comparer(new FileInputStream("C:\\source.py"))) {
            ...
            comparer.compare(new FileOutputStream("C:\\result.py")); // Crée un fichier résultat avec le nom spécifié
        }
        ```
...
demos:
    ...
    content: |
        Comparez les fichiers PY dès maintenant en visitant le site Web [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
