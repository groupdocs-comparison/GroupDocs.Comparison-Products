...
############################# Head ############################
head_title: "Java TXT API для сравнения документов и файлов"
head_description: "Сравнение TXT файлов в приложениях Java, J2EE, J2SE. Проанализируйте сводку различий в содержании, тексте и стиле."

############################# Header ############################
title: "Сравнение TXT файлов в Java" 
description: "Сравнивайте содержимое TXT файлов в Java. Работайте со списком различий и сохраняйте сравниваемые файлы в одном документе."
