...
############################# Head ############################
head_title: "GroupDocs.Comparison for Java para la comparación XLSX."
head_description: "La API GroupDocs.Comparison ofrece la recuperación de informes que detallan las variaciones en XLSX documentos. Compatible con los entornos Java, J2EE y J2SE."

############################# Header ############################
title: "Java aplicaciones para detectar cambios en XLSX hojas de cálculo" 
description: "La API GroupDocs.Comparison Java permite la comparación de XLSX hojas de cálculo en aplicaciones Java, J2EE o J2SE."
...
about:
    ...
    content: |
       La API GroupDocs.Comparison for Java facilita la comparación de XLSX hojas de cálculo y genera informes sobre las diferencias encontradas en el texto, los párrafos, las formas, los estilos y otros elementos. Además, admite la fusión de modificaciones de varios archivos originales sin necesidad de bibliotecas externas. Mejore sus Java proyectos con una integración de código mínima.

############################# Steps ############################
steps:
    enable: true
    title: "Usa Java para comparar varios XLSX archivos"
    content: |
      Usa [GroupDocs.Comparison](https://products.groupdocs.com/comparison/java/) para analizar MS Excel hojas de cálculo
      
      1. Instale el paquete desde [Maven](https://releases.groupdocs.com/java/repo/com/groupdocs/groupdocs-comparison/)
      2. Instancie el comparador con la primera hoja de cálculo XLSX como parámetro
      3. Incluya XLSX hojas de cálculo adicionales para comparar
      4. Disfrute de un informe completo
...
more_formats:
    enable: true
    title: "Gestiona los cambios en XLSX hojas de cálculo con Java"
    exclude: "XLSX"
    description: "La biblioteca GroupDocs.Comparison Java permite a los usuarios supervisar diferentes versiones de XLSX hojas de cálculo mediante informes detallados y precisos que se redactan fácilmente."
    items: 
        # format loop 1
