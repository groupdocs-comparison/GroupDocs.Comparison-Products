...
############################# Head ############################
head_title: "Java SCALA Comparison API - Check SCALA Files for Differences"
head_description: "Compare and merge SCALA files in Java, J2EE, J2SE applications. Analyze differences summary in content, text & style of SCALA files, images and document formats."

############################# Header ############################
title: "Compare SCALA Files in Java" 
description: "Perform content comparison between more than two SCALA files in Java. Retrieve a list of differences and save the compared files to a single document."
...
steps:
    enable: true
    title: "How to compare several SCALA documents using Java"
    content: |
      Use [GroupDocs.Comparison](https://products.groupdocs.com/comparison/java/) to compare multiple SCALA files and generate a report detailing their differences
      ...
      2. Create an instance of the Comparer class setting path to one of SCALA files
      3. Add at least one additional SCALA to the Comparer instance
