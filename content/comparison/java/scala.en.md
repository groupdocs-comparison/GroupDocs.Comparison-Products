...
############################# Head ############################
head_title: "Java SCALA Comparison API - Compare SCALA Files for Differences"
...
steps:
    ...
    content_left: |
        [GroupDocs.Comparison](/comparison/java/) makes it easy for Java developers to compare SCALA files within their applications using a few lines of code.
