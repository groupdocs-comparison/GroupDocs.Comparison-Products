...
############################# Head ############################
head_title: "Java API de comparaison PPS - Comparez les fichiers PPS pour les différences"
head_description: "Comparez et fusionnez les fichiers PPS dans les applications Java, J2EE, J2SE. Analysez le résumé des différences dans le contenu, le texte et le style des fichiers, images et formats de document PPS."

############################# Header ############################
title: "Comparez les fichiers PPS dans Java"
...
steps:
    ...
    code: |
        ...
        try (Comparer comparer = new Comparer("C:\\source.pps")) {
            ...
            comparer.compare("C:\\result.pps"); // Crée un fichier résultat avec le nom spécifié
        }
        ...
        try (Comparer comparer = new Comparer(new FileInputStream("C:\\source.pps"))) {
            ...
            comparer.compare(new FileOutputStream("C:\\result.pps")); // Crée un fichier résultat avec le nom spécifié
        }
        ```
...
demos:
    ...
    content: |
        Comparez les fichiers PPS dès maintenant en visitant le site Web [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
