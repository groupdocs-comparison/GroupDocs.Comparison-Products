...
############################# Head ############################
head_title: "Java VSD Comparison API - Compare VSD Files for Differences"
head_description: "Compare and merge VSD files in Java, J2EE, J2SE applications. Analyse differences summary in content, text & style of VSD files, images and document formats."

############################# Header ############################
title: "Compare VSD Files in Java"
description: "Perform a line-by-line comparison between more than two VSD files in Java. Retrieve a list of differences and save the compared files to a single document."
...
steps:
    enable: true
    title_left: "Steps for Comparing VSD Files in Java"
    content_left: |
        [GroupDocs.Comparison](/comparison/java/) makes it easy for Java developers to compare VSD files within their applications using a few lines of code.
    ...
    code: |
        ...
        try (Comparer comparer = new Comparer("C:\\source.vsd")) {
            ...
            comparer.compare("C:\\result.vsd"); // Create result file with the specified name
        }
        ...
        try (Comparer comparer = new Comparer(new FileInputStream("C:\\source.vsd"))) {
            ...
            comparer.compare(new FileOutputStream("C:\\result.vsd")); // Create result file with the specified name
        }
        ```
...
demos:
    enable: true
    title: "Live Demos to Compare VSD Files"
    content: |
        Compare VSD files right now by visiting [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family) website.  
