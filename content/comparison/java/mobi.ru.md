...
############################# Head ############################
head_title: "API сравнения MOBI Java – сравнение файлов MOBI на наличие различий"
head_description: "Сравнивайте и объединяйте файлы MOBI в приложениях Java, J2EE, J2SE. Анализируйте сводную информацию о различиях в содержании, тексте и стиле MOBI файлов, изображений и форматов документов."

############################# Header ############################
title: "Сравнить файлы MOBI в Java"
description: "Выполните построчное сравнение между более чем двумя файлами MOBI в Java. Получите список различий и сохраните сравниваемые файлы в один документ."
...
steps:
    enable: true
    title_left: "Шаги для сравнения файлов MOBI в Java"
    content_left: |
        [GroupDocs.Comparison](/comparison/java/) позволяет разработчикам Java легко сравнивать файлы MOBI в своих приложениях, используя несколько строк кода.
    ...
    code: |
        ...
        try (Comparer comparer = new Comparer("C:\\source.mobi")) {
            ...
            comparer.compare("C:\\result.mobi"); // Создать файл результатов с указанным именем
        }
        ...
        try (Comparer comparer = new Comparer(new FileInputStream("C:\\source.mobi"))) {
            ...
            comparer.compare(new FileOutputStream("C:\\result.mobi")); // Создать файл результатов с указанным именем
        }
        ```
...
demos:
    enable: true
    title: "Живые демонстрации для сравнения файлов MOBI"
    content: |
        Сравните файлы MOBI прямо сейчас, посетив веб-сайт [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
