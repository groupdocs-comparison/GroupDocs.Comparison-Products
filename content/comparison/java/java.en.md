...
############################# Head ############################
head_title: "Java JAVA Comparison API - Check JAVA Files for Differences"
head_description: "Compare and merge JAVA files in Java, J2EE, J2SE applications. Analyze differences summary in content, text & style of JAVA files, images and document formats."

############################# Header ############################
title: "Compare JAVA Files in Java" 
description: "Perform content comparison between more than two JAVA files in Java. Retrieve a list of differences and save the compared files to a single document."
...
steps:
    enable: true
    title: "How to compare several JAVA documents using Java"
    content: |
      Use [GroupDocs.Comparison](https://products.groupdocs.com/comparison/java/) to compare multiple JAVA files and generate a report detailing their differences
      ...
      2. Create an instance of the Comparer class setting path to one of JAVA files
      3. Add at least one additional JAVA to the Comparer instance
