...
############################# Head ############################
head_title: "API di confronto Java DXF - Verifica la presenza di differenze tra i file DXF"
head_description: "Confronta e unisci i file DXF nelle applicazioni Java, J2EE, J2SE. Analizza il riepilogo delle differenze in termini di contenuto, testo e stile."

############################# Header ############################
title: "Confronta DXF file in Java" 
description: "Esegui il confronto dei contenuti tra più di due file DXF in Java. Recupera un elenco di differenze e salva i file confrontati in un unico documento."
...
steps:
    enable: true
    title: "Come confrontare diversi documenti DXF utilizzando Java"
    content: |
      Usa [GroupDocs.Comparison](https://products.groupdocs.com/comparison/java/) per confrontare più file DXF e generare un rapporto che descriva in dettaglio le loro differenze
      ...
      2. Crea un'istanza della classe Comparer impostando il percorso di uno dei file DXF
      3. Aggiungi almeno un altro DXF all'istanza di Comparer
