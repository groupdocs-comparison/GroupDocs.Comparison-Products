...
############################# Head ############################
head_title: "API di confronto Java DXF: confronta i file DXF per le differenze"
head_description: "Confronta e unisci file DXF nelle applicazioni Java, J2EE, J2SE. Analizza il riepilogo delle differenze nel contenuto, nel testo e nello stile di file, immagini e formati di documenti DXF."

############################# Header ############################
title: "Confronta i file DXF in Java"
description: "Esegui un confronto riga per riga tra più di due file DXF in Java. Recupera un elenco di differenze e salva i file confrontati in un singolo documento."
...
steps:
    enable: true
    title_left: "Passaggi per confrontare i file DXF in Java"
    content_left: |
        [GroupDocs.Comparison](/comparison/java/) consente agli sviluppatori Java di confrontare facilmente i file DXF all'interno delle loro applicazioni utilizzando poche righe di codice.
    ...
    code: |
        ...
        try (Comparer comparer = new Comparer("C:\\source.dxf")) {
            ...
            comparer.compare("C:\\result.dxf"); // Crea il file dei risultati con il nome specificato
        }
        ...
        try (Comparer comparer = new Comparer(new FileInputStream("C:\\source.dxf"))) {
            ...
            comparer.compare(new FileOutputStream("C:\\result.dxf")); // Crea il file dei risultati con il nome specificato
        }
        ```
...
demos:
    enable: true
    title: "Demo dal vivo per confrontare file DXF"
    content: |
        Confronta subito i file DXF visitando il sito web [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
