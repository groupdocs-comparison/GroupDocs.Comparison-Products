...
############################# Head ############################
head_title: "Java PHP API Perbandingan - Periksa PHP File untuk Perbedaan"
head_description: "Bandingkan dan gabungkan PHP file dalam aplikasi Java, J2EE, J2SE. Analisis ringkasan perbedaan dalam konten, teks & gaya."

############################# Header ############################
title: "Bandingkan PHP File di Java" 
description: "Lakukan perbandingan konten antara lebih dari dua PHP file di Java. Ambil daftar perbedaan dan simpan file yang dibandingkan ke satu dokumen."
...
steps:
    enable: true
    title: "Cara membandingkan beberapa dokumen PHP menggunakan Java"
    content: |
      Gunakan [GroupDocs.Comparison](https://products.groupdocs.com/comparison/java/) untuk membandingkan beberapa file PHP dan menghasilkan laporan yang merinci perbedaannya
      ...
      2. Buat instance jalur pengaturan kelas Comparer ke salah satu dari PHP file
      3. Tambahkan setidaknya satu PHP tambahan ke instance Comparer
