...
############################# Head ############################
head_title: "Java POT API Perbandingan - Periksa POT File untuk Perbedaan"
head_description: "Bandingkan dan gabungkan POT file dalam aplikasi Java, J2EE, J2SE. Analisis ringkasan perbedaan dalam konten, teks & gaya."

############################# Header ############################
title: "Bandingkan POT File di Java" 
description: "Lakukan perbandingan konten antara lebih dari dua POT file di Java. Ambil daftar perbedaan dan simpan file yang dibandingkan ke satu dokumen."
...
steps:
    enable: true
    title: "Cara membandingkan beberapa dokumen POT menggunakan Java"
    content: |
      Gunakan [GroupDocs.Comparison](https://products.groupdocs.com/comparison/java/) untuk membandingkan beberapa file POT dan menghasilkan laporan yang merinci perbedaannya
      ...
      2. Buat instance jalur pengaturan kelas Comparer ke salah satu dari POT file
      3. Tambahkan setidaknya satu POT tambahan ke instance Comparer
