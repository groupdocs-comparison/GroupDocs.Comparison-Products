...
############################# Head ############################
head_title: "JavaDOCX比較API-DOCXファイルの違いを比較する"
...
steps:
    enable: true
    title_left: "JavaでDOCXファイルを比較する手順"
    content_left: |
        [GroupDocs.Comparison](/ja/comparison/java/)を使用すると、Java開発者は数行のコードを使用してアプリケーション内のDOCXファイルを簡単に比較できます。
