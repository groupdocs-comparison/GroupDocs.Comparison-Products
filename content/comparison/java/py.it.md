...
############################# Head ############################
head_title: "API di confronto Java PY: confronta i file PY per le differenze"
head_description: "Confronta e unisci file PY nelle applicazioni Java, J2EE, J2SE. Analizza il riepilogo delle differenze nel contenuto, nel testo e nello stile di file, immagini e formati di documenti PY."

############################# Header ############################
title: "Confronta i file PY in Java"
description: "Esegui un confronto riga per riga tra più di due file PY in Java. Recupera un elenco di differenze e salva i file confrontati in un singolo documento."
...
steps:
    enable: true
    title_left: "Passaggi per confrontare i file PY in Java"
    content_left: |
...
demos:
    enable: true
    title: "Demo dal vivo per confrontare file PY"
    content: |
        Confronta subito i file PY visitando il sito web [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
