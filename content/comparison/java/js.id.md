...
############################# Head ############################
head_title: "Java JS API Perbandingan - Periksa JS File untuk Perbedaan"
head_description: "Bandingkan dan gabungkan JS file dalam aplikasi Java, J2EE, J2SE. Analisis ringkasan perbedaan dalam konten, teks & gaya."

############################# Header ############################
title: "Bandingkan JS File di Java" 
description: "Lakukan perbandingan konten antara lebih dari dua JS file di Java. Ambil daftar perbedaan dan simpan file yang dibandingkan ke satu dokumen."
...
steps:
    enable: true
    title: "Cara membandingkan beberapa dokumen JS menggunakan Java"
    content: |
      Gunakan [GroupDocs.Comparison](https://products.groupdocs.com/comparison/java/) untuk membandingkan beberapa file JS dan menghasilkan laporan yang merinci perbedaannya
      ...
      2. Buat instance jalur pengaturan kelas Comparer ke salah satu dari JS file
      3. Tambahkan setidaknya satu JS tambahan ke instance Comparer
