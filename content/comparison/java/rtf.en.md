...
############################# Head ############################
head_title: "Java RTF Comparison API - Check RTF Files for Differences"
head_description: "Compare and merge RTF files in Java, J2EE, J2SE applications. Analyze differences summary in content, text & style of RTF files, images and document formats."

############################# Header ############################
title: "Compare RTF Files in Java" 
description: "Perform content comparison between more than two RTF files in Java. Retrieve a list of differences and save the compared files to a single document."
...
steps:
    ...
    content: |
      Use [GroupDocs.Comparison](https://products.groupdocs.com/comparison/java/) to compare multiple RTF files and generate a report detailing their differences
