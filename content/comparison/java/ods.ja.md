...
############################# Head ############################
head_title: "JavaODS比較API-ODSファイルの違いを比較する"
...
steps:
    enable: true
    title_left: "JavaでODSファイルを比較する手順"
    content_left: |
        [GroupDocs.Comparison](/ja/comparison/java/)を使用すると、Java開発者は数行のコードを使用してアプリケーション内のODSファイルを簡単に比較できます。
