...
############################# Head ############################
head_title: "Java LESS API Perbandingan - Periksa LESS File untuk Perbedaan"
head_description: "Bandingkan dan gabungkan LESS file dalam aplikasi Java, J2EE, J2SE. Analisis ringkasan perbedaan dalam konten, teks & gaya."

############################# Header ############################
title: "Bandingkan LESS File di Java" 
description: "Lakukan perbandingan konten antara lebih dari dua LESS file di Java. Ambil daftar perbedaan dan simpan file yang dibandingkan ke satu dokumen."
...
steps:
    enable: true
    title: "Cara membandingkan beberapa dokumen LESS menggunakan Java"
    content: |
      Gunakan [GroupDocs.Comparison](https://products.groupdocs.com/comparison/java/) untuk membandingkan beberapa file LESS dan menghasilkan laporan yang merinci perbedaannya
      ...
      2. Buat instance jalur pengaturan kelas Comparer ke salah satu dari LESS file
      3. Tambahkan setidaknya satu LESS tambahan ke instance Comparer
