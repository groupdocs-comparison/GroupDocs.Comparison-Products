...
############################# Head ############################
head_title: "API de comparaison Java JSON - Vérifiez les différences dans les fichiers JSON"
head_description: "Comparez et fusionnez JSON fichiers dans les applications Java, J2EE et J2SE. Analysez le résumé des différences en termes de contenu, de texte et de style."

############################# Header ############################
title: "Comparer JSON fichiers dans Java" 
description: "Effectuez une comparaison de contenu entre plus de deux JSON fichiers dans Java. Récupérez une liste des différences et enregistrez les fichiers comparés dans un seul document."
...
steps:
    enable: true
    title: "Comment comparer plusieurs documents JSON à l'aide de Java"
    content: |
      Utilisez [GroupDocs.Comparison](https://products.groupdocs.com/comparison/java/) pour comparer plusieurs JSON fichiers et générer un rapport détaillant leurs différences
      ...
      2. Créez une instance de la classe Comparer en définissant le chemin d'accès à l'un des JSON fichiers
      3. Ajoutez au moins un JSON supplémentaire à l'instance Comparer
