...
############################# Head ############################
head_title: "Java ODS Comparison API - Check ODS Files for Differences"
head_description: "Compare and merge ODS files in Java, J2EE, J2SE applications. Analyze differences summary in content, text & style of ODS files, images and document formats."

############################# Header ############################
title: "Compare ODS Files in Java" 
description: "Perform content comparison between more than two ODS files in Java. Retrieve a list of differences and save the compared files to a single document."
...
steps:
    enable: true
    title: "How to compare several ODS documents using Java"
    content: |
      Use [GroupDocs.Comparison](https://products.groupdocs.com/comparison/java/) to compare multiple ODS files and generate a report detailing their differences
      ...
      2. Create an instance of the Comparer class setting path to one of ODS files
      3. Add at least one additional ODS to the Comparer instance
