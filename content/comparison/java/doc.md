...
############################# Head ############################
head_title: "Java DOC Comparison API - Compare DOC Files for Differences"
head_description: "Compare and merge DOC files in Java, J2EE, J2SE applications. Analyse differences summary in content, text &amp; style of DOC files, images and document formats."

############################# Header ############################
title: "Compare DOC Files in Java"
description: "Perform a line-by-line comparison between more than two DOC files in Java. Retrieve a list of differences and save the compared files to a single document."
...
steps:
    enable: true
    title_left: "Steps for Comparing DOC Files in Java"
    content_left: |
        [GroupDocs.Comparison](/comparison/java/) makes it easy for Java developers to compare DOC files within their applications using a few lines of code.
    ...
    code: |
        ...
        try (Comparer comparer = new Comparer("C:\\source.doc")) {
            ...
            comparer.compare("C:\\result.doc"); // Create result file with the specified name
        }
        ...
        try (Comparer comparer = new Comparer(new FileInputStream("C:\\source.doc"))) {
            ...
            comparer.compare(new FileOutputStream("C:\\result.doc")); // Create result file with the specified name
        }
        ```
...
demos:
    enable: true
    title: "Live Demos to Compare DOC Files"
    content: |
        Compare DOC files right now by visiting [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family) website.  
