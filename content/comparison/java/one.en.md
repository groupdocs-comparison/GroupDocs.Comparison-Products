...
############################# Head ############################
head_title: "Java ONE Comparison API - Check ONE Files for Differences"
head_description: "Compare and merge ONE files in Java, J2EE, J2SE applications. Analyze differences summary in content, text & style of ONE files, images and document formats."

############################# Header ############################
title: "Compare ONE Files in Java" 
description: "Perform content comparison between more than two ONE files in Java. Retrieve a list of differences and save the compared files to a single document."
...
steps:
    enable: true
    title: "How to compare several ONE documents using Java"
    content: |
      Use [GroupDocs.Comparison](https://products.groupdocs.com/comparison/java/) to compare multiple ONE files and generate a report detailing their differences
      ...
      2. Create an instance of the Comparer class setting path to one of ONE files
      3. Add at least one additional ONE to the Comparer instance
