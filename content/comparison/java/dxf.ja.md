...
############################# Head ############################
head_title: "JavaDXF比較API-DXFファイルの違いを比較する"
...
steps:
    enable: true
    title_left: "JavaでDXFファイルを比較する手順"
    content_left: |
        [GroupDocs.Comparison](/ja/comparison/java/)を使用すると、Java開発者は数行のコードを使用してアプリケーション内のDXFファイルを簡単に比較できます。
