...
############################# Head ############################
head_title: "Java XLS API di confronto - Confronta XLS file per le differenze"
head_description: "Confronta e unisci XLS file in applicazioni Java, J2EE, J2SE. Analizza il riepilogo delle differenze nel contenuto, nel testo e nello stile di XLS file, immagini e formati di documenti."

############################# Header ############################
title: "Confronta XLS File in Java"
description: "Esegui un confronto riga per riga tra più di due file XLS in Java. Recupera un elenco di differenze e salva i file confrontati in un unico documento."
...
steps:
    enable: true
    title_left: "Passi per confrontare i file XLS in Java"
    content_left: |
...
demos:
    enable: true
    title: "Demo dal vivo per confrontare XLS file"
    content: |
        Confronta subito XLS file visitando il sito web [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
