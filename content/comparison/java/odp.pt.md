...
############################# Head ############################
head_title: "API de comparação Java ODP - Compare arquivos ODP em busca de diferenças"
head_description: "Compare e mescle arquivos ODP em aplicativos Java, J2EE, J2SE. Analise o resumo das diferenças no conteúdo, texto e estilo de ODP arquivos, imagens e formatos de documentos."

############################# Header ############################
title: "Compare arquivos ODP em Java"
description: "Execute uma comparação linha por linha entre mais de dois arquivos ODP em Java. Recupere uma lista de diferenças e salve os arquivos comparados em um único documento."
...
steps:
    enable: true
    title_left: "Etapas para comparar arquivos ODP em Java"
    content_left: |
        [GroupDocs.Comparison](/comparison/java/) torna mais fácil para os desenvolvedores Java comparar arquivos ODP em seus aplicativos usando algumas linhas de código.
    ...
    code: |
        ...
        try (Comparer comparer = new Comparer("C:\\source.odp")) {
            ...
            comparer.compare("C:\\result.odp"); // Crie um arquivo de resultado com o nome especificado
        }
        ...
        try (Comparer comparer = new Comparer(new FileInputStream("C:\\source.odp"))) {
            ...
            comparer.compare(new FileOutputStream("C:\\result.odp")); // Crie um arquivo de resultado com o nome especificado
        }
        ```
...
demos:
    enable: true
    title: "Demonstrações ao vivo para comparar arquivos ODP"
    content: |
        Compare arquivos ODP agora mesmo visitando o site [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
