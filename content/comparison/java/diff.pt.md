...
############################# Head ############################
head_title: "API de comparação Java DIFF - Compare arquivos DIFF em busca de diferenças"
head_description: "Compare e mescle arquivos DIFF em aplicativos Java, J2EE, J2SE. Analise o resumo das diferenças no conteúdo, texto e estilo de DIFF arquivos, imagens e formatos de documentos."

############################# Header ############################
title: "Compare arquivos DIFF em Java"
description: "Execute uma comparação linha por linha entre mais de dois arquivos DIFF em Java. Recupere uma lista de diferenças e salve os arquivos comparados em um único documento."
...
steps:
    enable: true
    title_left: "Etapas para comparar arquivos DIFF em Java"
    content_left: |
        [GroupDocs.Comparison](/comparison/java/) torna mais fácil para os desenvolvedores Java comparar arquivos DIFF em seus aplicativos usando algumas linhas de código.
    ...
    code: |
        ...
        try (Comparer comparer = new Comparer("C:\\source.diff")) {
            ...
            comparer.compare("C:\\result.diff"); // Crie um arquivo de resultado com o nome especificado
        }
        ...
        try (Comparer comparer = new Comparer(new FileInputStream("C:\\source.diff"))) {
            ...
            comparer.compare(new FileOutputStream("C:\\result.diff")); // Crie um arquivo de resultado com o nome especificado
        }
        ```
...
demos:
    enable: true
    title: "Demonstrações ao vivo para comparar arquivos DIFF"
    content: |
        Compare arquivos DIFF agora mesmo visitando o site [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
