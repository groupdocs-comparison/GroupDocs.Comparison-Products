...
############################# Head ############################
head_title: "C# Java Node.js Python ドキュメント比較ライブラリ |差分チェッカー"
...
code_samples:
  ...
  items:
    ...
    - title: "2 つのファイルの比較"
      content: |
       2 つの文書を比較するには、まずソースファイルとターゲットファイルの両方を読み込み、次に `compare` メソッドを適用します。特定の比較設定を柔軟に選択して、よりカスタマイズされた分析を行うことができます。
      samples:
        - language: "C#"
          color: "blue"
          content: |
