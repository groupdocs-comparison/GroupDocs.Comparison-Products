...
############################# Head ############################
head_title: "Bandingkan dua file CPP di .NET | API Perbandingan Dokumen"
head_description: "Bandingkan dan gabungkan lebih dari dua file CPP dalam aplikasi C# .NET. Ambil ringkasan perbedaan dalam konten, teks & gaya file CPP, gambar dan format dokumen."

############################# Header ############################
title: "Bandingkan File CPP di C# .NET"
description: "API perbandingan dokumen .NET untuk mendeteksi perubahan antara dua versi file CPP dan mengekspor ke dokumen akhir dengan ringkasan mendetail tentang perbedaan antara dokumen yang dibandingkan."
...
steps:
    enable: true
    title_left: "Langkah-langkah Membandingkan File CPP di C#"
    content_left: |
        [GroupDocs.Comparison](/comparison/net/) memudahkan pengembang .NET untuk membandingkan & menggabungkan beberapa file CPP dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
    ...
    code: |
        ...
        using (Comparer comparer = new Comparer("source.cpp"))
        {
            ...
            comparer.Compare("result.cpp"); // Buat file hasil dengan nama yang ditentukan
        }
        ...
        using (Comparer comparer = new Comparer(File.OpenRead("source.cpp")))
        {
            ...
            comparer.Compare(File.Create("result.cpp")); // Buat file hasil dengan nama yang ditentukan
        }
        ```
...
demos:
    enable: true
    title: "Demo Langsung Membandingkan File CPP"
    content: |
        Deteksi perbedaan antara file CPP sekarang dengan mengunjungi situs web [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-cpp"
          title: "Tentang Format File CPP"
          content: |
            File dengan ekstensi file CPP adalah file kode sumber untuk aplikasi yang ditulis dalam bahasa pemrograman C++. Satu proyek C++ mungkin berisi lebih dari satu file CPP sebagai kode sumber aplikasi. Proyek semacam itu terdiri dari berbagai jenis file, yang mana file CPP dikenal sebagai file implementasi karena berisi semua definisi metode yang dideklarasikan dalam file header (.h). Proyek C++ secara keseluruhan menghasilkan aplikasi yang dapat dieksekusi ketika dikompilasi secara keseluruhan.
