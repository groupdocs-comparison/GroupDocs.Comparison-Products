...
############################# Head ############################
head_title: "Comparez deux fichiers MSG dans .NET | API de comparaison de documents"
head_description: "Comparez et fusionnez plus de deux fichiers MSG dans des applications C# .NET. Récupérez le résumé des différences dans le contenu, le texte et le style des fichiers, images et formats de documents MSG."

############################# Header ############################
title: "Comparez les fichiers MSG en C# .NET"
description: "API de comparaison de documents .NET pour détecter les modifications entre deux versions de fichiers MSG et exporter vers un document final avec un résumé détaillé des différences entre les documents comparés."
...
steps:
    enable: true
    title_left: "Étapes pour comparer les fichiers MSG en C#"
    content_left: |
        [GroupDocs.Comparison](/comparison/net/) permet aux développeurs .NET de comparer et de fusionner facilement plusieurs fichiers MSG dans leurs applications en implémentant quelques étapes simples.
    ...
    code: |
        ...
        using (Comparer comparer = new Comparer("source.msg"))
        {
            ...
            comparer.Compare("result.msg"); // Créer un fichier de résultats avec le nom spécifié
        }
        ...
        using (Comparer comparer = new Comparer(File.OpenRead("source.msg")))
        {
            ...
            comparer.Compare(File.Create("result.msg")); // Créer un fichier de résultats avec le nom spécifié
        }
        ```
...
demos:
    enable: true
    title: "Démonstrations en direct de comparaison de fichiers MSG"
    content: |
        Détectez dès maintenant les différences entre les fichiers MSG en visitant le site Web [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-msg"
          ...
          content: |
            MSG est un format de fichier utilisé par Microsoft Outlook et Exchange pour stocker des messages électroniques, des contacts, des rendez-vous ou d'autres tâches. Ces messages peuvent contenir un ou plusieurs champs de courrier électronique, avec l'expéditeur, le destinataire, l'objet, la date et le corps du message, ou des informations de contact, les détails du rendez-vous et une ou plusieurs spécifications de tâche. Les propriétés qui constituent l'objet Message, notamment, font également partie du fichier MSG. Le fichier MSG contient des en-têtes, un corps de message principal et des hyperliens sous forme de texte ASCII brut. Les fichiers MSG conviennent également aux programmes nécessitant l'interface de programmation d'applications de messagerie (MAPI) de Microsoft.
...
solutions:
    ...
    solution:
        # solution loop
        - img_alt: "GroupDocs.Comparison for Java MSG"
