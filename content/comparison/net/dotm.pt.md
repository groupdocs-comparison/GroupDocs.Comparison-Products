...
head_description: "Compare e mescle mais de dois arquivos DOTM em aplicativos C# .NET. Recupere o resumo das diferenças no conteúdo, texto e estilo de DOTM arquivos, imagens e formatos de documento."

############################# Header ############################
title: "Comparar arquivos DOTM em C# .NET"
...
steps:
    ...
    code: |
        ...
        using (Comparer comparer = new Comparer("source.dotm"))
        {
            ...
            comparer.Compare("result.dotm"); // Cria arquivo de resultado com o nome especificado
        }
        ...
        using (Comparer comparer = new Comparer(File.OpenRead("source.dotm")))
        {
            ...
            comparer.Compare(File.Create("result.dotm")); // Cria arquivo de resultado com o nome especificado
        }
        ```
