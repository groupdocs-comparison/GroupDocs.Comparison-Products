...
head_description: "Compare e mescle mais de dois arquivos LOG em aplicativos C# .NET. Recupere o resumo das diferenças no conteúdo, texto e estilo de LOG arquivos, imagens e formatos de documento."

############################# Header ############################
title: "Comparar arquivos LOG em C# .NET"
...
steps:
    ...
    code: |
        ...
        using (Comparer comparer = new Comparer("source.log"))
        {
            ...
            comparer.Compare("result.log"); // Cria arquivo de resultado com o nome especificado
        }
        ...
        using (Comparer comparer = new Comparer(File.OpenRead("source.log")))
        {
            ...
            comparer.Compare(File.Create("result.log")); // Cria arquivo de resultado com o nome especificado
        }
        ```
