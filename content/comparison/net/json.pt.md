...
head_description: "Compare e mescle mais de dois arquivos JSON em aplicativos C# .NET. Recupere o resumo das diferenças no conteúdo, texto e estilo de JSON arquivos, imagens e formatos de documento."

############################# Header ############################
title: "Comparar arquivos JSON em C# .NET"
...
steps:
    ...
    code: |
        ...
        using (Comparer comparer = new Comparer("source.json"))
        {
            ...
            comparer.Compare("result.json"); // Cria arquivo de resultado com o nome especificado
        }
        ...
        using (Comparer comparer = new Comparer(File.OpenRead("source.json")))
        {
            ...
            comparer.Compare(File.Create("result.json")); // Cria arquivo de resultado com o nome especificado
        }
        ```
