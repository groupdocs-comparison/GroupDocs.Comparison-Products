...
head_description: "Compare e mescle mais de dois arquivos GROOVY em aplicativos C# .NET. Recupere o resumo das diferenças no conteúdo, texto e estilo de GROOVY arquivos, imagens e formatos de documento."

############################# Header ############################
title: "Comparar arquivos GROOVY em C# .NET"
...
steps:
    ...
    code: |
        ...
        using (Comparer comparer = new Comparer("source.groovy"))
        {
            ...
            comparer.Compare("result.groovy"); // Cria arquivo de resultado com o nome especificado
        }
        ...
        using (Comparer comparer = new Comparer(File.OpenRead("source.groovy")))
        {
            ...
            comparer.Compare(File.Create("result.groovy")); // Cria arquivo de resultado com o nome especificado
        }
        ```
