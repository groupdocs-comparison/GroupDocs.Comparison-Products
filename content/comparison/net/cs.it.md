...
############################# Head ############################
head_title: "Confronta due file CS in .NET | API di confronto dei documenti"
head_description: "Confronta e unisci più di due file CS in applicazioni C# .NET. Recupera il riepilogo delle differenze nel contenuto, nel testo e nello stile di CS file, immagini e formati di documenti."

############################# Header ############################
title: "Confronta i file CS in C# .NET"
description: "API di confronto dei documenti .NET per rilevare le modifiche tra due versioni di file CS ed esportare in un documento finale con un riepilogo dettagliato delle differenze tra i documenti confrontati."
...
steps:
    enable: true
    title_left: "Passaggi per confrontare i file CS in C#"
    content_left: |
        [GroupDocs.Comparison](/comparison/net/) semplifica agli sviluppatori .NET il confronto e l'unione di più file CS nelle loro applicazioni implementando pochi semplici passaggi.
    ...
    code: |
        ...
        using (Comparer comparer = new Comparer("source.cs"))
        {
            ...
            comparer.Compare("result.cs"); // Crea il file dei risultati con il nome specificato
        }
        ...
        using (Comparer comparer = new Comparer(File.OpenRead("source.cs")))
        {
            ...
            comparer.Compare(File.Create("result.cs")); // Crea il file dei risultati con il nome specificato
        }
        ```
...
demos:
    enable: true
    title: "Demo live di confronto di CS file"
    content: |
        Rileva subito le differenze tra i file CS visitando il sito web [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
...
about_formats:
    ...
    format:
        # format loop
        - icon: "far fa-file-cs"
          title: "Informazioni sul formato file CS"
          content: |
            I file con estensione .CS sono file di codice sorgente per il linguaggio di programmazione C#. Introdotto da Microsoft per l'utilizzo con .NET Framework, il formato file fornisce il linguaggio di programmazione di basso livello per la scrittura del codice che viene compilato per generare il file di output finale sotto forma di EXE o DLL. Questi possono essere creati e compilati con Microsoft Visual Studio. Microsoft Visual Studio Express può anche essere utilizzato per creare e aggiornare tali file che è un IDE gratuito. I file CS vengono utilizzati per lo sviluppo di applicazioni che possono variare da semplici applicazioni desktop a programmi più complessi. Una semplice soluzione di progetto di Visual Studio creata con il linguaggio C# può comprendere uno o più file di questo tipo. I file contrassegnati per l'inclusione nella compilazione sono elencati nel file CSPROJ che fa parte del progetto e indica al compilatore di utilizzare i file contrassegnati.
