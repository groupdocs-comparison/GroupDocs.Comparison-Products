...
head_description: "Comparez et fusionnez plus de deux fichiers BMP dans des applications C# .NET. Récupérez le résumé des différences dans le contenu, le texte et le style des fichiers, images et formats de document BMP."

############################# Header ############################
title: "Comparez les fichiers BMP en C# .NET"
description: "API de comparaison de documents .NET pour détecter les changements entre deux versions de fichiers BMP et exporter vers un document final avec un résumé détaillé des différences entre les documents comparés."
...
steps:
    ...
    content_left: |
        [GroupDocs.Comparison](/comparison/net/) permet aux développeurs .NET de comparer et de fusionner facilement plusieurs fichiers BMP dans leurs applications en mettant en œuvre quelques étapes simples.
    ...
    code: |
        ...
        using (Comparer comparer = new Comparer("source.bmp"))
        {
            ...
            comparer.Compare("result.bmp"); // Crée un fichier résultat avec le nom spécifié
        }
        ...
        using (Comparer comparer = new Comparer(File.OpenRead("source.bmp")))
        {
            ...
            comparer.Compare(File.Create("result.bmp")); // Crée un fichier résultat avec le nom spécifié
        }
        ```
...
demos:
    enable: true
    title: "Démonstrations en direct de la comparaison de fichiers BMP"
    content: |
