...
head_description: "Compare e mescle mais de dois arquivos ONE em aplicativos C# .NET. Recupere resumos de diferenças em conteúdo, texto e estilo de ONE arquivos, imagens e formatos de documentos."

############################# Header ############################
title: "Compare arquivos ONE em C# .NET"
...
steps:
    ...
    code: |
        ...
        using (Comparer comparer = new Comparer("source.one"))
        {
            ...
            comparer.Compare("result.one"); // Crie um arquivo de resultado com o nome especificado
        }
        ...
        using (Comparer comparer = new Comparer(File.OpenRead("source.one")))
        {
            ...
            comparer.Compare(File.Create("result.one")); // Crie um arquivo de resultado com o nome especificado
        }
        ```
