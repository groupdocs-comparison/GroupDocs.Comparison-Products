...
head_description: "Compare e mescle mais de dois arquivos TXT em aplicativos C# .NET. Recupere o resumo das diferenças no conteúdo, texto e estilo de TXT arquivos, imagens e formatos de documento."

############################# Header ############################
title: "Comparar arquivos TXT em C# .NET"
...
steps:
    ...
    code: |
        ...
        using (Comparer comparer = new Comparer("source.txt"))
        {
            ...
            comparer.Compare("result.txt"); // Cria arquivo de resultado com o nome especificado
        }
        ...
        using (Comparer comparer = new Comparer(File.OpenRead("source.txt")))
        {
            ...
            comparer.Compare(File.Create("result.txt")); // Cria arquivo de resultado com o nome especificado
        }
        ```
