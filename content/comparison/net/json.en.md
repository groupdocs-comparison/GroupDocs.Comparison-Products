...
############################# Head ############################
head_title: "Compare JSON files with C# Comparison Software"
head_description: "Compare and merge JSON files in C# .NET applications. Retrieve differences summary in content, text & style."

############################# Header ############################
title: "Compare JSON in C# .NET" 
description: ".NET documents comparison API to check for diffs between two versions of JSON files and export to a final document with a detailed summary of the differences between the compared documents."
...
steps:
    ...
    content: |
      ...
      2. Provide an instance of Comparer class with full path to initial JSON file
