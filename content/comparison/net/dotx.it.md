...
############################# Head ############################
head_title: "Confronta due file DOTX in .NET | API di confronto dei documenti"
head_description: "Confronta e unisci più di due file DOTX nelle applicazioni C# .NET. Recupera il riepilogo delle differenze nel contenuto, nel testo e nello stile di file, immagini e formati di documenti DOTX."

############################# Header ############################
title: "Confronta i file DOTX in C# .NET"
description: "API di confronto dei documenti .NET per rilevare le modifiche tra due versioni di file DOTX ed esportarle in un documento finale con un riepilogo dettagliato delle differenze tra i documenti confrontati."
...
steps:
    enable: true
    title_left: "Passaggi per confrontare i file DOTX in C#"
    content_left: |
        [GroupDocs.Comparison](/comparison/net/) semplifica agli sviluppatori .NET il confronto e l'unione di più file DOTX nelle loro applicazioni implementando alcuni semplici passaggi.
    ...
    code: |
        ...
        using (Comparer comparer = new Comparer("source.dotx"))
        {
            ...
            comparer.Compare("result.dotx"); // Crea il file dei risultati con il nome specificato
        }
        ...
        using (Comparer comparer = new Comparer(File.OpenRead("source.dotx")))
        {
            ...
            comparer.Compare(File.Create("result.dotx")); // Crea il file dei risultati con il nome specificato
        }
        ```
...
demos:
    enable: true
    title: "Demo dal vivo del confronto di file DOTX"
    content: |
        Rileva subito le differenze tra i file DOTX visitando il sito web [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-dotx"
          ...
          content: |
            I file con estensione DOTX sono file modello creati da Microsoft Word per avere impostazioni preformattate per la generazione di ulteriori file DOCX. Viene creato un file modello per avere impostazioni utente specifiche che devono essere applicate alle mosche successive create da queste. Queste impostazioni includono margini della pagina, bordi, intestazioni, piè di pagina e altre impostazioni della pagina. Tali modelli vengono utilizzati nei documenti ufficiali come carta intestata aziendale e moduli standardizzati. Il formato file DOTX è stato introdotto con il rilascio di Microsoft Office 2007 per sostituire il formato file binario DOT, ma è supportato anche da versioni successive. Microsoft Word per impostazione predefinita apre ogni nuovo documento in base al file normal.dot. Se modificati, tutti i nuovi file creati avranno le stesse impostazioni del file modello. In Microsoft Word 2007, il formato file DOT è stato sostituito con il formato file DOTX basato su Office OpenXML.
