...
head_description: "Compare e mescle mais de dois arquivos OTP em aplicativos C# .NET. Recupere o resumo das diferenças no conteúdo, texto e estilo de OTP arquivos, imagens e formatos de documento."

############################# Header ############################
title: "Comparar arquivos OTP em C# .NET"
...
steps:
    ...
    code: |
        ...
        using (Comparer comparer = new Comparer("source.otp"))
        {
            ...
            comparer.Compare("result.otp"); // Cria arquivo de resultado com o nome especificado
        }
        ...
        using (Comparer comparer = new Comparer(File.OpenRead("source.otp")))
        {
            ...
            comparer.Compare(File.Create("result.otp")); // Cria arquivo de resultado com o nome especificado
        }
        ```
