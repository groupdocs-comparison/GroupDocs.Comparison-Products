...
head_description: "Compare e mescle mais de dois arquivos DOTX em aplicativos C# .NET. Recupere o resumo das diferenças no conteúdo, texto e estilo de DOTX arquivos, imagens e formatos de documento."

############################# Header ############################
title: "Comparar arquivos DOTX em C# .NET"
...
steps:
    ...
    code: |
        ...
        using (Comparer comparer = new Comparer("source.dotx"))
        {
            ...
            comparer.Compare("result.dotx"); // Cria arquivo de resultado com o nome especificado
        }
        ...
        using (Comparer comparer = new Comparer(File.OpenRead("source.dotx")))
        {
            ...
            comparer.Compare(File.Create("result.dotx")); // Cria arquivo de resultado com o nome especificado
        }
        ```
