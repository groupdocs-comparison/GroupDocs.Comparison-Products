...
head_description: "Compare e mescle mais de dois arquivos VST em aplicativos C# .NET. Recupere o resumo das diferenças no conteúdo, texto e estilo de VST arquivos, imagens e formatos de documento."

############################# Header ############################
title: "Comparar arquivos VST em C# .NET"
...
steps:
    ...
    code: |
        ...
        using (Comparer comparer = new Comparer("source.vst"))
        {
            ...
            comparer.Compare("result.vst"); // Cria arquivo de resultado com o nome especificado
        }
        ...
        using (Comparer comparer = new Comparer(File.OpenRead("source.vst")))
        {
            ...
            comparer.Compare(File.Create("result.vst")); // Cria arquivo de resultado com o nome especificado
        }
        ```
