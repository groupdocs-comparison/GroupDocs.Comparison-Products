...
head_description: "Compare e mescle mais de dois arquivos PPTX em aplicativos C# .NET. Recupere o resumo das diferenças no conteúdo, texto e estilo de PPTX arquivos, imagens e formatos de documento."

############################# Header ############################
title: "Comparar arquivos PPTX em C# .NET"
...
steps:
    ...
    code: |
        ...
        using (Comparer comparer = new Comparer("source.pptx"))
        {
            ...
            comparer.Compare("result.pptx"); // Cria arquivo de resultado com o nome especificado
        }
        ...
        using (Comparer comparer = new Comparer(File.OpenRead("source.pptx")))
        {
            ...
            comparer.Compare(File.Create("result.pptx")); // Cria arquivo de resultado com o nome especificado
        }
        ```
