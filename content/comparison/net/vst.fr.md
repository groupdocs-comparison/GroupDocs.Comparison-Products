...
head_description: "Comparez et fusionnez plus de deux fichiers VST dans des applications C# .NET. Récupérez le résumé des différences dans le contenu, le texte et le style des fichiers, images et formats de document VST."

############################# Header ############################
title: "Comparez les fichiers VST en C# .NET"
description: "API de comparaison de documents .NET pour détecter les changements entre deux versions de fichiers VST et exporter vers un document final avec un résumé détaillé des différences entre les documents comparés."
...
steps:
    ...
    content_left: |
        [GroupDocs.Comparison](/comparison/net/) permet aux développeurs .NET de comparer et de fusionner facilement plusieurs fichiers VST dans leurs applications en mettant en œuvre quelques étapes simples.
    ...
    code: |
        ...
        using (Comparer comparer = new Comparer("source.vst"))
        {
            ...
            comparer.Compare("result.vst"); // Crée un fichier résultat avec le nom spécifié
        }
        ...
        using (Comparer comparer = new Comparer(File.OpenRead("source.vst")))
        {
            ...
            comparer.Compare(File.Create("result.vst")); // Crée un fichier résultat avec le nom spécifié
        }
        ```
...
demos:
    enable: true
    title: "Démonstrations en direct de la comparaison de fichiers VST"
    content: |
