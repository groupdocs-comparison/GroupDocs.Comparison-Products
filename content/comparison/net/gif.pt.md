...
head_description: "Compare e mescle mais de dois arquivos GIF em aplicativos C# .NET. Recupere o resumo das diferenças no conteúdo, texto e estilo de GIF arquivos, imagens e formatos de documento."

############################# Header ############################
title: "Comparar arquivos GIF em C# .NET"
...
steps:
    ...
    code: |
        ...
        using (Comparer comparer = new Comparer("source.gif"))
        {
            ...
            comparer.Compare("result.gif"); // Cria arquivo de resultado com o nome especificado
        }
        ...
        using (Comparer comparer = new Comparer(File.OpenRead("source.gif")))
        {
            ...
            comparer.Compare(File.Create("result.gif")); // Cria arquivo de resultado com o nome especificado
        }
        ```
