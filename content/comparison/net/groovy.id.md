...
############################# Head ############################
head_title: "Bandingkan file GROOVY dengan C# Perangkat Lunak Perbandingan"
head_description: "Bandingkan dan gabungkan GROOVY file dalam aplikasi C# .NET. Ambil ringkasan perbedaan dalam konten, teks & gaya."

############################# Header ############################
title: "Bandingkan GROOVY di C# .NET" 
description: ".NET dokumen API perbandingan untuk memeriksa perbedaan antara dua versi file GROOVY dan mengekspor ke dokumen akhir dengan ringkasan terperinci tentang perbedaan antara dokumen yang dibandingkan."
...
steps:
    enable: true
    title: "Cara membandingkan beberapa GROOVY file menggunakan C#"
    content: |
      Dimungkinkan untuk menggunakan [GroupDocs.Comparison](https://products.groupdocs.com/comparison/net/) untuk mendapatkan laporan tentang perbedaan di banyak file GROOVY.
      ...
      2. Berikan instance kelas Comparer dengan path lengkap ke file awal GROOVY
      3. Tambahkan setidaknya satu GROOVY lainnya ke Comparer
