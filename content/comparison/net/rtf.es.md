...
############################# Head ############################
head_title: "Compara dos archivos RTF en .NET | API de comparación de documentos"
head_description: "Compare y combine más de dos archivos RTF en aplicaciones C# .NET. Recupere un resumen de diferencias en contenido, texto y estilo de RTF archivos, imágenes y formatos de documentos."

############################# Header ############################
title: "Comparar archivos RTF en C# .NET"
description: "API de comparación de documentos .NET para detectar los cambios entre dos versiones de archivos RTF y exportarlos a un documento final con un resumen detallado de las diferencias entre los documentos comparados."
...
steps:
    enable: true
    title_left: "Pasos para comparar archivos RTF en C#"
    content_left: |
        [GroupDocs.Comparison](/comparison/net/) facilita a los desarrolladores .NET comparar y fusionar múltiples archivos RTF en sus aplicaciones implementando unos sencillos pasos.
    ...
    code: |
        ...
        using (Comparer comparer = new Comparer("source.rtf"))
        {
            ...
            comparer.Compare("result.rtf"); // Crear archivo de resultados con el nombre especificado
        }
        ...
        using (Comparer comparer = new Comparer(File.OpenRead("source.rtf")))
        {
            ...
            comparer.Compare(File.Create("result.rtf")); // Crear archivo de resultados con el nombre especificado
        }
        ```
...
demos:
    enable: true
    title: "Demostraciones en vivo de comparación de archivos RTF"
    content: |
        Detecte diferencias entre archivos RTF ahora mismo visitando el sitio web [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-rtf"
          ...
          content: |
            Introducido y documentado por Microsoft, el formato de texto enriquecido (RTF) representa un método de codificación de texto y gráficos formateados para su uso dentro de aplicaciones. El formato facilita el intercambio de documentos entre plataformas con otros productos de Microsoft, cumpliendo así el propósito de la interoperabilidad. Esta capacidad lo convierte en un estándar de transferencia de datos entre software de procesamiento de textos y, por lo tanto, los contenidos se pueden transferir de un sistema operativo a otro sin perder el formato del documento. Las especificaciones de formato de archivo están disponibles por parte de Microsoft para su descarga pública y se puede consultarlas desde la perspectiva del desarrollador.
