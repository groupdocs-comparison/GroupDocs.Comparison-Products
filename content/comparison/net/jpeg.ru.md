...
############################# Head ############################
head_title: "API GroupDocs.Comparison for .NET для сравнения JPEG"
...
steps:
    enable: true
    title: "Как сравнить JPEG картинок от C#"
    content: |
      Управляйте содержимым JPEG файлов с помощью [GroupDocs.Comparison](https://products.groupdocs.com/comparison/net/)
      
      1. Получите GroupDocs.Comparison for .NET от [Nuget](https://www.nuget.org/packages/GroupDocs.Comparison) и добавьте в свой проект
      2. Используйте конструктор объектов Comparer, чтобы задать путь к изображению JPEG
      3. Привлеките другое JPEG изображение для анализа
      4. Отчет об исследовании, сохраненный на локальном диске
...
more_formats:
    ...
    exclude: "JPEG"
    description: "Легко анализируйте информацию о любых изменениях в файлах JPEG с помощью продукта GroupDocs.Comparison for .NET."
    items: 
        # format loop 1
