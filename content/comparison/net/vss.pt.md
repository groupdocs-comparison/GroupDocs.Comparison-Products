...
head_description: "Compare e mescle mais de dois arquivos VSS em aplicativos C# .NET. Recupere o resumo das diferenças no conteúdo, texto e estilo de VSS arquivos, imagens e formatos de documento."

############################# Header ############################
title: "Comparar arquivos VSS em C# .NET"
...
steps:
    ...
    code: |
        ...
        using (Comparer comparer = new Comparer("source.vss"))
        {
            ...
            comparer.Compare("result.vss"); // Cria arquivo de resultado com o nome especificado
        }
        ...
        using (Comparer comparer = new Comparer(File.OpenRead("source.vss")))
        {
            ...
            comparer.Compare(File.Create("result.vss")); // Cria arquivo de resultado com o nome especificado
        }
        ```
