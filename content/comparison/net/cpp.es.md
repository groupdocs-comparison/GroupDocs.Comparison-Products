...
############################# Head ############################
head_title: "Compare CPP archivos con el software de comparación C#"
head_description: "Compare y combine CPP archivos en aplicaciones C# .NET. Recupera el resumen de las diferencias en contenido, texto y estilo."

############################# Header ############################
title: "Compara CPP en C# .NET" 
description: ".NET API de comparación de documentos para comprobar si hay diferencias entre dos versiones de CPP archivos y exportarlos a un documento final con un resumen detallado de las diferencias entre los documentos comparados."
...
steps:
    enable: true
    title: "Cómo comparar varios archivos CPP con C#"
    content: |
      Es posible usar [GroupDocs.Comparison](https://products.groupdocs.com/comparison/net/) para obtener informes sobre las diferencias en muchos CPP archivos.
      ...
      2. Proporcione una instancia de la clase Comparer con la ruta completa al archivo inicial CPP
      3. Añada al menos otro CPP al comparador
