...
head_description: "Compare y combine más de dos archivos DIFF en aplicaciones C# .NET. Recupere un resumen de diferencias en contenido, texto y estilo de DIFF archivos, imágenes y formatos de documentos."

############################# Header ############################
title: "Comparar archivos DIFF en C# .NET"
description: "API de comparación de documentos .NET para detectar los cambios entre dos versiones de archivos DIFF y exportarlos a un documento final con un resumen detallado de las diferencias entre los documentos comparados."
...
steps:
    ...
    content_left: |
        [GroupDocs.Comparison](/comparison/net/) facilita a los desarrolladores .NET comparar y fusionar múltiples archivos DIFF en sus aplicaciones implementando unos sencillos pasos.
...
demos:
    enable: true
    title: "Demostraciones en vivo de comparación de archivos DIFF"
    content: |
        Detecte diferencias entre archivos DIFF ahora mismo visitando el sitio web [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
