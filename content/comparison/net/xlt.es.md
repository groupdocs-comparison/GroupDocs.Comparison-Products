...
head_description: "Compare y combine más de dos archivos XLT en aplicaciones C# .NET. Recupere el resumen de diferencias en contenido, texto y estilo de XLT archivos, imágenes y formatos de documentos."

############################# Header ############################
title: "Comparar archivos XLT en C# .NET"
description: "API de comparación de documentos .NET para detectar los cambios entre dos versiones de archivos XLT y exportar a un documento final con un resumen detallado de las diferencias entre los documentos comparados."
...
steps:
    ...
    content_left: |
        [GroupDocs.Comparison](/comparison/net/) facilita a los desarrolladores de .NET comparar y fusionar varios archivos XLT en sus aplicaciones mediante la implementación de unos sencillos pasos.
...
demos:
    enable: true
    title: "Demostraciones en vivo de la comparación de archivos XLT"
    content: |
        Detecte las diferencias entre los archivos XLT ahora mismo visitando el sitio web [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
