...
head_description: "Compare e mescle mais de dois arquivos DICOM em aplicativos C# .NET. Recupere o resumo das diferenças no conteúdo, texto e estilo de DICOM arquivos, imagens e formatos de documento."

############################# Header ############################
title: "Comparar arquivos DICOM em C# .NET"
...
steps:
    ...
    code: |
        ...
        using (Comparer comparer = new Comparer("source.dicom"))
        {
            ...
            comparer.Compare("result.dicom"); // Cria arquivo de resultado com o nome especificado
        }
        ...
        using (Comparer comparer = new Comparer(File.OpenRead("source.dicom")))
        {
            ...
            comparer.Compare(File.Create("result.dicom")); // Cria arquivo de resultado com o nome especificado
        }
        ```
