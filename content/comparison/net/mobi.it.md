...
############################# Head ############################
head_title: "Confronta i file MOBI con il software di confronto C#"
head_description: "Confronta e unisci i file MOBI in C# .NET applicazioni. Recupera il riepilogo delle differenze in termini di contenuto, testo e stile."

############################# Header ############################
title: "Confronta MOBI con C# .NET" 
description: "API di confronto dei documenti .NET per verificare le differenze tra due versioni dei file MOBI ed esportare in un documento finale con un riepilogo dettagliato delle differenze tra i documenti confrontati."
...
steps:
    enable: true
    title: "Come confrontare più file MOBI utilizzando C#"
    content: |
      È possibile utilizzare [GroupDocs.Comparison](https://products.groupdocs.com/comparison/net/) per ottenere report sulle differenze in molti file MOBI.
      ...
      2. Fornisci un'istanza della classe Comparer con il percorso completo del file MOBI iniziale
      3. Aggiungi almeno un altro MOBI a Comparer
