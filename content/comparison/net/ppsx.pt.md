...
head_description: "Compare e mescle mais de dois arquivos PPSX em aplicativos C# .NET. Recupere o resumo das diferenças no conteúdo, texto e estilo de PPSX arquivos, imagens e formatos de documento."

############################# Header ############################
title: "Comparar arquivos PPSX em C# .NET"
...
steps:
    ...
    code: |
        ...
        using (Comparer comparer = new Comparer("source.ppsx"))
        {
            ...
            comparer.Compare("result.ppsx"); // Cria arquivo de resultado com o nome especificado
        }
        ...
        using (Comparer comparer = new Comparer(File.OpenRead("source.ppsx")))
        {
            ...
            comparer.Compare(File.Create("result.ppsx")); // Cria arquivo de resultado com o nome especificado
        }
        ```
