...
head_description: "Compare e mescle mais de dois arquivos DWG em aplicativos C# .NET. Recupere o resumo das diferenças no conteúdo, texto e estilo de DWG arquivos, imagens e formatos de documento."

############################# Header ############################
title: "Comparar arquivos DWG em C# .NET"
...
steps:
    ...
    code: |
        ...
        using (Comparer comparer = new Comparer("source.dwg"))
        {
            ...
            comparer.Compare("result.dwg"); // Cria arquivo de resultado com o nome especificado
        }
        ...
        using (Comparer comparer = new Comparer(File.OpenRead("source.dwg")))
        {
            ...
            comparer.Compare(File.Create("result.dwg")); // Cria arquivo de resultado com o nome especificado
        }
        ```
