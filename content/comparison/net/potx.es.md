...
############################# Head ############################
head_title: "Compara dos archivos POTX en .NET | API de comparación de documentos"
head_description: "Compare y combine más de dos archivos POTX en aplicaciones C# .NET. Recupere un resumen de diferencias en contenido, texto y estilo de POTX archivos, imágenes y formatos de documentos."

############################# Header ############################
title: "Comparar archivos POTX en C# .NET"
description: "API de comparación de documentos .NET para detectar los cambios entre dos versiones de archivos POTX y exportarlos a un documento final con un resumen detallado de las diferencias entre los documentos comparados."
...
steps:
    enable: true
    title_left: "Pasos para comparar archivos POTX en C#"
    content_left: |
        [GroupDocs.Comparison](/comparison/net/) facilita a los desarrolladores .NET comparar y fusionar múltiples archivos POTX en sus aplicaciones implementando unos sencillos pasos.
    ...
    code: |
        ...
        using (Comparer comparer = new Comparer("source.potx"))
        {
            ...
            comparer.Compare("result.potx"); // Crear archivo de resultados con el nombre especificado
        }
        ...
        using (Comparer comparer = new Comparer(File.OpenRead("source.potx")))
        {
            ...
            comparer.Compare(File.Create("result.potx")); // Crear archivo de resultados con el nombre especificado
        }
        ```
...
demos:
    enable: true
    title: "Demostraciones en vivo de comparación de archivos POTX"
    content: |
        Detecte diferencias entre archivos POTX ahora mismo visitando el sitio web [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-potx"
          ...
          content: |
            Los archivos con extensión .POTX representan presentaciones de plantillas de Microsoft PowerPoint creadas con Microsoft PowerPoint 2007 y versiones posteriores. Este formato se creó para reemplazar el formato de archivo POT que se basa en el formato de archivo binario y es compatible con PowerPoint 97-2003. Los archivos generados se pueden utilizar para crear presentaciones que tengan el mismo diseño y otras configuraciones necesarias para aplicar a archivos nuevos. Estas configuraciones pueden incluir estilos, fondos, paleta de colores, fuentes y valores predeterminados. Estos archivos se generan para crear archivos de plantilla listos para usar para uso oficial.
