...
############################# Head ############################
head_title: "Compare two SQL files in .NET | Document Comparison APIs"
head_description: "Compare and merge more than two SQL files in C# .NET applications. Retrieve differences summary in content, text & style of SQL files, images and document formats."

############################# Header ############################
title: "Compare SQL Files in C# .NET"
description: ".NET documents comparison API to detect the changes between two versions of SQL files and export to a final document with a detailed summary of the differences between the compared documents."
...
steps:
    enable: true
    title_left: "Steps for Comparing SQL Files in C#"
    content_left: |
        [GroupDocs.Comparison](/comparison/net/) makes it easy for .NET developers to compare & merge multiple SQL files in their applications by implementing a few easy steps.
    ...
    code: |
        ...
        using (Comparer comparer = new Comparer("source.sql"))
        {
            ...
            comparer.Compare("result.sql"); // Create result file with the specified name
        }
        ...
        using (Comparer comparer = new Comparer(File.OpenRead("source.sql")))
        {
            ...
            comparer.Compare(File.Create("result.sql")); // Create result file with the specified name
        }
        ```
...
demos:
    enable: true
    title: "Live Demos of Comparing SQL Files"
    content: |
        Detect differences between SQL files right now by visiting [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family) website.  
