...
head_description: "Compare e mescle mais de dois arquivos SQL em aplicativos C# .NET. Recupere o resumo das diferenças no conteúdo, texto e estilo de SQL arquivos, imagens e formatos de documento."

############################# Header ############################
title: "Comparar arquivos SQL em C# .NET"
...
steps:
    ...
    code: |
        ...
        using (Comparer comparer = new Comparer("source.sql"))
        {
            ...
            comparer.Compare("result.sql"); // Cria arquivo de resultado com o nome especificado
        }
        ...
        using (Comparer comparer = new Comparer(File.OpenRead("source.sql")))
        {
            ...
            comparer.Compare(File.Create("result.sql")); // Cria arquivo de resultado com o nome especificado
        }
        ```
