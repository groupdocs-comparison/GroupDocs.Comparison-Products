...
############################# Head ############################
head_title: "ODT Dateien mit C# Vergleichssoftware vergleichen"
head_description: "Vergleichen und führen Sie ODT Dateien in C# .NET Anwendungen zusammen. Rufen Sie eine Zusammenfassung der Unterschiede in Inhalt, Text und Stil ab."

############################# Header ############################
title: "Vergleiche ODT in C# .NET" 
description: ".NET API zum Vergleich von Dokumenten, um nach Unterschieden zwischen zwei Versionen von ODT Dateien zu suchen und in ein endgültiges Dokument mit einer detaillierten Zusammenfassung der Unterschiede zwischen den verglichenen Dokumenten zu exportieren."
...
steps:
    enable: true
    title: "So vergleichen Sie mehrere ODT Dateien mit C#"
    content: |
      Es ist möglich, [GroupDocs.Comparison](https://products.groupdocs.com/comparison/net/) zu verwenden, um Berichte über Unterschiede in vielen ODT Dateien zu erhalten.
      ...
      2. Geben Sie eine Instanz der Comparer-Klasse mit dem vollständigen Pfad zur ursprünglichen ODT -Datei an
      3. Hängen Sie mindestens ein weiteres ODT an Comparer an
    ...
    code:
      ...
      content: |
        ...
        using (Comparer comparer = new Comparer("main_document.odt"))
        {
            // Andere Dateien hinzufügen
        	comparer.Add("modified_1.odt");
            comparer.Add("modified_2.odt");

            // Ruft die Ergebnisdatei mit dem angegebenen Namen ab
            comparer.Compare("report.odt"); 
        }
