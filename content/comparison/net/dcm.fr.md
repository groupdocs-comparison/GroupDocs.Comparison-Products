...
############################# Head ############################
head_title: "Comparez deux fichiers DCM dans .NET | API de comparaison de documents"
head_description: "Comparez et fusionnez plus de deux fichiers DCM dans des applications C# .NET. Récupérez le résumé des différences dans le contenu, le texte et le style des fichiers, images et formats de documents DCM."

############################# Header ############################
title: "Comparez les fichiers DCM en C# .NET"
description: "API de comparaison de documents .NET pour détecter les modifications entre deux versions de fichiers DCM et exporter vers un document final avec un résumé détaillé des différences entre les documents comparés."
...
steps:
    enable: true
    title_left: "Étapes pour comparer les fichiers DCM en C#"
    content_left: |
        [GroupDocs.Comparison](/comparison/net/) permet aux développeurs .NET de comparer et de fusionner facilement plusieurs fichiers DCM dans leurs applications en implémentant quelques étapes simples.
    ...
    code: |
        ...
        using (Comparer comparer = new Comparer("source.dcm"))
        {
            ...
            comparer.Compare("result.dcm"); // Créer un fichier de résultats avec le nom spécifié
        }
        ...
        using (Comparer comparer = new Comparer(File.OpenRead("source.dcm")))
        {
            ...
            comparer.Compare(File.Create("result.dcm")); // Créer un fichier de résultats avec le nom spécifié
        }
        ```
...
demos:
    enable: true
    title: "Démonstrations en direct de comparaison de fichiers DCM"
    content: |
        Détectez dès maintenant les différences entre les fichiers DCM en visitant le site Web [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-dcm"
          ...
          content: |
            Les fichiers avec l'extension .DCM représentent une image numérique qui stocke des informations médicales sur les patients telles que les IRM, les tomodensitogrammes et les images échographiques. Il a été développé par la National Electrical Manufacturers Association (NEMA) et visait à normaliser le format de fichier d'imagerie pour la distribution et la visualisation d'images médicales. Il est similaire au format de fichier DICOM et peut inclure les informations du patient à titre de référence.
...
solutions:
    ...
    solution:
        # solution loop
        - img_alt: "GroupDocs.Comparison for Java DCM"
          image: "https://www.groupdocs.cloud/templates/groupdocs/images/product-logos/groupdocs-comparison-java.png"
          product: "GroupDocs.Comparison"
          platform: "Java"
          link: "/comparison/java/dcm/"
