...
head_description: "Compare e mescle mais de dois arquivos ODT em aplicativos C# .NET. Recupere resumos de diferenças em conteúdo, texto e estilo de ODT arquivos, imagens e formatos de documentos."

############################# Header ############################
title: "Compare arquivos ODT em C# .NET"
...
steps:
    ...
    code: |
        ...
        using (Comparer comparer = new Comparer("source.odt"))
        {
            ...
            comparer.Compare("result.odt"); // Crie um arquivo de resultado com o nome especificado
        }
        ...
        using (Comparer comparer = new Comparer(File.OpenRead("source.odt")))
        {
            ...
            comparer.Compare(File.Create("result.odt")); // Crie um arquivo de resultado com o nome especificado
        }
        ```
