...
############################# Head ############################
head_title: "Compare dois arquivos JS em .NET | APIs de comparação de documentos"
head_description: "Compare e mescle mais de dois arquivos JS em aplicativos C# .NET. Recupere o resumo das diferenças no conteúdo, texto e estilo de JS arquivos, imagens e formatos de documento."

############################# Header ############################
title: "Comparar arquivos JS em C# .NET"
description: "API de comparação de documentos .NET para detectar as alterações entre duas versões de arquivos JS e exportar para um documento final com um resumo detalhado das diferenças entre os documentos comparados."
...
steps:
    enable: true
    title_left: "Etapas para comparar arquivos JS em C#"
    content_left: |
        [GroupDocs.Comparison](/comparison/net/) torna mais fácil para os desenvolvedores .NET comparar e mesclar vários arquivos JS em seus aplicativos implementando algumas etapas fáceis.
    ...
    code: |
        ...
        using (Comparer comparer = new Comparer("source.js"))
        {
            ...
            comparer.Compare("result.js"); // Cria arquivo de resultado com o nome especificado
        }
        ...
        using (Comparer comparer = new Comparer(File.OpenRead("source.js")))
        {
            ...
            comparer.Compare(File.Create("result.js")); // Cria arquivo de resultado com o nome especificado
        }
        ```
...
demos:
    enable: true
    title: "Demonstrações ao vivo de comparação de arquivos JS"
    content: |
        Detecte diferenças entre arquivos JS agora mesmo visitando o site [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
...
about_formats:
    ...
    format:
        # format loop
        - icon: "far fa-file-js"
          title: "Sobre o formato de arquivo JS"
          content: |
            JS (JavaScript) são arquivos que contém código JavaScript para execução em páginas web. Os arquivos JavaScript são armazenados com a extensão .js. Dentro do documento HTML, você pode incorporar o código JavaScript usando as tags ou incluir um arquivo JS. Semelhante aos arquivos CSS, os arquivos JS podem ser incluídos em vários documentos HTML para reutilização de código. JavaScript pode ser usado para manipular o HTML DOM.
