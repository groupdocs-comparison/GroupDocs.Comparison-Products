...
head_description: "Сравните и объедините более двух файлов MHT в приложениях C# .NET. Получите сводку о различиях в содержимом, тексте и стиле файлов MHT, изображениях и форматах документов."
