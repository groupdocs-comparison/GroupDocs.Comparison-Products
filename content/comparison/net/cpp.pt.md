...
head_description: "Compare e mescle mais de dois arquivos CPP em aplicativos C# .NET. Recupere resumos de diferenças em conteúdo, texto e estilo de CPP arquivos, imagens e formatos de documentos."

############################# Header ############################
title: "Compare arquivos CPP em C# .NET"
...
steps:
    ...
    code: |
        ...
        using (Comparer comparer = new Comparer("source.cpp"))
        {
            ...
            comparer.Compare("result.cpp"); // Crie um arquivo de resultado com o nome especificado
        }
        ...
        using (Comparer comparer = new Comparer(File.OpenRead("source.cpp")))
        {
            ...
            comparer.Compare(File.Create("result.cpp")); // Crie um arquivo de resultado com o nome especificado
        }
        ```
