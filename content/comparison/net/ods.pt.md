...
head_description: "Compare e mescle mais de dois arquivos ODS em aplicativos C# .NET. Recupere o resumo das diferenças no conteúdo, texto e estilo de ODS arquivos, imagens e formatos de documento."

############################# Header ############################
title: "Comparar arquivos ODS em C# .NET"
...
steps:
    ...
    code: |
        ...
        using (Comparer comparer = new Comparer("source.ods"))
        {
            ...
            comparer.Compare("result.ods"); // Cria arquivo de resultado com o nome especificado
        }
        ...
        using (Comparer comparer = new Comparer(File.OpenRead("source.ods")))
        {
            ...
            comparer.Compare(File.Create("result.ods")); // Cria arquivo de resultado com o nome especificado
        }
        ```
