...
############################# Header ############################
title: "Comparing CS files in C# .NET applications" 
description: ".NET document comparison API for retrieving and displaying differences in CS files in C#, ASP.NET, VB.NET, and .NET Core Applications. Effortlessly obtain detailed reports for a seamless experience."
...
steps:
    ...
    content: |
      It is possible to use [GroupDocs.Comparison](https://products.groupdocs.com/comparison/net/) for getting report about differences in many CS files.
      ...
      2. Provide an instance of Comparer class with full path to initial CS file
