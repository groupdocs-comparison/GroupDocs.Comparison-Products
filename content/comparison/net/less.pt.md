...
head_description: "Compare e mescle mais de dois arquivos LESS em aplicativos C# .NET. Recupere o resumo das diferenças no conteúdo, texto e estilo de LESS arquivos, imagens e formatos de documento."

############################# Header ############################
title: "Comparar arquivos LESS em C# .NET"
...
steps:
    ...
    code: |
        ...
        using (Comparer comparer = new Comparer("source.less"))
        {
            ...
            comparer.Compare("result.less"); // Cria arquivo de resultado com o nome especificado
        }
        ...
        using (Comparer comparer = new Comparer(File.OpenRead("source.less")))
        {
            ...
            comparer.Compare(File.Create("result.less")); // Cria arquivo de resultado com o nome especificado
        }
        ```
