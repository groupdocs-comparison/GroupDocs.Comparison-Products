...
head_description: "Compare e mescle mais de dois arquivos BMP em aplicativos C# .NET. Recupere o resumo das diferenças no conteúdo, texto e estilo de BMP arquivos, imagens e formatos de documento."

############################# Header ############################
title: "Comparar arquivos BMP em C# .NET"
...
steps:
    ...
    code: |
        ...
        using (Comparer comparer = new Comparer("source.bmp"))
        {
            ...
            comparer.Compare("result.bmp"); // Cria arquivo de resultado com o nome especificado
        }
        ...
        using (Comparer comparer = new Comparer(File.OpenRead("source.bmp")))
        {
            ...
            comparer.Compare(File.Create("result.bmp")); // Cria arquivo de resultado com o nome especificado
        }
        ```
