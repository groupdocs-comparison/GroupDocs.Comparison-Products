...
head_description: "Compare e mescle mais de dois arquivos SCALA em aplicativos C# .NET. Recupere o resumo das diferenças no conteúdo, texto e estilo de SCALA arquivos, imagens e formatos de documento."

############################# Header ############################
title: "Comparar arquivos SCALA em C# .NET"
...
steps:
    ...
    code: |
        ...
        using (Comparer comparer = new Comparer("source.scala"))
        {
            ...
            comparer.Compare("result.scala"); // Cria arquivo de resultado com o nome especificado
        }
        ...
        using (Comparer comparer = new Comparer(File.OpenRead("source.scala")))
        {
            ...
            comparer.Compare(File.Create("result.scala")); // Cria arquivo de resultado com o nome especificado
        }
        ```
