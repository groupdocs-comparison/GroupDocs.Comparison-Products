...
head_description: "3つ以上を比較してマージします（C＃.NETアプリケーションのXLTMファイル。コンテンツ、テキスト、XLTMファイルのスタイル、画像、ドキュメント形式の違いの概要を取得します."

title: "C＃.NETでXLTMファイルを比較する"
description: ".XLTMファイルの2つのバージョン間の変更を検出し、比較されたドキュメント間の違いの詳細な要約を含む最終的なドキュメントにエクスポートするためのNETドキュメント比較API."
