...
head_description: "Compare e mescle mais de dois arquivos POTX em aplicativos C# .NET. Recupere o resumo das diferenças no conteúdo, texto e estilo de POTX arquivos, imagens e formatos de documento."

############################# Header ############################
title: "Comparar arquivos POTX em C# .NET"
...
steps:
    ...
    code: |
        ...
        using (Comparer comparer = new Comparer("source.potx"))
        {
            ...
            comparer.Compare("result.potx"); // Cria arquivo de resultado com o nome especificado
        }
        ...
        using (Comparer comparer = new Comparer(File.OpenRead("source.potx")))
        {
            ...
            comparer.Compare(File.Create("result.potx")); // Cria arquivo de resultado com o nome especificado
        }
        ```
