...
############################# Head ############################
head_title: "Compare dois arquivos POTX em .NET | APIs de comparação de documentos"
head_description: "Compare e mescle mais de dois arquivos POTX em aplicativos C# .NET. Recupere resumos de diferenças em conteúdo, texto e estilo de POTX arquivos, imagens e formatos de documentos."

############################# Header ############################
title: "Compare arquivos POTX em C# .NET"
description: "API de comparação de documentos .NET para detectar as alterações entre duas versões de arquivos POTX e exportar para um documento final com um resumo detalhado das diferenças entre os documentos comparados."
...
steps:
    enable: true
    title_left: "Etapas para comparar arquivos POTX em C#"
    content_left: |
        [GroupDocs.Comparison](/comparison/net/) torna mais fácil para os desenvolvedores .NET comparar e mesclar vários arquivos POTX em seus aplicativos, implementando algumas etapas fáceis.
    ...
    code: |
        ...
        using (Comparer comparer = new Comparer("source.potx"))
        {
            ...
            comparer.Compare("result.potx"); // Crie um arquivo de resultado com o nome especificado
        }
        ...
        using (Comparer comparer = new Comparer(File.OpenRead("source.potx")))
        {
            ...
            comparer.Compare(File.Create("result.potx")); // Crie um arquivo de resultado com o nome especificado
        }
        ```
...
demos:
    enable: true
    title: "Demonstrações ao vivo de comparação de arquivos POTX"
    content: |
        Detecte diferenças entre arquivos POTX agora mesmo visitando o site [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-potx"
          ...
          content: |
            Arquivos com extensão .POTX representam apresentações de modelos do Microsoft PowerPoint criadas com o Microsoft PowerPoint 2007 e superior. Este formato foi criado para substituir o formato de arquivo POT que se baseia no formato de arquivo binário e é compatível com o PowerPoint 97-2003. Os arquivos gerados podem ser usados ​​para criar apresentações que tenham o mesmo layout e outras configurações necessárias para serem aplicadas a novos arquivos. Essas configurações podem incluir estilos, planos de fundo, paleta de cores, fontes e padrões. Esses arquivos são gerados para criar arquivos de modelo prontos para uso oficial.
