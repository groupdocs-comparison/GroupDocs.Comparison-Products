...
head_description: "Compare e mescle mais de dois arquivos XLS em aplicativos C# .NET. Recupere o resumo das diferenças no conteúdo, texto e estilo de XLS arquivos, imagens e formatos de documento."

############################# Header ############################
title: "Comparar arquivos XLS em C# .NET"
...
steps:
    ...
    code: |
        ...
        using (Comparer comparer = new Comparer("source.xls"))
        {
            ...
            comparer.Compare("result.xls"); // Cria arquivo de resultado com o nome especificado
        }
        ...
        using (Comparer comparer = new Comparer(File.OpenRead("source.xls")))
        {
            ...
            comparer.Compare(File.Create("result.xls")); // Cria arquivo de resultado com o nome especificado
        }
        ```
