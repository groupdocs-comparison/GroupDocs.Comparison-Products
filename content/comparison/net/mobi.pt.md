...
head_description: "Compare e mescle mais de dois arquivos MOBI em aplicativos C# .NET. Recupere o resumo das diferenças no conteúdo, texto e estilo de MOBI arquivos, imagens e formatos de documento."

############################# Header ############################
title: "Comparar arquivos MOBI em C# .NET"
...
steps:
    ...
    code: |
        ...
        using (Comparer comparer = new Comparer("source.mobi"))
        {
            ...
            comparer.Compare("result.mobi"); // Cria arquivo de resultado com o nome especificado
        }
        ...
        using (Comparer comparer = new Comparer(File.OpenRead("source.mobi")))
        {
            ...
            comparer.Compare(File.Create("result.mobi")); // Cria arquivo de resultado com o nome especificado
        }
        ```
