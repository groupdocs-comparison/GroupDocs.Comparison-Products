...
############################# Head ############################
head_title: "Compare arquivos MOBI com o software de comparação C#"
head_description: "Compare e mescle MOBI arquivos em C# .NET aplicativos. Recupere o resumo das diferenças em conteúdo, texto e estilo."

############################# Header ############################
title: "Comparar MOBI em C# .NET" 
description: "API de comparação de documentos .NET para verificar diferenças entre duas versões de MOBI arquivos e exportar para um documento final com um resumo detalhado das diferenças entre os documentos comparados."
...
steps:
    enable: true
    title: "Como comparar vários arquivos MOBI usando C#"
    content: |
      É possível usar [GroupDocs.Comparison](https://products.groupdocs.com/comparison/net/) para obter relatórios sobre diferenças em muitos MOBI arquivos.
      ...
      2. Forneça uma instância da classe Comparer com o caminho completo para o arquivo MOBI inicial
      3. Anexe pelo menos um outro MOBI ao Comparador
