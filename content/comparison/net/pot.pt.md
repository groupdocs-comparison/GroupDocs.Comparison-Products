...
############################# Head ############################
head_title: "Compare dois arquivos POT em .NET | APIs de comparação de documentos"
head_description: "Compare e mescle mais de dois arquivos POT em aplicativos C# .NET. Recupere resumos de diferenças em conteúdo, texto e estilo de POT arquivos, imagens e formatos de documentos."

############################# Header ############################
title: "Compare arquivos POT em C# .NET"
description: "API de comparação de documentos .NET para detectar as alterações entre duas versões de arquivos POT e exportar para um documento final com um resumo detalhado das diferenças entre os documentos comparados."
...
steps:
    enable: true
    title_left: "Etapas para comparar arquivos POT em C#"
    content_left: |
        [GroupDocs.Comparison](/comparison/net/) torna mais fácil para os desenvolvedores .NET comparar e mesclar vários arquivos POT em seus aplicativos, implementando algumas etapas fáceis.
    ...
    code: |
        ...
        using (Comparer comparer = new Comparer("source.pot"))
        {
            ...
            comparer.Compare("result.pot"); // Crie um arquivo de resultado com o nome especificado
        }
        ...
        using (Comparer comparer = new Comparer(File.OpenRead("source.pot")))
        {
            ...
            comparer.Compare(File.Create("result.pot")); // Crie um arquivo de resultado com o nome especificado
        }
        ```
...
demos:
    enable: true
    title: "Demonstrações ao vivo de comparação de arquivos POT"
    content: |
        Detecte diferenças entre arquivos POT agora mesmo visitando o site [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-pot"
          title: "Sobre o formato de arquivo POT"
          content: |
            Arquivos com extensão .POT representam arquivos de modelo do Microsoft PowerPoint criados pelas versões do PowerPoint 97-2003. Os arquivos criados com essas versões do Microsoft PowerPoint estão em formato binário em comparação com aqueles criados nos formatos de arquivo Office OpenXML usando versões superiores do PowerPoint. Os arquivos, portanto, gerados podem ser utilizados para criar apresentações que possuam o mesmo layout e outras configurações necessárias para serem aplicadas a novos arquivos. Essas configurações podem incluir estilos, planos de fundo, paleta de cores, fontes e padrões. Esses arquivos são gerados para criar arquivos de modelo prontos para uso oficial.
