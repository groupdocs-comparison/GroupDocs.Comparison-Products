...
head_description: "Compare e mescle mais de dois arquivos POT em aplicativos C# .NET. Recupere o resumo das diferenças no conteúdo, texto e estilo de POT arquivos, imagens e formatos de documento."

############################# Header ############################
title: "Comparar arquivos POT em C# .NET"
...
steps:
    ...
    code: |
        ...
        using (Comparer comparer = new Comparer("source.pot"))
        {
            ...
            comparer.Compare("result.pot"); // Cria arquivo de resultado com o nome especificado
        }
        ...
        using (Comparer comparer = new Comparer(File.OpenRead("source.pot")))
        {
            ...
            comparer.Compare(File.Create("result.pot")); // Cria arquivo de resultado com o nome especificado
        }
        ```
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-pot"
          ...
          content: |
            Arquivos com extensão .POT representam arquivos de modelo do Microsoft PowerPoint criados por versões do PowerPoint 97-2003. Os arquivos criados com essas versões do Microsoft PowerPoint estão em formato binário em comparação com aqueles criados nos formatos de arquivo Office OpenXML usando as versões superiores do PowerPoint. Os arquivos, portanto, gerados podem ser usados ​​para criar apresentações que tenham o mesmo layout e outras configurações necessárias para serem aplicadas a novos arquivos. Essas configurações podem incluir estilos, planos de fundo, paleta de cores, fontes e padrões. Esses arquivos são gerados para criar arquivos de modelo prontos para uso para uso oficial.
