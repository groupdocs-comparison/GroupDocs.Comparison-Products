...
head_description: "Compare e mescle mais de dois arquivos JPG em aplicativos C# .NET. Recupere o resumo das diferenças no conteúdo, texto e estilo de JPG arquivos, imagens e formatos de documento."

############################# Header ############################
title: "Comparar arquivos JPG em C# .NET"
...
steps:
    ...
    code: |
        ...
        using (Comparer comparer = new Comparer("source.jpg"))
        {
            ...
            comparer.Compare("result.jpg"); // Cria arquivo de resultado com o nome especificado
        }
        ...
        using (Comparer comparer = new Comparer(File.OpenRead("source.jpg")))
        {
            ...
            comparer.Compare(File.Create("result.jpg")); // Cria arquivo de resultado com o nome especificado
        }
        ```
