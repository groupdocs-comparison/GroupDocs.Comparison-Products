...
head_description: "Compare e mescle mais de dois arquivos MHT em aplicativos C# .NET. Recupere o resumo das diferenças no conteúdo, texto e estilo de MHT arquivos, imagens e formatos de documento."

############################# Header ############################
title: "Comparar arquivos MHT em C# .NET"
...
steps:
    ...
    code: |
        ...
        using (Comparer comparer = new Comparer("source.mht"))
        {
            ...
            comparer.Compare("result.mht"); // Cria arquivo de resultado com o nome especificado
        }
        ...
        using (Comparer comparer = new Comparer(File.OpenRead("source.mht")))
        {
            ...
            comparer.Compare(File.Create("result.mht")); // Cria arquivo de resultado com o nome especificado
        }
        ```
