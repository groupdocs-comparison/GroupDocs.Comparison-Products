...
############################# Head ############################
head_title: "Bandingkan file ONE dengan C# Perangkat Lunak Perbandingan"
head_description: "Bandingkan dan gabungkan ONE file dalam aplikasi C# .NET. Ambil ringkasan perbedaan dalam konten, teks & gaya."

############################# Header ############################
title: "Bandingkan ONE di C# .NET" 
description: ".NET dokumen API perbandingan untuk memeriksa perbedaan antara dua versi file ONE dan mengekspor ke dokumen akhir dengan ringkasan terperinci tentang perbedaan antara dokumen yang dibandingkan."
...
steps:
    enable: true
    title: "Cara membandingkan beberapa ONE file menggunakan C#"
    content: |
      Dimungkinkan untuk menggunakan [GroupDocs.Comparison](https://products.groupdocs.com/comparison/net/) untuk mendapatkan laporan tentang perbedaan di banyak file ONE.
      ...
      2. Berikan instance kelas Comparer dengan path lengkap ke file awal ONE
      3. Tambahkan setidaknya satu ONE lainnya ke Comparer
