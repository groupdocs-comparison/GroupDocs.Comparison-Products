...
head_description: "Bandingkan dan gabungkan lebih dari dua (file ONE dalam aplikasi C# .NET. Dapatkan ringkasan perbedaan dalam konten, teks & gaya file ONE, gambar, dan format dokumen."

############################# Header ############################
title: "Bandingkan File ONE di C# .NET"
description: ".API perbandingan dokumen .NET untuk mendeteksi perubahan antara dua versi file ONE dan mengekspor ke dokumen akhir dengan ringkasan terperinci tentang perbedaan antara dokumen yang dibandingkan."
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Membandingkan File ONE di C#"
    content_left: |
        [GroupDocs.Comparison](/id/comparison/net/) memudahkan pengembang .NET untuk membandingkan & menggabungkan beberapa file ONE dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
    ...
    code: |
        ...
        using (Comparer comparer = new Comparer(File.OpenRead("source.one"))
        {
            ...
            comparer.Compare(File.Create("result.one"));
        }
        ```
...
demos:
    ...
    content: |
        Deteksi perbedaan antara file ONE sekarang juga dengan mengunjungi situs web [GroupDocs.Comparison](https://products.groupdocs.app/comparison/family). Demo langsung memiliki manfaat sebagai berikut.
