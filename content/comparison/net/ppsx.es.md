...
############################# Head ############################
head_title: "Compara dos archivos PPSX en .NET | API de comparación de documentos"
head_description: "Compare y combine más de dos archivos PPSX en aplicaciones C# .NET. Recupere un resumen de diferencias en contenido, texto y estilo de PPSX archivos, imágenes y formatos de documentos."

############################# Header ############################
title: "Comparar archivos PPSX en C# .NET"
description: "API de comparación de documentos .NET para detectar los cambios entre dos versiones de archivos PPSX y exportarlos a un documento final con un resumen detallado de las diferencias entre los documentos comparados."
...
steps:
    enable: true
    title_left: "Pasos para comparar archivos PPSX en C#"
    content_left: |
        [GroupDocs.Comparison](/comparison/net/) facilita a los desarrolladores .NET comparar y fusionar múltiples archivos PPSX en sus aplicaciones implementando unos sencillos pasos.
    ...
    code: |
        ...
        using (Comparer comparer = new Comparer("source.ppsx"))
        {
            ...
            comparer.Compare("result.ppsx"); // Crear archivo de resultados con el nombre especificado
        }
        ...
        using (Comparer comparer = new Comparer(File.OpenRead("source.ppsx")))
        {
            ...
            comparer.Compare(File.Create("result.ppsx")); // Crear archivo de resultados con el nombre especificado
        }
        ```
...
demos:
    enable: true
    title: "Demostraciones en vivo de comparación de archivos PPSX"
    content: |
        Detecte diferencias entre archivos PPSX ahora mismo visitando el sitio web [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-ppsx"
          ...
          content: |
            Los archivos PPSX, presentación de diapositivas de Power Point, se crean utilizando Microsoft PowerPoint 2007 y superior para fines de presentación de diapositivas. Es una actualización del formato de archivo PPS compatible con las versiones de Microsoft PowerPoint 97-2003. Cuando un archivo PPSX se comparte con otro usuario y se abre, comienza como una presentación de PowerPoint, a diferencia del archivo PPTX que se abre en modo editable. La secuencia de presentación de diapositivas es la misma que en la presentación original. Todas las diapositivas acompañan a las imágenes, los sonidos y otros medios integrados acompañan a las diapositivas de la presentación en el PPSX durante la presentación de diapositivas.
