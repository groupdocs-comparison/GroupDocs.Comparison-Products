...
############################# Head ############################
head_title: "Comparez deux fichiers JS dans .NET | API de comparaison de documents"
head_description: "Comparez et fusionnez plus de deux fichiers JS dans des applications C# .NET. Récupérez le résumé des différences dans le contenu, le texte et le style des fichiers, images et formats de documents JS."

############################# Header ############################
title: "Comparez les fichiers JS en C# .NET"
description: "API de comparaison de documents .NET pour détecter les modifications entre deux versions de fichiers JS et exporter vers un document final avec un résumé détaillé des différences entre les documents comparés."
...
steps:
    enable: true
    title_left: "Étapes pour comparer les fichiers JS en C#"
    content_left: |
        [GroupDocs.Comparison](/comparison/net/) permet aux développeurs .NET de comparer et de fusionner facilement plusieurs fichiers JS dans leurs applications en implémentant quelques étapes simples.
    ...
    code: |
        ...
        using (Comparer comparer = new Comparer("source.js"))
        {
            ...
            comparer.Compare("result.js"); // Créer un fichier de résultats avec le nom spécifié
        }
        ...
        using (Comparer comparer = new Comparer(File.OpenRead("source.js")))
        {
            ...
            comparer.Compare(File.Create("result.js")); // Créer un fichier de résultats avec le nom spécifié
        }
        ```
...
demos:
    enable: true
    title: "Démonstrations en direct de comparaison de fichiers JS"
    content: |
        Détectez dès maintenant les différences entre les fichiers JS en visitant le site Web [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
...
about_formats:
    ...
    format:
        # format loop
        - icon: "far fa-file-js"
          title: "À propos du format de fichier JS"
          content: |
            JS (JavaScript) sont des fichiers contenant du code JavaScript à exécuter sur des pages Web. Les fichiers JavaScript sont stockés avec l'extension .js. Dans le document HTML, vous pouvez soit intégrer le code JavaScript à l'aide des balises, soit inclure un fichier JS. Semblables aux fichiers CSS, les fichiers JS peuvent être inclus dans plusieurs documents HTML pour faciliter la réutilisation du code. JavaScript peut être utilisé pour manipuler le DOM HTML.
