...
head_description: "Сравните и объедините более двух файлов ODT в приложениях C# .NET. Получите сводку о различиях в содержимом, тексте и стиле файлов ODT, изображениях и форматах документов."
