...
############################# Head ############################
head_title: "Compare dois arquivos PHP em .NET | APIs de comparação de documentos"
head_description: "Compare e mescle mais de dois arquivos PHP em aplicativos C# .NET. Recupere resumos de diferenças em conteúdo, texto e estilo de PHP arquivos, imagens e formatos de documentos."

############################# Header ############################
title: "Compare arquivos PHP em C# .NET"
description: "API de comparação de documentos .NET para detectar as alterações entre duas versões de arquivos PHP e exportar para um documento final com um resumo detalhado das diferenças entre os documentos comparados."
...
steps:
    enable: true
    title_left: "Etapas para comparar arquivos PHP em C#"
    content_left: |
        [GroupDocs.Comparison](/comparison/net/) torna mais fácil para os desenvolvedores .NET comparar e mesclar vários arquivos PHP em seus aplicativos, implementando algumas etapas fáceis.
    ...
    code: |
        ...
        using (Comparer comparer = new Comparer("source.php"))
        {
            ...
            comparer.Compare("result.php"); // Crie um arquivo de resultado com o nome especificado
        }
        ...
        using (Comparer comparer = new Comparer(File.OpenRead("source.php")))
        {
            ...
            comparer.Compare(File.Create("result.php")); // Crie um arquivo de resultado com o nome especificado
        }
        ```
...
demos:
    enable: true
    title: "Demonstrações ao vivo de comparação de arquivos PHP"
    content: |
        Detecte diferenças entre arquivos PHP agora mesmo visitando o site [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-php"
          title: "Sobre o formato de arquivo PHP"
          content: |
            Um arquivo com extensão .php refere-se à linguagem de programação de código aberto usada para escrever scripts do lado do servidor para serem executados no servidor. É a linguagem de script da web mais popular e poderosa, amplamente usada para o desenvolvimento de aplicativos da web em grande escala. PHP está no centro do maior sistema de blog da web, ou seja, WordPress, e administra a maior rede social Facebook. Ele roda em várias plataformas, como Windows, Linux, Unix, Mac OS X, etc. e é compatível com quase todos os servidores usados ​​​​hoje, ou seja, Apache, IIS, etc. PHP suporta uma ampla variedade de bancos de dados, incluindo MySQL.
