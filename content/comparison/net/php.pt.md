...
head_description: "Compare e mescle mais de dois arquivos PHP em aplicativos C# .NET. Recupere o resumo das diferenças no conteúdo, texto e estilo de PHP arquivos, imagens e formatos de documento."

############################# Header ############################
title: "Comparar arquivos PHP em C# .NET"
...
steps:
    ...
    code: |
        ...
        using (Comparer comparer = new Comparer("source.php"))
        {
            ...
            comparer.Compare("result.php"); // Cria arquivo de resultado com o nome especificado
        }
        ...
        using (Comparer comparer = new Comparer(File.OpenRead("source.php")))
        {
            ...
            comparer.Compare(File.Create("result.php")); // Cria arquivo de resultado com o nome especificado
        }
        ```
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-php"
          ...
          content: |
            Um arquivo com extensão .php refere-se à linguagem de programação de código aberto usada para escrever scripts do lado do servidor a serem executados no servidor. É a linguagem de script da Web mais popular e poderosa, amplamente utilizada para o desenvolvimento de aplicativos da Web em larga escala. PHP está no centro do maior sistema de blogging na web, ou seja, WordPress e executa a maior rede social Facebook. Ele roda em várias plataformas, como Windows, Linux, Unix, Mac OS X, etc. e é compatível com quase todos os servidores usados ​​hoje, como Apache, IIS, etc.
