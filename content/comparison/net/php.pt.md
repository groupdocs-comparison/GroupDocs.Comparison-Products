...
############################# Head ############################
head_title: "Compare arquivos PHP com o software de comparação C#"
head_description: "Compare e mescle PHP arquivos em C# .NET aplicativos. Recupere o resumo das diferenças em conteúdo, texto e estilo."

############################# Header ############################
title: "Comparar PHP em C# .NET" 
description: "API de comparação de documentos .NET para verificar diferenças entre duas versões de PHP arquivos e exportar para um documento final com um resumo detalhado das diferenças entre os documentos comparados."
...
steps:
    enable: true
    title: "Como comparar vários arquivos PHP usando C#"
    content: |
      É possível usar [GroupDocs.Comparison](https://products.groupdocs.com/comparison/net/) para obter relatórios sobre diferenças em muitos PHP arquivos.
      ...
      2. Forneça uma instância da classe Comparer com o caminho completo para o arquivo PHP inicial
      3. Anexe pelo menos um outro PHP ao Comparador
