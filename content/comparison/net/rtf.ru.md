...
head_description: "Сравните и объедините более двух файлов RTF в приложениях C# .NET. Получите сводку о различиях в содержимом, тексте и стиле файлов RTF, изображениях и форматах документов."
