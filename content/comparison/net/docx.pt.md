...
head_description: "Compare e mescle mais de dois arquivos DOCX em aplicativos C# .NET. Recupere o resumo das diferenças no conteúdo, texto e estilo de DOCX arquivos, imagens e formatos de documento."

############################# Header ############################
title: "Comparar arquivos DOCX em C# .NET"
...
steps:
    ...
    code: |
        ...
        using (Comparer comparer = new Comparer("source.docx"))
        {
            ...
            comparer.Compare("result.docx"); // Cria arquivo de resultado com o nome especificado
        }
        ...
        using (Comparer comparer = new Comparer(File.OpenRead("source.docx")))
        {
            ...
            comparer.Compare(File.Create("result.docx")); // Cria arquivo de resultado com o nome especificado
        }
        ```
