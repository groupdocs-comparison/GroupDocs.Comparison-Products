...
############################# Head ############################
head_title: "Compare dois arquivos CS em .NET | APIs de comparação de documentos"
head_description: "Compare e mescle mais de dois arquivos CS em aplicativos C# .NET. Recupere o resumo das diferenças no conteúdo, texto e estilo de CS arquivos, imagens e formatos de documento."

############################# Header ############################
title: "Comparar arquivos CS em C# .NET"
description: "API de comparação de documentos .NET para detectar as alterações entre duas versões de arquivos CS e exportar para um documento final com um resumo detalhado das diferenças entre os documentos comparados."
...
steps:
    enable: true
    title_left: "Etapas para comparar arquivos CS em C#"
    content_left: |
        [GroupDocs.Comparison](/comparison/net/) torna mais fácil para os desenvolvedores .NET comparar e mesclar vários arquivos CS em seus aplicativos implementando algumas etapas fáceis.
    ...
    code: |
        ...
        using (Comparer comparer = new Comparer("source.cs"))
        {
            ...
            comparer.Compare("result.cs"); // Cria arquivo de resultado com o nome especificado
        }
        ...
        using (Comparer comparer = new Comparer(File.OpenRead("source.cs")))
        {
            ...
            comparer.Compare(File.Create("result.cs")); // Cria arquivo de resultado com o nome especificado
        }
        ```
...
demos:
    enable: true
    title: "Demonstrações ao vivo de comparação de arquivos CS"
    content: |
        Detecte diferenças entre arquivos CS agora mesmo visitando o site [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
...
about_formats:
    ...
    format:
        # format loop
        - icon: "far fa-file-cs"
          title: "Sobre o formato de arquivo CS"
          content: |
            Arquivos com extensão .CS são arquivos de código-fonte para a linguagem de programação C#. Introduzido pela Microsoft para uso com o .NET Framework, o formato de arquivo fornece a linguagem de programação de baixo nível para escrever código que é compilado para gerar o arquivo de saída final na forma de EXE ou DLL. Estes podem ser criados e compilados com o Microsoft Visual Studio. O Microsoft Visual Studio Express também pode ser usado para criar e atualizar esses arquivos, que é um IDE gratuito. Os arquivos CS são usados ​​para o desenvolvimento de aplicativos que podem variar de aplicativos de desktop simples a programas mais complexos. Uma solução de projeto simples do Visual Studio criada com a linguagem C# pode ser composta por um ou mais desses arquivos. Os arquivos marcados para inclusão na compilação são listados no arquivo CSPROJ que faz parte do projeto e informa ao compilador para usar os arquivos marcados.
