...
head_description: "Compare e mescle mais de dois arquivos PDF em aplicativos C# .NET. Recupere o resumo das diferenças no conteúdo, texto e estilo de PDF arquivos, imagens e formatos de documento."

############################# Header ############################
title: "Comparar arquivos PDF em C# .NET"
...
steps:
    ...
    code: |
        ...
        using (Comparer comparer = new Comparer("source.pdf"))
        {
            ...
            comparer.Compare("result.pdf"); // Cria arquivo de resultado com o nome especificado
        }
        ...
        using (Comparer comparer = new Comparer(File.OpenRead("source.pdf")))
        {
            ...
            comparer.Compare(File.Create("result.pdf")); // Cria arquivo de resultado com o nome especificado
        }
        ```
