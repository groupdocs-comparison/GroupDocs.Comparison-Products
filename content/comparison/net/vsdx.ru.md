...
head_description: "Сравните и объедините более двух файлов VSDX в приложениях C# .NET. Получите сводку о различиях в содержимом, тексте и стиле файлов VSDX, изображениях и форматах документов."
