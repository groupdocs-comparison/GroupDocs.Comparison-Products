...
############################# Head ############################
head_title: "Compare dois arquivos PY em .NET | APIs de comparação de documentos"
head_description: "Compare e mescle mais de dois arquivos PY em aplicativos C# .NET. Recupere o resumo das diferenças no conteúdo, texto e estilo de PY arquivos, imagens e formatos de documento."

############################# Header ############################
title: "Comparar arquivos PY em C# .NET"
description: "API de comparação de documentos .NET para detectar as alterações entre duas versões de arquivos PY e exportar para um documento final com um resumo detalhado das diferenças entre os documentos comparados."
...
steps:
    enable: true
    title_left: "Etapas para comparar arquivos PY em C#"
    content_left: |
        [GroupDocs.Comparison](/comparison/net/) torna mais fácil para os desenvolvedores .NET comparar e mesclar vários arquivos PY em seus aplicativos implementando algumas etapas fáceis.
    ...
    code: |
        ...
        using (Comparer comparer = new Comparer("source.py"))
        {
            ...
            comparer.Compare("result.py"); // Cria arquivo de resultado com o nome especificado
        }
        ...
        using (Comparer comparer = new Comparer(File.OpenRead("source.py")))
        {
            ...
            comparer.Compare(File.Create("result.py")); // Cria arquivo de resultado com o nome especificado
        }
        ```
...
demos:
    enable: true
    title: "Demonstrações ao vivo de comparação de arquivos PY"
    content: |
        Detecte diferenças entre arquivos PY agora mesmo visitando o site [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
...
about_formats:
    ...
    format:
        # format loop
        - icon: "far fa-file-py"
          title: "Sobre o formato de arquivo PY"
          content: |
            Arquivos com a extensão .py contêm o código-fonte python. É uma linguagem muito popular que pode ser usada para desenvolvimento web, desenvolvimento de software, matemática e scripts de sistema. Python é uma linguagem de plataforma cruzada que pode funcionar em diferentes plataformas como Windows, MAC, Linux, Raspberry Pi, etc. Python fornece uma sintaxe simples semelhante à língua inglesa e é mais fácil de ler. A sintaxe do Python permite que programas sejam escritos com menos linhas de código. O Python é executado em um sistema interpretador para que o código possa ser executado assim que for escrito, o que o torna muito bom para prototipagem.
