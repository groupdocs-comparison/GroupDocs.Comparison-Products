...
############################# Head ############################
head_title: "Confronta due file POTX in .NET | API di confronto dei documenti"
head_description: "Confronta e unisci più di due file POTX nelle applicazioni C# .NET. Recupera il riepilogo delle differenze nel contenuto, nel testo e nello stile di file, immagini e formati di documenti POTX."

############################# Header ############################
title: "Confronta i file POTX in C# .NET"
description: "API di confronto dei documenti .NET per rilevare le modifiche tra due versioni di file POTX ed esportarle in un documento finale con un riepilogo dettagliato delle differenze tra i documenti confrontati."
...
steps:
    enable: true
    title_left: "Passaggi per confrontare i file POTX in C#"
    content_left: |
        [GroupDocs.Comparison](/comparison/net/) semplifica agli sviluppatori .NET il confronto e l'unione di più file POTX nelle loro applicazioni implementando alcuni semplici passaggi.
    ...
    code: |
        ...
        using (Comparer comparer = new Comparer("source.potx"))
        {
            ...
            comparer.Compare("result.potx"); // Crea il file dei risultati con il nome specificato
        }
        ...
        using (Comparer comparer = new Comparer(File.OpenRead("source.potx")))
        {
            ...
            comparer.Compare(File.Create("result.potx")); // Crea il file dei risultati con il nome specificato
        }
        ```
...
demos:
    enable: true
    title: "Demo dal vivo del confronto di file POTX"
    content: |
        Rileva subito le differenze tra i file POTX visitando il sito web [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-potx"
          ...
          content: |
            I file con estensione .POTX rappresentano presentazioni modello Microsoft PowerPoint create con Microsoft PowerPoint 2007 e versioni successive. Questo formato è stato creato per sostituire il formato file POT basato sul formato file binario ed è supportato con PowerPoint 97-2003. I file generati possono essere utilizzati per creare presentazioni con lo stesso layout e altre impostazioni necessarie per essere applicate a nuovi file. Queste impostazioni possono includere stili, sfondi, tavolozza dei colori, caratteri e impostazioni predefinite. Tali file vengono generati per creare file modello pronti all'uso per uso ufficiale.
...
solutions:
    ...
    solution:
        # solution loop
        - img_alt: "GroupDocs.Comparison for Java POTX"
