...
head_description: "Compare e mescle mais de dois arquivos XLSM em aplicativos C# .NET. Recupere o resumo das diferenças no conteúdo, texto e estilo de XLSM arquivos, imagens e formatos de documento."

############################# Header ############################
title: "Comparar arquivos XLSM em C# .NET"
...
steps:
    ...
    code: |
        ...
        using (Comparer comparer = new Comparer("source.xlsm"))
        {
            ...
            comparer.Compare("result.xlsm"); // Cria arquivo de resultado com o nome especificado
        }
        ...
        using (Comparer comparer = new Comparer(File.OpenRead("source.xlsm")))
        {
            ...
            comparer.Compare(File.Create("result.xlsm")); // Cria arquivo de resultado com o nome especificado
        }
        ```
