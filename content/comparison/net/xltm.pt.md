...
############################# Head ############################
head_title: "Compare dois arquivos XLTM em .NET | APIs de comparação de documentos"
head_description: "Compare e mescle mais de dois arquivos XLTM em aplicativos C# .NET. Recupere o resumo das diferenças no conteúdo, texto e estilo de XLTM arquivos, imagens e formatos de documento."

############################# Header ############################
title: "Comparar arquivos XLTM em C# .NET"
description: "API de comparação de documentos .NET para detectar as alterações entre duas versões de arquivos XLTM e exportar para um documento final com um resumo detalhado das diferenças entre os documentos comparados."
...
steps:
    enable: true
    title_left: "Etapas para comparar arquivos XLTM em C#"
    content_left: |
        [GroupDocs.Comparison](/comparison/net/) torna mais fácil para os desenvolvedores .NET comparar e mesclar vários arquivos XLTM em seus aplicativos implementando algumas etapas fáceis.
    ...
    code: |
        ...
        using (Comparer comparer = new Comparer("source.xltm"))
        {
        	comparer.Add("target1.xltm");
            comparer.Add("target2.xltm");
            comparer.Add("target3.xltm");
            comparer.Compare("result.xltm"); // Cria arquivo de resultado com o nome especificado
        }
        ...
        using (Comparer comparer = new Comparer(File.OpenRead("source.xltm")))
        {
            ...
            comparer.Compare(File.Create("result.xltm")); // Cria arquivo de resultado com o nome especificado
        }
        ```
...
demos:
    enable: true
    title: "Demonstrações ao vivo de comparação de arquivos XLTM"
    content: |
        Detecte diferenças entre arquivos XLTM agora mesmo visitando o site [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-xltm"
          title: "Sobre o formato de arquivo XLTM"
          content: |
            A extensão de arquivo XLTM representa arquivos gerados pelo Microsoft Excel como arquivos de modelo habilitados para macro. Os arquivos XLTM são semelhantes ao XLTX em estrutura, exceto que o último não oferece suporte à criação de arquivos de modelo com macros. Esses arquivos de modelo são usados ​​para gerar e definir o layout, formatação e outras configurações junto com as macros para facilitar a criação de arquivos XLSX semelhantes.
          link: "https://docs.fileformat.com/image/xltm/"
...
solutions:
    ...
    solution:
        # solution loop
        - img_alt: "GroupDocs.Comparison for Java XLTM"
