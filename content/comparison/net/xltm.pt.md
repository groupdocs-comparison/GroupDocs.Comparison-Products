...
head_description: "Compare e mescle mais de dois arquivos XLTM em aplicativos C# .NET. Recupere resumos de diferenças em conteúdo, texto e estilo de XLTM arquivos, imagens e formatos de documentos."

############################# Header ############################
title: "Compare arquivos XLTM em C# .NET"
...
steps:
    ...
    code: |
        ...
        using (Comparer comparer = new Comparer("source.xltm"))
        {
            ...
            comparer.Compare("result.xltm"); // Crie um arquivo de resultado com o nome especificado
        }
        ...
        using (Comparer comparer = new Comparer(File.OpenRead("source.xltm")))
        {
            ...
            comparer.Compare(File.Create("result.xltm")); // Crie um arquivo de resultado com o nome especificado
        }
        ```
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-xltm"
          ...
          content: |
            A extensão de arquivo XLTM representa arquivos gerados pelo Microsoft Excel como arquivos de modelo habilitados para macro. Os arquivos XLTM são semelhantes aos XLTX em estrutura, exceto que este último não suporta a criação de arquivos de modelo com macros. Esses arquivos de modelo são usados ​​para gerar e definir o layout, a formatação e outras configurações junto com as macros para facilitar a criação de arquivos XLSX semelhantes.
