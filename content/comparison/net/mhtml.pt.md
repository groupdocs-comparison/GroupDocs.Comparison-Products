...
head_description: "Compare e mescle mais de dois arquivos MHTML em aplicativos C# .NET. Recupere o resumo das diferenças no conteúdo, texto e estilo de MHTML arquivos, imagens e formatos de documento."

############################# Header ############################
title: "Comparar arquivos MHTML em C# .NET"
...
steps:
    ...
    code: |
        ...
        using (Comparer comparer = new Comparer("source.mhtml"))
        {
            ...
            comparer.Compare("result.mhtml"); // Cria arquivo de resultado com o nome especificado
        }
        ...
        using (Comparer comparer = new Comparer(File.OpenRead("source.mhtml")))
        {
            ...
            comparer.Compare(File.Create("result.mhtml")); // Cria arquivo de resultado com o nome especificado
        }
        ```
