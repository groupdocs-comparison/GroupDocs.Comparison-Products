...
############################# Head ############################
head_title: "Bandingkan dua file HTML di .NET | API Perbandingan Dokumen"
head_description: "Bandingkan dan gabungkan lebih dari dua file HTML dalam aplikasi C# .NET. Ambil ringkasan perbedaan dalam konten, teks & gaya file HTML, gambar dan format dokumen."

############################# Header ############################
title: "Bandingkan File HTML di C# .NET"
description: "API perbandingan dokumen .NET untuk mendeteksi perubahan antara dua versi file HTML dan mengekspor ke dokumen akhir dengan ringkasan mendetail tentang perbedaan antara dokumen yang dibandingkan."
...
steps:
    enable: true
    title_left: "Langkah-langkah Membandingkan File HTML di C#"
    content_left: |
        [GroupDocs.Comparison](/comparison/net/) memudahkan pengembang .NET untuk membandingkan & menggabungkan beberapa file HTML dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
    ...
    code: |
        ...
        using (Comparer comparer = new Comparer("source.html"))
        {
            ...
            comparer.Compare("result.html"); // Buat file hasil dengan nama yang ditentukan
        }
        ...
        using (Comparer comparer = new Comparer(File.OpenRead("source.html")))
        {
            ...
            comparer.Compare(File.Create("result.html")); // Buat file hasil dengan nama yang ditentukan
        }
        ```
...
demos:
    enable: true
    title: "Demo Langsung Membandingkan File HTML"
    content: |
        Deteksi perbedaan antara file HTML sekarang dengan mengunjungi situs web [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
