...
head_description: "Compare e mescle mais de dois arquivos OTT em aplicativos C# .NET. Recupere o resumo das diferenças no conteúdo, texto e estilo de OTT arquivos, imagens e formatos de documento."

############################# Header ############################
title: "Comparar arquivos OTT em C# .NET"
...
steps:
    ...
    code: |
        ...
        using (Comparer comparer = new Comparer("source.ott"))
        {
            ...
            comparer.Compare("result.ott"); // Cria arquivo de resultado com o nome especificado
        }
        ...
        using (Comparer comparer = new Comparer(File.OpenRead("source.ott")))
        {
            ...
            comparer.Compare(File.Create("result.ott")); // Cria arquivo de resultado com o nome especificado
        }
        ```
