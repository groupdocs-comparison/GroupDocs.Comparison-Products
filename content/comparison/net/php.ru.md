...
############################# Head ############################
head_title: "Сравните два файла PHP в .NET | API-интерфейсы сравнения документов"
head_description: "Сравнивайте и объединяйте более двух файлов PHP в приложениях C# .NET. Получите сводную информацию о различиях в содержании, тексте и стиле файлов, изображений и форматов документов PHP."

############################# Header ############################
title: "Сравнить файлы PHP в C# .NET"
description: "API сравнения документов .NET для обнаружения изменений между двумя версиями файлов PHP и экспорта в окончательный документ с подробным описанием различий между сравниваемыми документами."
...
steps:
    enable: true
    title_left: "Действия по сравнению файлов PHP в C#"
    content_left: |
        [GroupDocs.Comparison](/comparison/net/) позволяет разработчикам .NET сравнивать и объединять несколько файлов PHP в своих приложениях, выполнив несколько простых шагов.
    ...
    code: |
        ...
        using (Comparer comparer = new Comparer("source.php"))
        {
            ...
            comparer.Compare("result.php"); // Создать файл результатов с указанным именем
        }
        ...
        using (Comparer comparer = new Comparer(File.OpenRead("source.php")))
        {
            ...
            comparer.Compare(File.Create("result.php")); // Создать файл результатов с указанным именем
        }
        ```
...
demos:
    enable: true
    title: "Живые демонстрации сравнения файлов PHP"
    content: |
        Обнаружьте различия между файлами PHP прямо сейчас, посетив веб-сайт [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-php"
          title: "О формате файла PHP"
          content: |
            Файл с расширением .php относится к языку программирования с открытым исходным кодом, который используется для написания серверных сценариев, которые будут выполняться на сервере. Это самый популярный и мощный язык веб-скриптов, который широко используется для разработки крупномасштабных веб-приложений. PHP лежит в основе крупнейшей системы блогов в Интернете, то есть WordPress, и управляет крупнейшей социальной сетью Facebook. Он работает на различных платформах, таких как Windows, Linux, Unix, Mac OS X и т. д., и совместим практически со всеми серверами, используемыми сегодня, например, Apache, IIS и т. д. PHP поддерживает широкий спектр баз данных, включая MySQL.
