...
############################# Head ############################
head_title: "Comparez deux fichiers DOTM dans .NET | API de comparaison de documents"
head_description: "Comparez et fusionnez plus de deux fichiers DOTM dans des applications C# .NET. Récupérez le résumé des différences dans le contenu, le texte et le style des fichiers, images et formats de documents DOTM."

############################# Header ############################
title: "Comparez les fichiers DOTM en C# .NET"
description: "API de comparaison de documents .NET pour détecter les modifications entre deux versions de fichiers DOTM et exporter vers un document final avec un résumé détaillé des différences entre les documents comparés."
...
steps:
    enable: true
    title_left: "Étapes pour comparer les fichiers DOTM en C#"
    content_left: |
        [GroupDocs.Comparison](/comparison/net/) permet aux développeurs .NET de comparer et de fusionner facilement plusieurs fichiers DOTM dans leurs applications en implémentant quelques étapes simples.
    ...
    code: |
        ...
        using (Comparer comparer = new Comparer("source.dotm"))
        {
            ...
            comparer.Compare("result.dotm"); // Créer un fichier de résultats avec le nom spécifié
        }
        ...
        using (Comparer comparer = new Comparer(File.OpenRead("source.dotm")))
        {
            ...
            comparer.Compare(File.Create("result.dotm")); // Créer un fichier de résultats avec le nom spécifié
        }
        ```
...
demos:
    enable: true
    title: "Démonstrations en direct de comparaison de fichiers DOTM"
    content: |
        Détectez dès maintenant les différences entre les fichiers DOTM en visitant le site Web [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-dotm"
          title: "À propos du format de fichier DOTM"
          content: |
            Un fichier avec l'extension DOTM représente un fichier modèle créé avec Microsoft Word 2007 ou supérieur. Il est similaire au format de fichier DOCX populaire, à la différence qu'il conserve les paramètres définis par l'utilisateur pour les réutiliser en cas de création de nouveaux documents. Ces documents sont plus souvent utilisés dans les bureaux où un fichier modèle standard est généré avec des paramètres tels que les informations de page, les marges, la mise en page par défaut et les macros, et est utilisé pour créer de nouveaux documents à partir de celui-ci lorsque cela est nécessaire. Les fichiers DOTM, cependant, enregistrent des macros, qui sont une série de commandes sous la forme d'actions enregistrées pour l'exécution automatique d'une tâche. Cela permet de gagner du temps lors de l'exécution d'actions répétées à l'issue d'une tâche.
