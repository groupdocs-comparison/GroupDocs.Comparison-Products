...
############################# Head ############################
head_title: "SQL Dateien mit C# Vergleichssoftware vergleichen"
head_description: "Vergleichen und führen Sie SQL Dateien in C# .NET Anwendungen zusammen. Rufen Sie eine Zusammenfassung der Unterschiede in Inhalt, Text und Stil ab."

############################# Header ############################
title: "Vergleiche SQL in C# .NET" 
description: ".NET API zum Vergleich von Dokumenten, um nach Unterschieden zwischen zwei Versionen von SQL Dateien zu suchen und in ein endgültiges Dokument mit einer detaillierten Zusammenfassung der Unterschiede zwischen den verglichenen Dokumenten zu exportieren."
...
steps:
    enable: true
    title: "So vergleichen Sie mehrere SQL Dateien mit C#"
    content: |
      Es ist möglich, [GroupDocs.Comparison](https://products.groupdocs.com/comparison/net/) zu verwenden, um Berichte über Unterschiede in vielen SQL Dateien zu erhalten.
      ...
      2. Geben Sie eine Instanz der Comparer-Klasse mit dem vollständigen Pfad zur ursprünglichen SQL -Datei an
      3. Hängen Sie mindestens ein weiteres SQL an Comparer an
    ...
    code:
      ...
      content: |
        ...
        using (Comparer comparer = new Comparer("main_document.sql"))
        {
            // Andere Dateien hinzufügen
        	comparer.Add("modified_1.sql");
            comparer.Add("modified_2.sql");

            // Ruft die Ergebnisdatei mit dem angegebenen Namen ab
            comparer.Compare("report.sql"); 
        }
