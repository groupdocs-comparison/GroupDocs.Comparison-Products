...
head_description: "Compare e mescle mais de dois arquivos VSD em aplicativos C# .NET. Recupere o resumo das diferenças no conteúdo, texto e estilo de VSD arquivos, imagens e formatos de documento."

############################# Header ############################
title: "Comparar arquivos VSD em C# .NET"
...
steps:
    ...
    code: |
        ...
        using (Comparer comparer = new Comparer("source.vsd"))
        {
            ...
            comparer.Compare("result.vsd"); // Cria arquivo de resultado com o nome especificado
        }
        ...
        using (Comparer comparer = new Comparer(File.OpenRead("source.vsd")))
        {
            ...
            comparer.Compare(File.Create("result.vsd")); // Cria arquivo de resultado com o nome especificado
        }
        ```
