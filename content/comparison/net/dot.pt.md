...
head_description: "Compare e mescle mais de dois arquivos DOT em aplicativos C# .NET. Recupere o resumo das diferenças no conteúdo, texto e estilo de DOT arquivos, imagens e formatos de documento."

############################# Header ############################
title: "Comparar arquivos DOT em C# .NET"
...
steps:
    ...
    code: |
        ...
        using (Comparer comparer = new Comparer("source.dot"))
        {
            ...
            comparer.Compare("result.dot"); // Cria arquivo de resultado com o nome especificado
        }
        ...
        using (Comparer comparer = new Comparer(File.OpenRead("source.dot")))
        {
            ...
            comparer.Compare(File.Create("result.dot")); // Cria arquivo de resultado com o nome especificado
        }
        ```
