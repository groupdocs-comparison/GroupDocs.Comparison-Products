...
############################# Head ############################
head_title: "Bandingkan dua file CS di .NET | API Perbandingan Dokumen"
head_description: "Bandingkan dan gabungkan lebih dari dua file CS dalam aplikasi C# .NET. Ambil ringkasan perbedaan dalam konten, teks & gaya file CS, gambar dan format dokumen."

############################# Header ############################
title: "Bandingkan File CS di C# .NET"
description: "API perbandingan dokumen .NET untuk mendeteksi perubahan antara dua versi file CS dan mengekspor ke dokumen akhir dengan ringkasan mendetail tentang perbedaan antara dokumen yang dibandingkan."
...
steps:
    enable: true
    title_left: "Langkah-langkah Membandingkan File CS di C#"
    content_left: |
        [GroupDocs.Comparison](/comparison/net/) memudahkan pengembang .NET untuk membandingkan & menggabungkan beberapa file CS dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
    ...
    code: |
        ...
        using (Comparer comparer = new Comparer("source.cs"))
        {
            ...
            comparer.Compare("result.cs"); // Buat file hasil dengan nama yang ditentukan
        }
        ...
        using (Comparer comparer = new Comparer(File.OpenRead("source.cs")))
        {
            ...
            comparer.Compare(File.Create("result.cs")); // Buat file hasil dengan nama yang ditentukan
        }
        ```
...
demos:
    enable: true
    title: "Demo Langsung Membandingkan File CS"
    content: |
        Deteksi perbedaan antara file CS sekarang dengan mengunjungi situs web [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
...
about_formats:
    ...
    format:
        # format loop
        - icon: "far fa-file-cs"
          title: "Tentang Format File CS"
          content: |
            File dengan ekstensi .CS adalah file kode sumber untuk bahasa pemrograman C#. Diperkenalkan oleh Microsoft untuk digunakan dengan .NET Framework, format file menyediakan bahasa pemrograman tingkat rendah untuk menulis kode yang dikompilasi untuk menghasilkan file keluaran akhir dalam bentuk EXE atau DLL. Ini dapat dibuat dan dikompilasi dengan Microsoft Visual Studio. Microsoft Visual Studio Express juga dapat digunakan untuk membuat dan memperbarui file tersebut yang merupakan IDE gratis. File CS digunakan untuk pengembangan aplikasi mulai dari aplikasi desktop sederhana hingga program yang lebih kompleks. Solusi proyek Visual Studio sederhana yang dibuat dengan bahasa C# dapat terdiri dari satu atau lebih file tersebut. File yang ditandai untuk disertakan dalam kompilasi tercantum dalam file CSPROJ yang merupakan bagian dari proyek dan memberitahu kompiler untuk menggunakan file yang ditandai.
