...
head_description: "3つ以上を比較してマージします（C＃.NETアプリケーションのXLSXファイル。コンテンツ、テキスト、XLSXファイルのスタイル、画像、ドキュメント形式の違いの概要を取得します."

title: "C＃.NETでXLSXファイルを比較する"
description: ".XLSXファイルの2つのバージョン間の変更を検出し、比較されたドキュメント間の違いの詳細な要約を含む最終的なドキュメントにエクスポートするためのNETドキュメント比較API."
