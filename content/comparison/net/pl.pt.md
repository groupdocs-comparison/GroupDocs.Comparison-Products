...
head_description: "Compare e mescle mais de dois arquivos PL em aplicativos C# .NET. Recupere o resumo das diferenças no conteúdo, texto e estilo de PL arquivos, imagens e formatos de documento."

############################# Header ############################
title: "Comparar arquivos PL em C# .NET"
...
steps:
    ...
    code: |
        ...
        using (Comparer comparer = new Comparer("source.pl"))
        {
            ...
            comparer.Compare("result.pl"); // Cria arquivo de resultado com o nome especificado
        }
        ...
        using (Comparer comparer = new Comparer(File.OpenRead("source.pl")))
        {
            ...
            comparer.Compare(File.Create("result.pl")); // Cria arquivo de resultado com o nome especificado
        }
        ```
