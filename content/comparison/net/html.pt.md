...
head_description: "Compare e mescle mais de dois arquivos HTML em aplicativos C# .NET. Recupere o resumo das diferenças no conteúdo, texto e estilo de HTML arquivos, imagens e formatos de documento."

############################# Header ############################
title: "Comparar arquivos HTML em C# .NET"
...
steps:
    ...
    code: |
        ...
        using (Comparer comparer = new Comparer("source.html"))
        {
            ...
            comparer.Compare("result.html"); // Cria arquivo de resultado com o nome especificado
        }
        ...
        using (Comparer comparer = new Comparer(File.OpenRead("source.html")))
        {
            ...
            comparer.Compare(File.Create("result.html")); // Cria arquivo de resultado com o nome especificado
        }
        ```
