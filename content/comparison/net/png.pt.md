...
head_description: "Compare e mescle mais de dois arquivos PNG em aplicativos C# .NET. Recupere o resumo das diferenças no conteúdo, texto e estilo de PNG arquivos, imagens e formatos de documento."

############################# Header ############################
title: "Comparar arquivos PNG em C# .NET"
...
steps:
    ...
    code: |
        ...
        using (Comparer comparer = new Comparer("source.png"))
        {
            ...
            comparer.Compare("result.png"); // Cria arquivo de resultado com o nome especificado
        }
        ...
        using (Comparer comparer = new Comparer(File.OpenRead("source.png")))
        {
            ...
            comparer.Compare(File.Create("result.png")); // Cria arquivo de resultado com o nome especificado
        }
        ```
