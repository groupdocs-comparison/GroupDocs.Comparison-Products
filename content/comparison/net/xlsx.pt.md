...
head_description: "Compare e mescle mais de dois arquivos XLSX em aplicativos C# .NET. Recupere o resumo das diferenças no conteúdo, texto e estilo de XLSX arquivos, imagens e formatos de documento."

############################# Header ############################
title: "Comparar arquivos XLSX em C# .NET"
...
steps:
    ...
    code: |
        ...
        using (Comparer comparer = new Comparer("source.xlsx"))
        {
            ...
            comparer.Compare("result.xlsx"); // Cria arquivo de resultado com o nome especificado
        }
        ...
        using (Comparer comparer = new Comparer(File.OpenRead("source.xlsx")))
        {
            ...
            comparer.Compare(File.Create("result.xlsx")); // Cria arquivo de resultado com o nome especificado
        }
        ```
