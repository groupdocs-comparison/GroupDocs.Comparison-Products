...
############################# Head ############################
head_title: "Bandingkan file CSV dengan C# Perangkat Lunak Perbandingan"
head_description: "Bandingkan dan gabungkan CSV file dalam aplikasi C# .NET. Ambil ringkasan perbedaan dalam konten, teks & gaya."

############################# Header ############################
title: "Bandingkan CSV di C# .NET" 
description: ".NET dokumen API perbandingan untuk memeriksa perbedaan antara dua versi file CSV dan mengekspor ke dokumen akhir dengan ringkasan terperinci tentang perbedaan antara dokumen yang dibandingkan."
...
steps:
    enable: true
    title: "Cara membandingkan beberapa CSV file menggunakan C#"
    content: |
      Dimungkinkan untuk menggunakan [GroupDocs.Comparison](https://products.groupdocs.com/comparison/net/) untuk mendapatkan laporan tentang perbedaan di banyak file CSV.
      ...
      2. Berikan instance kelas Comparer dengan path lengkap ke file awal CSV
      3. Tambahkan setidaknya satu CSV lainnya ke Comparer
