...
############################# Head ############################
head_title: "Compare LOG archivos con el software de comparación C#"
head_description: "Compare y combine LOG archivos en aplicaciones C# .NET. Recupera el resumen de las diferencias en contenido, texto y estilo."

############################# Header ############################
title: "Compara LOG en C# .NET" 
description: ".NET API de comparación de documentos para comprobar si hay diferencias entre dos versiones de LOG archivos y exportarlos a un documento final con un resumen detallado de las diferencias entre los documentos comparados."
...
steps:
    enable: true
    title: "Cómo comparar varios archivos LOG con C#"
    content: |
      Es posible usar [GroupDocs.Comparison](https://products.groupdocs.com/comparison/net/) para obtener informes sobre las diferencias en muchos LOG archivos.
      ...
      2. Proporcione una instancia de la clase Comparer con la ruta completa al archivo inicial LOG
      3. Añada al menos otro LOG al comparador
