...
head_description: "Compare e mescle mais de dois arquivos ODP em aplicativos C# .NET. Recupere o resumo das diferenças no conteúdo, texto e estilo de ODP arquivos, imagens e formatos de documento."

############################# Header ############################
title: "Comparar arquivos ODP em C# .NET"
...
steps:
    ...
    code: |
        ...
        using (Comparer comparer = new Comparer("source.odp"))
        {
            ...
            comparer.Compare("result.odp"); // Cria arquivo de resultado com o nome especificado
        }
        ...
        using (Comparer comparer = new Comparer(File.OpenRead("source.odp")))
        {
            ...
            comparer.Compare(File.Create("result.odp")); // Cria arquivo de resultado com o nome especificado
        }
        ```
