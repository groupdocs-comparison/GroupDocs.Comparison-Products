...
head_description: "3つ以上を比較してマージします（C＃.NETアプリケーションのRBファイル。コンテンツ、テキスト、およびRBファイルのスタイル、画像、ドキュメント形式の違いの概要を取得します。"
...
steps:
    ...
    content_left: |
        [GroupDocs.Comparison](/Comparison/net/)を使用すると、.NET開発者は、いくつかの簡単な手順を実装することで、アプリケーション内の複数のRBファイルを簡単に比較およびマージできます。
