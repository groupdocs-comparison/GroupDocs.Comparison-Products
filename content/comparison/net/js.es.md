...
############################# Head ############################
head_title: "Compara dos archivos JS en .NET | API de comparación de documentos"
head_description: "Compare y combine más de dos archivos JS en aplicaciones C# .NET. Recupere un resumen de diferencias en contenido, texto y estilo de JS archivos, imágenes y formatos de documentos."

############################# Header ############################
title: "Comparar archivos JS en C# .NET"
description: "API de comparación de documentos .NET para detectar los cambios entre dos versiones de archivos JS y exportarlos a un documento final con un resumen detallado de las diferencias entre los documentos comparados."
...
steps:
    enable: true
    title_left: "Pasos para comparar archivos JS en C#"
    content_left: |
        [GroupDocs.Comparison](/comparison/net/) facilita a los desarrolladores .NET comparar y fusionar múltiples archivos JS en sus aplicaciones implementando unos sencillos pasos.
    ...
    code: |
        ...
        using (Comparer comparer = new Comparer("source.js"))
        {
            ...
            comparer.Compare("result.js"); // Crear archivo de resultados con el nombre especificado
        }
        ...
        using (Comparer comparer = new Comparer(File.OpenRead("source.js")))
        {
            ...
            comparer.Compare(File.Create("result.js")); // Crear archivo de resultados con el nombre especificado
        }
        ```
...
demos:
    enable: true
    title: "Demostraciones en vivo de comparación de archivos JS"
    content: |
        Detecte diferencias entre archivos JS ahora mismo visitando el sitio web [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
...
about_formats:
    ...
    format:
        # format loop
        - icon: "far fa-file-js"
          title: "Acerca del formato de archivo JS"
          content: |
            JS (JavaScript) son archivos que contienen código JavaScript para su ejecución en páginas web. Los archivos JavaScript se almacenan con la extensión .js. Dentro del documento HTML, puede incrustar el código JavaScript usando las etiquetas o incluir un archivo JS. Al igual que los archivos CSS, los archivos JS se pueden incluir en varios documentos HTML para reutilizar el código. JavaScript se puede utilizar para manipular el DOM HTML.
