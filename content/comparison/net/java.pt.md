...
############################# Head ############################
head_title: "Compare dois arquivos JAVA em .NET | APIs de comparação de documentos"
head_description: "Compare e mescle mais de dois arquivos JAVA em aplicativos C# .NET. Recupere resumos de diferenças em conteúdo, texto e estilo de JAVA arquivos, imagens e formatos de documentos."

############################# Header ############################
title: "Compare arquivos JAVA em C# .NET"
description: "API de comparação de documentos .NET para detectar as alterações entre duas versões de arquivos JAVA e exportar para um documento final com um resumo detalhado das diferenças entre os documentos comparados."
...
steps:
    enable: true
    title_left: "Etapas para comparar arquivos JAVA em C#"
    content_left: |
        [GroupDocs.Comparison](/comparison/net/) torna mais fácil para os desenvolvedores .NET comparar e mesclar vários arquivos JAVA em seus aplicativos, implementando algumas etapas fáceis.
    ...
    code: |
        ...
        using (Comparer comparer = new Comparer("source.java"))
        {
            ...
            comparer.Compare("result.java"); // Crie um arquivo de resultado com o nome especificado
        }
        ...
        using (Comparer comparer = new Comparer(File.OpenRead("source.java")))
        {
            ...
            comparer.Compare(File.Create("result.java")); // Crie um arquivo de resultado com o nome especificado
        }
        ```
...
demos:
    enable: true
    title: "Demonstrações ao vivo de comparação de arquivos JAVA"
    content: |
        Detecte diferenças entre arquivos JAVA agora mesmo visitando o site [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-java"
          title: "Sobre o formato de arquivo JAVA"
          content: |
            Java é uma linguagem orientada a objetos de uso geral que pode ser executada em múltiplas plataformas. O código-fonte Java está contido em um arquivo com extensão .java. Java é usado para o desenvolvimento de aplicativos móveis, aplicativos da web, aplicativos de desktop, jogos, etc. Java funciona em várias plataformas, incluindo Windows, Mac, Linux, Raspberry Pi, etc. alternar entre esses idiomas.
