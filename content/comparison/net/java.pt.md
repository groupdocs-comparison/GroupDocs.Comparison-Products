...
head_description: "Compare e mescle mais de dois arquivos JAVA em aplicativos C# .NET. Recupere o resumo das diferenças no conteúdo, texto e estilo de JAVA arquivos, imagens e formatos de documento."

############################# Header ############################
title: "Comparar arquivos JAVA em C# .NET"
...
steps:
    ...
    code: |
        ...
        using (Comparer comparer = new Comparer("source.java"))
        {
            ...
            comparer.Compare("result.java"); // Cria arquivo de resultado com o nome especificado
        }
        ...
        using (Comparer comparer = new Comparer(File.OpenRead("source.java")))
        {
            ...
            comparer.Compare(File.Create("result.java")); // Cria arquivo de resultado com o nome especificado
        }
        ```
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-java"
          ...
          content: |
            Java é uma linguagem orientada a objetos de uso geral que pode ser executada em várias plataformas. O código-fonte Java está contido em um arquivo com a extensão .java. Java é usado para o desenvolvimento de aplicativos móveis, aplicativos da web, aplicativos de desktop, jogos, etc. Java funciona em várias plataformas, incluindo Windows, Mac, Linux, Raspberry Pi, etc. alternar entre esses idiomas.
