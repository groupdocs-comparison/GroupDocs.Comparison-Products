...
head_description: "Compare e mescle mais de dois arquivos EML em aplicativos C# .NET. Recupere o resumo das diferenças no conteúdo, texto e estilo de EML arquivos, imagens e formatos de documento."

############################# Header ############################
title: "Comparar arquivos EML em C# .NET"
...
steps:
    ...
    code: |
        ...
        using (Comparer comparer = new Comparer("source.eml"))
        {
            ...
            comparer.Compare("result.eml"); // Cria arquivo de resultado com o nome especificado
        }
        ...
        using (Comparer comparer = new Comparer(File.OpenRead("source.eml")))
        {
            ...
            comparer.Compare(File.Create("result.eml")); // Cria arquivo de resultado com o nome especificado
        }
        ```
