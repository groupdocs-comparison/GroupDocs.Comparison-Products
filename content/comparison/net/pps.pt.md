...
head_description: "Compare e mescle mais de dois arquivos PPS em aplicativos C# .NET. Recupere o resumo das diferenças no conteúdo, texto e estilo de PPS arquivos, imagens e formatos de documento."

############################# Header ############################
title: "Comparar arquivos PPS em C# .NET"
...
steps:
    ...
    code: |
        ...
        using (Comparer comparer = new Comparer("source.pps"))
        {
            ...
            comparer.Compare("result.pps"); // Cria arquivo de resultado com o nome especificado
        }
        ...
        using (Comparer comparer = new Comparer(File.OpenRead("source.pps")))
        {
            ...
            comparer.Compare(File.Create("result.pps")); // Cria arquivo de resultado com o nome especificado
        }
        ```
