...
head_description: "Compare e mescle mais de dois arquivos DJVU em aplicativos C# .NET. Recupere o resumo das diferenças no conteúdo, texto e estilo de DJVU arquivos, imagens e formatos de documento."

############################# Header ############################
title: "Comparar arquivos DJVU em C# .NET"
...
steps:
    ...
    code: |
        ...
        using (Comparer comparer = new Comparer("source.djvu"))
        {
            ...
            comparer.Compare("result.djvu"); // Cria arquivo de resultado com o nome especificado
        }
        ...
        using (Comparer comparer = new Comparer(File.OpenRead("source.djvu")))
        {
            ...
            comparer.Compare(File.Create("result.djvu")); // Cria arquivo de resultado com o nome especificado
        }
        ```
