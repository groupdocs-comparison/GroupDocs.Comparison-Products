...
############################# Head ############################
head_title: "ONE Dateien mit C# Vergleichssoftware vergleichen"
head_description: "Vergleichen und führen Sie ONE Dateien in C# .NET Anwendungen zusammen. Rufen Sie eine Zusammenfassung der Unterschiede in Inhalt, Text und Stil ab."

############################# Header ############################
title: "Vergleiche ONE in C# .NET" 
description: ".NET API zum Vergleich von Dokumenten, um nach Unterschieden zwischen zwei Versionen von ONE Dateien zu suchen und in ein endgültiges Dokument mit einer detaillierten Zusammenfassung der Unterschiede zwischen den verglichenen Dokumenten zu exportieren."
...
steps:
    enable: true
    title: "So vergleichen Sie mehrere ONE Dateien mit C#"
    content: |
      Es ist möglich, [GroupDocs.Comparison](https://products.groupdocs.com/comparison/net/) zu verwenden, um Berichte über Unterschiede in vielen ONE Dateien zu erhalten.
      ...
      2. Geben Sie eine Instanz der Comparer-Klasse mit dem vollständigen Pfad zur ursprünglichen ONE -Datei an
      3. Hängen Sie mindestens ein weiteres ONE an Comparer an
    ...
    code:
      ...
      content: |
        ...
        using (Comparer comparer = new Comparer("main_document.one"))
        {
            // Andere Dateien hinzufügen
        	comparer.Add("modified_1.one");
            comparer.Add("modified_2.one");

            // Ruft die Ergebnisdatei mit dem angegebenen Namen ab
            comparer.Compare("report.one"); 
        }
