...
############################# Head ############################
head_title: "DCM Dateien mit C# Vergleichssoftware vergleichen"
head_description: "Vergleichen und führen Sie DCM Dateien in C# .NET Anwendungen zusammen. Rufen Sie eine Zusammenfassung der Unterschiede in Inhalt, Text und Stil ab."

############################# Header ############################
title: "Vergleiche DCM in C# .NET" 
description: ".NET API zum Vergleich von Dokumenten, um nach Unterschieden zwischen zwei Versionen von DCM Dateien zu suchen und in ein endgültiges Dokument mit einer detaillierten Zusammenfassung der Unterschiede zwischen den verglichenen Dokumenten zu exportieren."
...
steps:
    enable: true
    title: "So vergleichen Sie mehrere DCM Dateien mit C#"
    content: |
      Es ist möglich, [GroupDocs.Comparison](https://products.groupdocs.com/comparison/net/) zu verwenden, um Berichte über Unterschiede in vielen DCM Dateien zu erhalten.
      ...
      2. Geben Sie eine Instanz der Comparer-Klasse mit dem vollständigen Pfad zur ursprünglichen DCM -Datei an
      3. Hängen Sie mindestens ein weiteres DCM an Comparer an
    ...
    code:
      ...
      content: |
        ...
        using (Comparer comparer = new Comparer("main_document.dcm"))
        {
            // Andere Dateien hinzufügen
        	comparer.Add("modified_1.dcm");
            comparer.Add("modified_2.dcm");

            // Ruft die Ergebnisdatei mit dem angegebenen Namen ab
            comparer.Compare("report.dcm"); 
        }
