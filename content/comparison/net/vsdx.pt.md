...
############################# Head ############################
head_title: "Compare dois arquivos VSDX em .NET | APIs de comparação de documentos"
head_description: "Compare e mescle mais de dois arquivos VSDX em aplicativos C# .NET. Recupere resumos de diferenças em conteúdo, texto e estilo de VSDX arquivos, imagens e formatos de documentos."

############################# Header ############################
title: "Compare arquivos VSDX em C# .NET"
description: "API de comparação de documentos .NET para detectar as alterações entre duas versões de arquivos VSDX e exportar para um documento final com um resumo detalhado das diferenças entre os documentos comparados."
...
steps:
    enable: true
    title_left: "Etapas para comparar arquivos VSDX em C#"
    content_left: |
        [GroupDocs.Comparison](/comparison/net/) torna mais fácil para os desenvolvedores .NET comparar e mesclar vários arquivos VSDX em seus aplicativos, implementando algumas etapas fáceis.
    ...
    code: |
        ...
        using (Comparer comparer = new Comparer("source.vsdx"))
        {
            ...
            comparer.Compare("result.vsdx"); // Crie um arquivo de resultado com o nome especificado
        }
        ...
        using (Comparer comparer = new Comparer(File.OpenRead("source.vsdx")))
        {
            ...
            comparer.Compare(File.Create("result.vsdx")); // Crie um arquivo de resultado com o nome especificado
        }
        ```
...
demos:
    enable: true
    title: "Demonstrações ao vivo de comparação de arquivos VSDX"
    content: |
        Detecte diferenças entre arquivos VSDX agora mesmo visitando o site [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-vsdx"
          ...
          content: |
            Arquivos com extensão .VSDX representam o formato de arquivo do Microsoft Visio introduzido a partir do Microsoft Office 2013. Ele foi desenvolvido para substituir o formato de arquivo binário, .VSD, compatível com versões anteriores do Microsoft Visio. Também tem suporte nos Serviços do Visio no Microsoft SharePoint Server 2013 e não requer um formato de arquivo intermediário para publicação no SharePoint Server. Os arquivos Visio são usados ​​para criar desenhos que contêm objetos visuais, fluxogramas, diagrama UML, fluxo de informações, organogramas, diagramas de software, layout de rede, modelos de banco de dados, mapeamento de objetos e outras informações semelhantes. Os arquivos gerados com o Visio também podem ser exportados para diversos formatos de arquivo, como PNG, BMP, PDF e outros.
