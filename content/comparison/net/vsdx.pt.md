...
head_description: "Compare e mescle mais de dois arquivos VSDX em aplicativos C# .NET. Recupere o resumo das diferenças no conteúdo, texto e estilo de VSDX arquivos, imagens e formatos de documento."

############################# Header ############################
title: "Comparar arquivos VSDX em C# .NET"
...
steps:
    ...
    code: |
        ...
        using (Comparer comparer = new Comparer("source.vsdx"))
        {
            ...
            comparer.Compare("result.vsdx"); // Cria arquivo de resultado com o nome especificado
        }
        ...
        using (Comparer comparer = new Comparer(File.OpenRead("source.vsdx")))
        {
            ...
            comparer.Compare(File.Create("result.vsdx")); // Cria arquivo de resultado com o nome especificado
        }
        ```
