...
############################# Head ############################
head_title: "Confronta due file DIFF in .NET | API di confronto dei documenti"
head_description: "Confronta e unisci più di due file DIFF nelle applicazioni C# .NET. Recupera il riepilogo delle differenze nel contenuto, nel testo e nello stile di file, immagini e formati di documenti DIFF."

############################# Header ############################
title: "Confronta i file DIFF in C# .NET"
description: "API di confronto dei documenti .NET per rilevare le modifiche tra due versioni di file DIFF ed esportarle in un documento finale con un riepilogo dettagliato delle differenze tra i documenti confrontati."
...
steps:
    enable: true
    title_left: "Passaggi per confrontare i file DIFF in C#"
    content_left: |
        [GroupDocs.Comparison](/comparison/net/) semplifica agli sviluppatori .NET il confronto e l'unione di più file DIFF nelle loro applicazioni implementando alcuni semplici passaggi.
    ...
    code: |
        ...
        using (Comparer comparer = new Comparer("source.diff"))
        {
            ...
            comparer.Compare("result.diff"); // Crea il file dei risultati con il nome specificato
        }
        ...
        using (Comparer comparer = new Comparer(File.OpenRead("source.diff")))
        {
            ...
            comparer.Compare(File.Create("result.diff")); // Crea il file dei risultati con il nome specificato
        }
        ```
...
demos:
    enable: true
    title: "Demo dal vivo del confronto di file DIFF"
    content: |
        Rileva subito le differenze tra i file DIFF visitando il sito web [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-diff"
          title: "Informazioni sul formato file DIFF"
          content: |
            Un file DIFF è un singolo file che mostra le differenze tra uno o più file di testo o di origine. È creato da Mercurial, uno strumento di gestione del controllo per gli sviluppatori per ottenere le differenze tra i file e applicare le patch. Attraverso i file DIFF, gli sviluppatori condividono le proprie modifiche con altri sviluppatori in modo che le modifiche possano essere aggiornate per generare una versione più recente dei file di testo. I file DIFF possono essere aperti in Mercurial.
