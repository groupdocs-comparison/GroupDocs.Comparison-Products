...
steps:
    ...
    content_left: |
        [GroupDocs.Comparison](/comparison/net/) makes it easy for .NET developers to compare & merge multiple DJVU files in their applications by implementing a few easy steps.
