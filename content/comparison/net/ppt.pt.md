...
head_description: "Compare e mescle mais de dois arquivos PPT em aplicativos C# .NET. Recupere o resumo das diferenças no conteúdo, texto e estilo de PPT arquivos, imagens e formatos de documento."

############################# Header ############################
title: "Comparar arquivos PPT em C# .NET"
...
steps:
    ...
    code: |
        ...
        using (Comparer comparer = new Comparer("source.ppt"))
        {
            ...
            comparer.Compare("result.ppt"); // Cria arquivo de resultado com o nome especificado
        }
        ...
        using (Comparer comparer = new Comparer(File.OpenRead("source.ppt")))
        {
            ...
            comparer.Compare(File.Create("result.ppt")); // Cria arquivo de resultado com o nome especificado
        }
        ```
