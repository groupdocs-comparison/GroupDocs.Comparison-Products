...
############################# Head ############################
head_title: "Compare VSS archivos con el software de comparación C#"
head_description: "Compare y combine VSS archivos en aplicaciones C# .NET. Recupera el resumen de las diferencias en contenido, texto y estilo."

############################# Header ############################
title: "Compara VSS en C# .NET" 
description: ".NET API de comparación de documentos para comprobar si hay diferencias entre dos versiones de VSS archivos y exportarlos a un documento final con un resumen detallado de las diferencias entre los documentos comparados."
...
steps:
    enable: true
    title: "Cómo comparar varios archivos VSS con C#"
    content: |
      Es posible usar [GroupDocs.Comparison](https://products.groupdocs.com/comparison/net/) para obtener informes sobre las diferencias en muchos VSS archivos.
      ...
      2. Proporcione una instancia de la clase Comparer con la ruta completa al archivo inicial VSS
      3. Añada al menos otro VSS al comparador
