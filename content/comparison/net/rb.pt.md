...
head_description: "Compare e mescle mais de dois arquivos RB em aplicativos C# .NET. Recupere o resumo das diferenças no conteúdo, texto e estilo de RB arquivos, imagens e formatos de documento."

############################# Header ############################
title: "Comparar arquivos RB em C# .NET"
...
steps:
    ...
    code: |
        ...
        using (Comparer comparer = new Comparer("source.rb"))
        {
            ...
            comparer.Compare("result.rb"); // Cria arquivo de resultado com o nome especificado
        }
        ...
        using (Comparer comparer = new Comparer(File.OpenRead("source.rb")))
        {
            ...
            comparer.Compare(File.Create("result.rb")); // Cria arquivo de resultado com o nome especificado
        }
        ```
