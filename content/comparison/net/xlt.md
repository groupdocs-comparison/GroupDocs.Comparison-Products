...
############################# Head ############################
head_title: "Compare two XLT files in .NET | Document Comparison APIs"
head_description: "Compare and merge more than two (XLT files in C# .NET applications. Retrieve differences summary in content, text &amp; style of XLT files, images and document formats."

############################# Header ############################
title: "Compare XLT Files in C# .NET"
description: ".NET documents comparison API to detect the changes between two versions of XLT files and export to a final document with a detailed summary of the differences between the compared documents."
...
steps:
    enable: true
    title_left: "Steps for Comparing XLT Files in C#"
    content_left: |
        [GroupDocs.Comparison](/comparison/net/) makes it easy for .NET developers to compare & merge multiple XLT files in their applications by implementing a few easy steps.
    ...
    code: |
        ...
        using (Comparer comparer = new Comparer("source.xlt")
        {
            ...
            comparer.Compare("result.xlt"); // Create result file with the specified name
        }
        ...
        using (Comparer comparer = new Comparer(File.OpenRead("source.xlt"))
        {
            ...
            comparer.Compare(File.Create("result.xlt")); // Create result file with the specified name
        }
        ```
...
demos:
    enable: true
    title: "Live Demos of Comparing XLT Files"
    content: |
        Detect differences between XLT files right now by visiting [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family) website.  
