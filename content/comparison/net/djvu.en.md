...
############################# Head ############################
head_title: "Compare DJVU files with C# Comparison Software"
head_description: "Compare and merge DJVU files in C# .NET applications. Retrieve differences summary in content, text & style."

############################# Header ############################
title: "Compare DJVU in C# .NET" 
...
steps:
    ...
    content: |
      It is possible to use [GroupDocs.Comparison](https://products.groupdocs.com/comparison/net/) for getting report about differences in many DJVU files.
      ...
      2. Provide an instance of Comparer class with full path to initial DJVU file
