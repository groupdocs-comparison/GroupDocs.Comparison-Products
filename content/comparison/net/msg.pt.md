...
head_description: "Compare e mescle mais de dois arquivos MSG em aplicativos C# .NET. Recupere o resumo das diferenças no conteúdo, texto e estilo de MSG arquivos, imagens e formatos de documento."

############################# Header ############################
title: "Comparar arquivos MSG em C# .NET"
...
steps:
    ...
    code: |
        ...
        using (Comparer comparer = new Comparer("source.msg"))
        {
            ...
            comparer.Compare("result.msg"); // Cria arquivo de resultado com o nome especificado
        }
        ...
        using (Comparer comparer = new Comparer(File.OpenRead("source.msg")))
        {
            ...
            comparer.Compare(File.Create("result.msg")); // Cria arquivo de resultado com o nome especificado
        }
        ```
