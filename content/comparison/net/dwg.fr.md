...
############################# Head ############################
head_title: "Comparer DWG fichiers avec le logiciel de comparaison C#"
head_description: "Comparez et fusionnez DWG fichiers dans C# .NET applications. Récupérez le résumé des différences en termes de contenu, de texte et de style."

############################# Header ############################
title: "Comparer DWG à C# .NET" 
description: "API de comparaison de documents .NET pour vérifier les différences entre deux versions des fichiers DWG et les exporter vers un document final avec un résumé détaillé des différences entre les documents comparés."
...
steps:
    enable: true
    title: "Comment comparer plusieurs fichiers DWG à l'aide de C#"
    content: |
      Il est possible d'utiliser [GroupDocs.Comparison](https://products.groupdocs.com/comparison/net/) pour obtenir un rapport sur les différences entre de nombreux fichiers DWG.
      ...
      2. Fournissez une instance de la classe Comparer avec le chemin complet vers le fichier initial DWG
      3. Ajouter au moins un autre DWG à Comparer
