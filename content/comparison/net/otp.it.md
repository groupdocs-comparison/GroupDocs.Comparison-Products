...
############################# Head ############################
head_title: "Confronta due file OTP in .NET | API di confronto dei documenti"
head_description: "Confronta e unisci più di due file OTP nelle applicazioni C# .NET. Recupera il riepilogo delle differenze nel contenuto, nel testo e nello stile di file, immagini e formati di documenti OTP."

############################# Header ############################
title: "Confronta i file OTP in C# .NET"
description: "API di confronto dei documenti .NET per rilevare le modifiche tra due versioni di file OTP ed esportarle in un documento finale con un riepilogo dettagliato delle differenze tra i documenti confrontati."
...
steps:
    enable: true
    title_left: "Passaggi per confrontare i file OTP in C#"
    content_left: |
        [GroupDocs.Comparison](/comparison/net/) semplifica agli sviluppatori .NET il confronto e l'unione di più file OTP nelle loro applicazioni implementando alcuni semplici passaggi.
    ...
    code: |
        ...
        using (Comparer comparer = new Comparer("source.otp"))
        {
            ...
            comparer.Compare("result.otp"); // Crea il file dei risultati con il nome specificato
        }
        ...
        using (Comparer comparer = new Comparer(File.OpenRead("source.otp")))
        {
            ...
            comparer.Compare(File.Create("result.otp")); // Crea il file dei risultati con il nome specificato
        }
        ```
...
demos:
    enable: true
    title: "Demo dal vivo del confronto di file OTP"
    content: |
        Rileva subito le differenze tra i file OTP visitando il sito web [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-otp"
          ...
          content: |
            I file con estensione .OTP rappresentano file modello di presentazione creati dalle applicazioni nel formato standard OASIS OpenDocument. Il contenuto di tale file include informazioni sulla presentazione sotto forma di diapositive con testo, immagini, forme, contenuti multimediali, effetti di transizione e altri elementi di diapositiva. Questi file modello vengono utilizzati per creare rapidamente nuove presentazioni in base alle informazioni di stile memorizzate nel modello stesso. I file OTP possono essere creati e salvati con diverse applicazioni come Impress fornita con la suite OpenOffice e Microsoft PowerPoint. Il formato file OTP è simile ai file modello di Microsoft PowerPoint .POT e .POTX.
