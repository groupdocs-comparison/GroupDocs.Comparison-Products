...
############################# Head ############################
head_title: "Comparer DOTX fichiers avec le logiciel de comparaison C#"
head_description: "Comparez et fusionnez DOTX fichiers dans C# .NET applications. Récupérez le résumé des différences en termes de contenu, de texte et de style."

############################# Header ############################
title: "Comparer DOTX à C# .NET" 
description: "API de comparaison de documents .NET pour vérifier les différences entre deux versions des fichiers DOTX et les exporter vers un document final avec un résumé détaillé des différences entre les documents comparés."
...
steps:
    enable: true
    title: "Comment comparer plusieurs fichiers DOTX à l'aide de C#"
    content: |
      Il est possible d'utiliser [GroupDocs.Comparison](https://products.groupdocs.com/comparison/net/) pour obtenir un rapport sur les différences entre de nombreux fichiers DOTX.
      ...
      2. Fournissez une instance de la classe Comparer avec le chemin complet vers le fichier initial DOTX
      3. Ajouter au moins un autre DOTX à Comparer
