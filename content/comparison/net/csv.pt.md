...
head_description: "Compare e mescle mais de dois arquivos CSV em aplicativos C# .NET. Recupere o resumo das diferenças no conteúdo, texto e estilo de CSV arquivos, imagens e formatos de documento."

############################# Header ############################
title: "Comparar arquivos CSV em C# .NET"
...
steps:
    ...
    code: |
        ...
        using (Comparer comparer = new Comparer("source.csv"))
        {
            ...
            comparer.Compare("result.csv"); // Cria arquivo de resultado com o nome especificado
        }
        ...
        using (Comparer comparer = new Comparer(File.OpenRead("source.csv")))
        {
            ...
            comparer.Compare(File.Create("result.csv")); // Cria arquivo de resultado com o nome especificado
        }
        ```
