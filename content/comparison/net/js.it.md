...
############################# Head ############################
head_title: "Confronta due file JS in .NET | API di confronto dei documenti"
head_description: "Confronta e unisci più di due file JS nelle applicazioni C# .NET. Recupera il riepilogo delle differenze nel contenuto, nel testo e nello stile di file, immagini e formati di documenti JS."

############################# Header ############################
title: "Confronta i file JS in C# .NET"
description: "API di confronto dei documenti .NET per rilevare le modifiche tra due versioni di file JS ed esportarle in un documento finale con un riepilogo dettagliato delle differenze tra i documenti confrontati."
...
steps:
    enable: true
    title_left: "Passaggi per confrontare i file JS in C#"
    content_left: |
        [GroupDocs.Comparison](/comparison/net/) semplifica agli sviluppatori .NET il confronto e l'unione di più file JS nelle loro applicazioni implementando alcuni semplici passaggi.
    ...
    code: |
        ...
        using (Comparer comparer = new Comparer("source.js"))
        {
            ...
            comparer.Compare("result.js"); // Crea il file dei risultati con il nome specificato
        }
        ...
        using (Comparer comparer = new Comparer(File.OpenRead("source.js")))
        {
            ...
            comparer.Compare(File.Create("result.js")); // Crea il file dei risultati con il nome specificato
        }
        ```
...
demos:
    enable: true
    title: "Demo dal vivo del confronto di file JS"
    content: |
        Rileva subito le differenze tra i file JS visitando il sito web [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
...
about_formats:
    ...
    format:
        # format loop
        - icon: "far fa-file-js"
          title: "Informazioni sul formato file JS"
          content: |
            JS (JavaScript) sono file che contengono codice JavaScript per l'esecuzione su pagine web. I file JavaScript vengono archiviati con l'estensione .js. All'interno del documento HTML, puoi incorporare il codice JavaScript utilizzando i tag o includere un file JS. Analogamente ai file CSS, i file JS possono essere inclusi in più documenti HTML per la riutilizzabilità del codice. JavaScript può essere utilizzato per manipolare il DOM HTML.
