...
head_description: "Compare e mescle mais de dois arquivos VDX em aplicativos C# .NET. Recupere o resumo das diferenças no conteúdo, texto e estilo de VDX arquivos, imagens e formatos de documento."

############################# Header ############################
title: "Comparar arquivos VDX em C# .NET"
...
steps:
    ...
    code: |
        ...
        using (Comparer comparer = new Comparer("source.vdx"))
        {
            ...
            comparer.Compare("result.vdx"); // Cria arquivo de resultado com o nome especificado
        }
        ...
        using (Comparer comparer = new Comparer(File.OpenRead("source.vdx")))
        {
            ...
            comparer.Compare(File.Create("result.vdx")); // Cria arquivo de resultado com o nome especificado
        }
        ```
