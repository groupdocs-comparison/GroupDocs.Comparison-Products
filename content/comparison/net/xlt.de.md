...
############################# Head ############################
head_title: "XLT Dateien mit C# Vergleichssoftware vergleichen"
head_description: "Vergleichen und führen Sie XLT Dateien in C# .NET Anwendungen zusammen. Rufen Sie eine Zusammenfassung der Unterschiede in Inhalt, Text und Stil ab."

############################# Header ############################
title: "Vergleiche XLT in C# .NET" 
description: ".NET API zum Vergleich von Dokumenten, um nach Unterschieden zwischen zwei Versionen von XLT Dateien zu suchen und in ein endgültiges Dokument mit einer detaillierten Zusammenfassung der Unterschiede zwischen den verglichenen Dokumenten zu exportieren."
...
steps:
    enable: true
    title: "So vergleichen Sie mehrere XLT Dateien mit C#"
    content: |
      Es ist möglich, [GroupDocs.Comparison](https://products.groupdocs.com/comparison/net/) zu verwenden, um Berichte über Unterschiede in vielen XLT Dateien zu erhalten.
      ...
      2. Geben Sie eine Instanz der Comparer-Klasse mit dem vollständigen Pfad zur ursprünglichen XLT -Datei an
      3. Hängen Sie mindestens ein weiteres XLT an Comparer an
    ...
    code:
      ...
      content: |
        ...
        using (Comparer comparer = new Comparer("main_document.xlt"))
        {
            // Andere Dateien hinzufügen
        	comparer.Add("modified_1.xlt");
            comparer.Add("modified_2.xlt");

            // Ruft die Ergebnisdatei mit dem angegebenen Namen ab
            comparer.Compare("report.xlt"); 
        }
