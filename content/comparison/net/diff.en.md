...
############################# Head ############################
head_title: "Compare DIFF files with C# Comparison Software"
head_description: "Compare and merge DIFF files in C# .NET applications. Retrieve differences summary in content, text & style."

############################# Header ############################
title: "Compare DIFF in C# .NET" 
description: ".NET documents comparison API to check for diffs between two versions of DIFF files and export to a final document with a detailed summary of the differences between the compared documents."
...
steps:
    ...
    content: |
      It is possible to use [GroupDocs.Comparison](https://products.groupdocs.com/comparison/net/) for getting report about differences in many DIFF files.
      ...
      2. Provide an instance of Comparer class with full path to initial DIFF file
