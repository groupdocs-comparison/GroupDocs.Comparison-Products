...
############################# Head ############################
head_title: "Compare dois arquivos DIFF em .NET | APIs de comparação de documentos"
head_description: "Compare e mescle mais de dois arquivos DIFF em aplicativos C# .NET. Recupere resumos de diferenças em conteúdo, texto e estilo de DIFF arquivos, imagens e formatos de documentos."

############################# Header ############################
title: "Compare arquivos DIFF em C# .NET"
description: "API de comparação de documentos .NET para detectar as alterações entre duas versões de arquivos DIFF e exportar para um documento final com um resumo detalhado das diferenças entre os documentos comparados."
...
steps:
    enable: true
    title_left: "Etapas para comparar arquivos DIFF em C#"
    content_left: |
        [GroupDocs.Comparison](/comparison/net/) torna mais fácil para os desenvolvedores .NET comparar e mesclar vários arquivos DIFF em seus aplicativos, implementando algumas etapas fáceis.
    ...
    code: |
        ...
        using (Comparer comparer = new Comparer("source.diff"))
        {
            ...
            comparer.Compare("result.diff"); // Crie um arquivo de resultado com o nome especificado
        }
        ...
        using (Comparer comparer = new Comparer(File.OpenRead("source.diff")))
        {
            ...
            comparer.Compare(File.Create("result.diff")); // Crie um arquivo de resultado com o nome especificado
        }
        ```
...
demos:
    enable: true
    title: "Demonstrações ao vivo de comparação de arquivos DIFF"
    content: |
        Detecte diferenças entre arquivos DIFF agora mesmo visitando o site [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-diff"
          title: "Sobre o formato de arquivo DIFF"
          content: |
            Um arquivo DIFF é um arquivo único que mostra as diferenças entre um ou mais arquivos de texto ou de origem. É criado pelo Mercurial, uma ferramenta de gerenciamento de controle para desenvolvedores obterem diferenças entre arquivos e aplicarem os patches. Através de arquivos DIFF, os desenvolvedores compartilham suas alterações com outros desenvolvedores para que as alterações possam ser atualizadas para gerar uma versão mais recente dos arquivos de texto. Arquivos DIFF podem ser abertos no Mercurial.
