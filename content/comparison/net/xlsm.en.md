...
############################# Head ############################
head_title: "Compare two XLSM files with C# Document Comparison software"
...
description: ".NET documents comparison API to check for diffs between two versions of XLSM files and export to a final document with a detailed summary of the differences between the compared documents."
...
steps:
    ...
    content: |
      It is possible to use [GroupDocs.Comparison](https://products.groupdocs.com/comparison/net/) for getting report about differences in many XLSM files.
