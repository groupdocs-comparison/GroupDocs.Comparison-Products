...
head_description: "Compare e mescle mais de dois arquivos XLSB em aplicativos C# .NET. Recupere o resumo das diferenças no conteúdo, texto e estilo de XLSB arquivos, imagens e formatos de documento."

############################# Header ############################
title: "Comparar arquivos XLSB em C# .NET"
...
steps:
    ...
    code: |
        ...
        using (Comparer comparer = new Comparer("source.xlsb"))
        {
            ...
            comparer.Compare("result.xlsb"); // Cria arquivo de resultado com o nome especificado
        }
        ...
        using (Comparer comparer = new Comparer(File.OpenRead("source.xlsb")))
        {
            ...
            comparer.Compare(File.Create("result.xlsb")); // Cria arquivo de resultado com o nome especificado
        }
        ```
