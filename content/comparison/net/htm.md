...
steps:
    ...
    content_left: |
        [GroupDocs.Comparison](/comparison/net/) makes it easy for .NET developers to compare & merge multiple HTM files in their applications by implementing a few easy steps.
