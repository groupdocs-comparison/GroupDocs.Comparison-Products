...
############################# Head ############################
head_title: "Bandingkan file VDX dengan C# Perangkat Lunak Perbandingan"
head_description: "Bandingkan dan gabungkan VDX file dalam aplikasi C# .NET. Ambil ringkasan perbedaan dalam konten, teks & gaya."

############################# Header ############################
title: "Bandingkan VDX di C# .NET" 
description: ".NET dokumen API perbandingan untuk memeriksa perbedaan antara dua versi file VDX dan mengekspor ke dokumen akhir dengan ringkasan terperinci tentang perbedaan antara dokumen yang dibandingkan."
...
steps:
    enable: true
    title: "Cara membandingkan beberapa VDX file menggunakan C#"
    content: |
      Dimungkinkan untuk menggunakan [GroupDocs.Comparison](https://products.groupdocs.com/comparison/net/) untuk mendapatkan laporan tentang perbedaan di banyak file VDX.
      ...
      2. Berikan instance kelas Comparer dengan path lengkap ke file awal VDX
      3. Tambahkan setidaknya satu VDX lainnya ke Comparer
