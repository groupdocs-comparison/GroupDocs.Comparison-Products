...
head_description: "Compare e mescle mais de dois arquivos JPEG em aplicativos C# .NET. Recupere o resumo das diferenças no conteúdo, texto e estilo de JPEG arquivos, imagens e formatos de documento."

############################# Header ############################
title: "Comparar arquivos JPEG em C# .NET"
...
steps:
    ...
    code: |
        ...
        using (Comparer comparer = new Comparer("source.jpeg"))
        {
            ...
            comparer.Compare("result.jpeg"); // Cria arquivo de resultado com o nome especificado
        }
        ...
        using (Comparer comparer = new Comparer(File.OpenRead("source.jpeg")))
        {
            ...
            comparer.Compare(File.Create("result.jpeg")); // Cria arquivo de resultado com o nome especificado
        }
        ```
