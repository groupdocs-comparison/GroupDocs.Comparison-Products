...
############################# Head ############################
head_title: "Compara dos archivos DOT en .NET | API de comparación de documentos"
head_description: "Compare y combine más de dos archivos DOT en aplicaciones C# .NET. Recupere un resumen de diferencias en contenido, texto y estilo de DOT archivos, imágenes y formatos de documentos."

############################# Header ############################
title: "Comparar archivos DOT en C# .NET"
description: "API de comparación de documentos .NET para detectar los cambios entre dos versiones de archivos DOT y exportarlos a un documento final con un resumen detallado de las diferencias entre los documentos comparados."
...
steps:
    enable: true
    title_left: "Pasos para comparar archivos DOT en C#"
    content_left: |
        [GroupDocs.Comparison](/comparison/net/) facilita a los desarrolladores .NET comparar y fusionar múltiples archivos DOT en sus aplicaciones implementando unos sencillos pasos.
    ...
    code: |
        ...
        using (Comparer comparer = new Comparer("source.dot"))
        {
            ...
            comparer.Compare("result.dot"); // Crear archivo de resultados con el nombre especificado
        }
        ...
        using (Comparer comparer = new Comparer(File.OpenRead("source.dot")))
        {
            ...
            comparer.Compare(File.Create("result.dot")); // Crear archivo de resultados con el nombre especificado
        }
        ```
...
demos:
    enable: true
    title: "Demostraciones en vivo de comparación de archivos DOT"
    content: |
        Detecte diferencias entre archivos DOT ahora mismo visitando el sitio web [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-dot"
          ...
          content: |
            Los archivos con extensión .DOT son archivos de plantilla creados por Microsoft Word para tener configuraciones preformateadas para la generación de más archivos DOC o DOCX. Se crea un archivo de plantilla para tener configuraciones de usuario específicas que deben aplicarse a los archivos posteriores creados a partir de estos. Estas configuraciones incluyen márgenes de página, bordes, encabezados, pies de página y otras configuraciones de página. Estas plantillas se utilizan en documentos oficiales, como membretes de empresas y formularios estandarizados. El formato de archivo DOT es específico de Microsoft Word 2003 y versiones anteriores, pero también es compatible con versiones superiores. Microsoft Word abre de forma predeterminada cada documento nuevo basado en el archivo normal.dot. Si se modifica, todos los archivos nuevos creados tendrán la misma configuración que el archivo de plantilla. En Microsoft Word 2007, el formato de archivo DOT ha sido reemplazado por el formato de archivo DOTX basado en Office OpenXML.
