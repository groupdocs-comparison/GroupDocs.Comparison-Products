...
############################# Head ############################
head_title: "Bandingkan dua file JS di .NET | API Perbandingan Dokumen"
head_description: "Bandingkan dan gabungkan lebih dari dua file JS dalam aplikasi C# .NET. Ambil ringkasan perbedaan dalam konten, teks & gaya file JS, gambar dan format dokumen."

############################# Header ############################
title: "Bandingkan File JS di C# .NET"
description: "API perbandingan dokumen .NET untuk mendeteksi perubahan antara dua versi file JS dan mengekspor ke dokumen akhir dengan ringkasan mendetail tentang perbedaan antara dokumen yang dibandingkan."
...
steps:
    enable: true
    title_left: "Langkah-langkah Membandingkan File JS di C#"
    content_left: |
        [GroupDocs.Comparison](/comparison/net/) memudahkan pengembang .NET untuk membandingkan & menggabungkan beberapa file JS dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
    ...
    code: |
        ...
        using (Comparer comparer = new Comparer("source.js"))
        {
            ...
            comparer.Compare("result.js"); // Buat file hasil dengan nama yang ditentukan
        }
        ...
        using (Comparer comparer = new Comparer(File.OpenRead("source.js")))
        {
            ...
            comparer.Compare(File.Create("result.js")); // Buat file hasil dengan nama yang ditentukan
        }
        ```
...
demos:
    enable: true
    title: "Demo Langsung Membandingkan File JS"
    content: |
        Deteksi perbedaan antara file JS sekarang dengan mengunjungi situs web [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
...
about_formats:
    ...
    format:
        # format loop
        - icon: "far fa-file-js"
          title: "Tentang Format File JS"
          content: |
            JS (JavaScript) adalah file yang berisi kode JavaScript untuk dieksekusi pada halaman web. File JavaScript disimpan dengan ekstensi .js. Di dalam dokumen HTML, Anda dapat menyematkan kode JavaScript menggunakan tag atau menyertakan file JS. Mirip dengan file CSS, file JS dapat disertakan dalam beberapa dokumen HTML agar kode dapat digunakan kembali. JavaScript dapat digunakan untuk memanipulasi DOM HTML.
