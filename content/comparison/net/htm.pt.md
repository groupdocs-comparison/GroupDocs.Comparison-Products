...
head_description: "Compare e mescle mais de dois arquivos HTM em aplicativos C# .NET. Recupere o resumo das diferenças no conteúdo, texto e estilo de HTM arquivos, imagens e formatos de documento."

############################# Header ############################
title: "Comparar arquivos HTM em C# .NET"
...
steps:
    ...
    code: |
        ...
        using (Comparer comparer = new Comparer("source.htm"))
        {
            ...
            comparer.Compare("result.htm"); // Cria arquivo de resultado com o nome especificado
        }
        ...
        using (Comparer comparer = new Comparer(File.OpenRead("source.htm")))
        {
            ...
            comparer.Compare(File.Create("result.htm")); // Cria arquivo de resultado com o nome especificado
        }
        ```
