...
head_description: "Compare e mescle mais de dois arquivos RTF em aplicativos C# .NET. Recupere o resumo das diferenças no conteúdo, texto e estilo de RTF arquivos, imagens e formatos de documento."

############################# Header ############################
title: "Comparar arquivos RTF em C# .NET"
...
steps:
    ...
    code: |
        ...
        using (Comparer comparer = new Comparer("source.rtf"))
        {
            ...
            comparer.Compare("result.rtf"); // Cria arquivo de resultado com o nome especificado
        }
        ...
        using (Comparer comparer = new Comparer(File.OpenRead("source.rtf")))
        {
            ...
            comparer.Compare(File.Create("result.rtf")); // Cria arquivo de resultado com o nome especificado
        }
        ```
