...
head_description: "Compare e mescle mais de dois arquivos DCM em aplicativos C# .NET. Recupere o resumo das diferenças no conteúdo, texto e estilo de DCM arquivos, imagens e formatos de documento."

############################# Header ############################
title: "Comparar arquivos DCM em C# .NET"
...
steps:
    ...
    code: |
        ...
        using (Comparer comparer = new Comparer("source.dcm"))
        {
            ...
            comparer.Compare("result.dcm"); // Cria arquivo de resultado com o nome especificado
        }
        ...
        using (Comparer comparer = new Comparer(File.OpenRead("source.dcm")))
        {
            ...
            comparer.Compare(File.Create("result.dcm")); // Cria arquivo de resultado com o nome especificado
        }
        ```
