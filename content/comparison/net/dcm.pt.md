...
############################# Head ############################
head_title: "Compare dois arquivos DCM em .NET | APIs de comparação de documentos"
head_description: "Compare e mescle mais de dois arquivos DCM em aplicativos C# .NET. Recupere resumos de diferenças em conteúdo, texto e estilo de DCM arquivos, imagens e formatos de documentos."

############################# Header ############################
title: "Compare arquivos DCM em C# .NET"
description: "API de comparação de documentos .NET para detectar as alterações entre duas versões de arquivos DCM e exportar para um documento final com um resumo detalhado das diferenças entre os documentos comparados."
...
steps:
    enable: true
    title_left: "Etapas para comparar arquivos DCM em C#"
    content_left: |
        [GroupDocs.Comparison](/comparison/net/) torna mais fácil para os desenvolvedores .NET comparar e mesclar vários arquivos DCM em seus aplicativos, implementando algumas etapas fáceis.
    ...
    code: |
        ...
        using (Comparer comparer = new Comparer("source.dcm"))
        {
            ...
            comparer.Compare("result.dcm"); // Crie um arquivo de resultado com o nome especificado
        }
        ...
        using (Comparer comparer = new Comparer(File.OpenRead("source.dcm")))
        {
            ...
            comparer.Compare(File.Create("result.dcm")); // Crie um arquivo de resultado com o nome especificado
        }
        ```
...
demos:
    enable: true
    title: "Demonstrações ao vivo de comparação de arquivos DCM"
    content: |
        Detecte diferenças entre arquivos DCM agora mesmo visitando o site [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family).
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-dcm"
          ...
          content: |
            Arquivos com extensão .DCM representam imagens digitais que armazenam informações médicas de pacientes, como ressonâncias magnéticas, tomografias computadorizadas e imagens de ultrassom. Foi desenvolvido pela National Electrical Manufacturers Association (NEMA) e tinha como objetivo padronizar o formato de arquivo de imagem para distribuição e visualização de imagens médicas. É semelhante ao formato de arquivo DICOM e pode incluir informações do paciente para referência.
