...
head_description: "Compare e mescle mais de dois arquivos DOCM em aplicativos C# .NET. Recupere o resumo das diferenças no conteúdo, texto e estilo de DOCM arquivos, imagens e formatos de documento."

############################# Header ############################
title: "Comparar arquivos DOCM em C# .NET"
...
steps:
    ...
    code: |
        ...
        using (Comparer comparer = new Comparer("source.docm"))
        {
            ...
            comparer.Compare("result.docm"); // Cria arquivo de resultado com o nome especificado
        }
        ...
        using (Comparer comparer = new Comparer(File.OpenRead("source.docm")))
        {
            ...
            comparer.Compare(File.Create("result.docm")); // Cria arquivo de resultado com o nome especificado
        }
        ```
