...
head_description: "Compare e mescle mais de dois arquivos ASM em aplicativos C# .NET. Recupere o resumo das diferenças no conteúdo, texto e estilo de ASM arquivos, imagens e formatos de documento."

############################# Header ############################
title: "Comparar arquivos ASM em C# .NET"
...
steps:
    ...
    code: |
        ...
        using (Comparer comparer = new Comparer("source.asm"))
        {
            ...
            comparer.Compare("result.asm"); // Cria arquivo de resultado com o nome especificado
        }
        ...
        using (Comparer comparer = new Comparer(File.OpenRead("source.asm")))
        {
            ...
            comparer.Compare(File.Create("result.asm")); // Cria arquivo de resultado com o nome especificado
        }
        ```
