...
head_description: "Сравните и объедините более двух файлов VSD в приложениях C# .NET. Получите сводку о различиях в содержимом, тексте и стиле файлов VSD, изображениях и форматах документов."
