...
head_description: "Compare e mescle mais de dois arquivos DOC em aplicativos C# .NET. Recupere o resumo das diferenças no conteúdo, texto e estilo de DOC arquivos, imagens e formatos de documento."

############################# Header ############################
title: "Comparar arquivos DOC em C# .NET"
...
steps:
    ...
    code: |
        ...
        using (Comparer comparer = new Comparer("source.doc"))
        {
            ...
            comparer.Compare("result.doc"); // Cria arquivo de resultado com o nome especificado
        }
        ...
        using (Comparer comparer = new Comparer(File.OpenRead("source.doc")))
        {
            ...
            comparer.Compare(File.Create("result.doc")); // Cria arquivo de resultado com o nome especificado
        }
        ```
