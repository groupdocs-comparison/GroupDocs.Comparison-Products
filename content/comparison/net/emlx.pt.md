...
head_description: "Compare e mescle mais de dois arquivos EMLX em aplicativos C# .NET. Recupere o resumo das diferenças no conteúdo, texto e estilo de EMLX arquivos, imagens e formatos de documento."

############################# Header ############################
title: "Comparar arquivos EMLX em C# .NET"
...
steps:
    ...
    code: |
        ...
        using (Comparer comparer = new Comparer("source.emlx"))
        {
            ...
            comparer.Compare("result.emlx"); // Cria arquivo de resultado com o nome especificado
        }
        ...
        using (Comparer comparer = new Comparer(File.OpenRead("source.emlx")))
        {
            ...
            comparer.Compare(File.Create("result.emlx")); // Cria arquivo de resultado com o nome especificado
        }
        ```
