...
############################# Head ############################
head_title: "Java XLT Comparison API - Compare XLT Filesfor Differences"
...
steps:
    ...
    content_left: |
        [GroupDocs.Comparison](https://products.groupdocs.com/comparison/java) makes it easy for Java developers to compare XLT files within their applications using a few lines of code.
