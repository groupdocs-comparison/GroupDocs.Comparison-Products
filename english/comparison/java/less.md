...
############################# Head ############################
head_title: "Java LESS Comparison API - Compare LESS Filesfor Differences"
...
steps:
    ...
    content_left: |
        [GroupDocs.Comparison](https://products.groupdocs.com/comparison/java) makes it easy for Java developers to compare LESS files within their applications using a few lines of code.
