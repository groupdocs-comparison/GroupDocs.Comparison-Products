...
############################# Head ############################
head_title: "Java PHP Comparison API - Compare PHP Filesfor Differences"
head_description: "Compare and merge PHP files in Java, J2EE, J2SE applications. Analyse differences summary in content, text &amp; style of PHP files, images and document formats."

############################# Header ############################
title: "Compare PHP Files in Java"
description: "Perform a line-by-line comparison between more than two PHP files in Java. Retrieve a list of differences and save the compared files to a single document."
...
steps:
    enable: true
    title_left: "Steps for Comparing PHP Files in Java"
    content_left: |
        [GroupDocs.Comparison](https://products.groupdocs.com/comparison/java) makes it easy for Java developers to compare PHP files within their applications using a few lines of code.
...
demos:
    enable: true
    title: "Live Demos to Compare PHP Files"
    content: |
        Compare PHP files right now by visiting [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family) website.  
