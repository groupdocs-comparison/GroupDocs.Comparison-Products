...
############################# Head ############################
head_title: "Java DOTM Comparison API - Compare DOTM Filesfor Differences"
...
description: "Perform a line-by-line comparison between more than two DOTM files in Java. Retrieve a list of differences and save the compared files to a single document."
...
steps:
    ...
    content_left: |
        [GroupDocs.Comparison](https://products.groupdocs.com/comparison/java) makes it easy for Java developers to compare DOTM files within their applications using a few lines of code.
...
demos:
    enable: true
    title: "Live Demos to Compare DOTM Files"
    content: |
