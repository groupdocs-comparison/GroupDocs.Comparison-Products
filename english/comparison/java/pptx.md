...
description: "Perform a line-by-line comparison between more than two PPTX files in Java. Retrieve a list of differences and save the compared files to a single document."
...
demos:
    enable: true
    title: "Live Demos to Compare PPTX Files"
    content: |
