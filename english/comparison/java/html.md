...
############################# Head ############################
head_title: "Java HTML Comparison API - Compare HTML Filesfor Differences"
...
steps:
    ...
    content_left: |
        [GroupDocs.Comparison](https://products.groupdocs.com/comparison/java) makes it easy for Java developers to compare HTML files within their applications using a few lines of code.
