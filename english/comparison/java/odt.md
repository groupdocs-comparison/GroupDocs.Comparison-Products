...
############################# Head ############################
head_title: "Java ODT Comparison API - Compare ODT Filesfor Differences"
...
steps:
    ...
    content_left: |
        [GroupDocs.Comparison](https://products.groupdocs.com/comparison/java) makes it easy for Java developers to compare ODT files within their applications using a few lines of code.
