...
############################# Head ############################
head_title: "Java JPEG Comparison API - Compare JPEG Filesfor Differences"
...
steps:
    ...
    content_left: |
        [GroupDocs.Comparison](https://products.groupdocs.com/comparison/java) makes it easy for Java developers to compare JPEG files within their applications using a few lines of code.
