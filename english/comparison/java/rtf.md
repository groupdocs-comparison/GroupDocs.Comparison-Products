...
############################# Head ############################
head_title: "Java RTF Comparison API - Compare RTF Filesfor Differences"
head_description: "Compare and merge RTF files in Java, J2EE, J2SE applications. Analyse differences summary in content, text &amp; style of RTF files, images and document formats."

############################# Header ############################
title: "Compare RTF Files in Java"
description: "Perform a line-by-line comparison between more than two RTF files in Java. Retrieve a list of differences and save the compared files to a single document."
...
steps:
    enable: true
    title_left: "Steps for Comparing RTF Files in Java"
    content_left: |
        [GroupDocs.Comparison](https://products.groupdocs.com/comparison/java) makes it easy for Java developers to compare RTF files within their applications using a few lines of code.
...
demos:
    enable: true
    title: "Live Demos to Compare RTF Files"
    content: |
        Compare RTF files right now by visiting [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family) website.  
