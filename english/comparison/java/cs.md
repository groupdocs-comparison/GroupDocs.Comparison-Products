...
############################# Head ############################
head_title: "Java CS Comparison API - Compare CS Filesfor Differences"
head_description: "Compare and merge CS files in Java, J2EE, J2SE applications. Analyse differences summary in content, text &amp; style of CS files, images and document formats."

############################# Header ############################
title: "Compare CS Files in Java"
description: "Perform a line-by-line comparison between more than two CS files in Java. Retrieve a list of differences and save the compared files to a single document."
...
steps:
    enable: true
    title_left: "Steps for Comparing CS Files in Java"
    content_left: |
        [GroupDocs.Comparison](https://products.groupdocs.com/comparison/java) makes it easy for Java developers to compare CS files within their applications using a few lines of code.
...
demos:
    enable: true
    title: "Live Demos to Compare CS Files"
    content: |
        Compare CS files right now by visiting [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family) website.  
