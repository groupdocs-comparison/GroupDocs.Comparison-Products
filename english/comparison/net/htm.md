...
############################# Head ############################
head_title: "Compare two HTM files in .NET | Document Comparison APIs"
head_description: "Compare and merge more than two (HTM files in C# .NET applications. Retrieve differences summary in content, text &amp; style of HTM files, images and document formats."

############################# Header ############################
title: "Compare HTM Files in C# .NET"
description: ".NET documents comparison API to detect the changes between two versions of HTM files and export to a final document with a detailed summary of the differences between the compared documents."
...
steps:
    enable: true
    title_left: "Steps for Comparing HTM Files in C#"
    content_left: |
        [GroupDocs.Comparison](https://products.groupdocs.com/comparison/net) makes it easy for .NET developers to compare & merge multipe HTM files in their applications by implementing a few easy steps.
...
demos:
    enable: true
    title: "Live Demos of Comparing HTM Files"
    content: |
        Detect differences between HTM files right now by visiting [GroupDocs.Comparison Live Demos](https://products.groupdocs.app/comparison/family) website.  
