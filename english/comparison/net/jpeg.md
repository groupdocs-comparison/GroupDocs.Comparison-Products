...
steps:
    ...
    content_left: |
        [GroupDocs.Comparison](https://products.groupdocs.com/comparison/net) makes it easy for .NET developers to compare & merge multipe JPEG files in their applications by implementing a few easy steps.
