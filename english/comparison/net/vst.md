...
description: ".NET documents comparison API to detect the changes between two versions of VST files and export to a final document with a detailed summary of the differences between the compared documents."
...
steps:
    ...
    content_left: |
        [GroupDocs.Comparison](https://products.groupdocs.com/comparison/net) makes it easy for .NET developers to compare & merge multipe VST files in their applications by implementing a few easy steps.
...
demos:
    enable: true
    title: "Live Demos of Comparing VST Files"
    content: |
